...
<div class="settings-section mb-8">
    <div class="settings-section-header d-flex align-items-start justify-content-between gap-3 mb-6">
        ...
        @isset($actions)
            <div class="settings-section-actions flex-shrink-0">{{ $actions }}</div>
        @endisset
    </div>
