(function ($) {
  ...
  // Vue/Inertia MainMenuList owns the .current class via page.url matching.
  // The old theme helper compared bare path segments to absolute hrefs and
  // incorrectly forced the first item (Home) active on many pages.
