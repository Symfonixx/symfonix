                ...
                'tabs' => [
                    [
                        ...
                        'routes' => [
                            ...
                            'create' => ['admin.pages.create', 'admin.pages.store', 'admin.ai.content.generate-form', 'admin.ai.image-edits.generate', 'admin.ai.image-edits.apply'],
                            'edit' => ['admin.pages.edit', 'admin.pages.update', 'admin.ai.content.generate-form', 'admin.ai.image-edits.generate', 'admin.ai.image-edits.apply'],
                    ...
                    [
                        ...
                        'routes' => [
                            ...
                            'create' => ['admin.blogs.create', 'admin.blogs.store', 'admin.ai.content.generate-form', 'admin.ai.image-edits.generate', 'admin.ai.image-edits.apply'],
                            'edit' => ['admin.blogs.edit', 'admin.blogs.update', 'admin.ai.content.generate-form', 'admin.ai.image-edits.generate', 'admin.ai.image-edits.apply'],
                ...
                'tabs' => [
                    [
                        ...
                        'routes' => [
                            ...
                            'create' => ['admin.services.create', 'admin.services.store', 'admin.ai.content.generate-form'],
                            'edit' => ['admin.services.edit', 'admin.services.update', 'admin.ai.content.generate-form'],
                ...
                'tabs' => [
                    ...
                    [
                        ...
                        'routes' => [
                            ...
                            'create' => ['admin.project-use-cases.create', 'admin.project-use-cases.store', 'admin.ai.content.generate-form', 'admin.ai.image-edits.generate', 'admin.ai.image-edits.apply'],
                            'edit' => ['admin.project-use-cases.edit', 'admin.project-use-cases.update', 'admin.ai.content.generate-form', 'admin.ai.image-edits.generate', 'admin.ai.image-edits.apply'],
                ...
                'tabs' => [
                    [
                        ...
                        'routes' => [
                            ...
                            'create' => ['admin.products.create', 'admin.products.store', 'admin.ai.content.generate-form', 'admin.ai.image-edits.generate', 'admin.ai.image-edits.apply'],
                            'edit' => ['admin.products.edit', 'admin.products.update', 'admin.products.toggle-published', 'admin.ai.content.generate-form', 'admin.ai.image-edits.generate', 'admin.ai.image-edits.apply'],
