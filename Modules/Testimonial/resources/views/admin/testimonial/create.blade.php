...
<x-admin-layout>
    <x-admin.create-card title="Add New Testimonial" :formUrl="route('admin.testimonials.store')">
        <div class="row mb-8">
            <div class="col-xl-3">
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <input type="text" class="form-control form-control-solid" name="position" value="{{old('position')}}" placeholder=""/>
            </div>
        </div>
        <div class="row mb-8">
            <div class="col-xl-3">
            ...
            <div class="col-xl-9 fv-row">
                <input type="url" class="form-control form-control-solid" name="url" value="{{old('url')}}" placeholder=""/>
            </div>
        </div>
        <div class="row mb-8">
            <div class="col-xl-3">
            ...
            <div class="col-xl-9 fv-row">
                <textarea class="form-control form-control-solid" name="quote" rows="3" required>{{old('quote')}}</textarea>
            </div>
        </div>
        <div class="row mb-8">
            <div class="col-xl-3">
