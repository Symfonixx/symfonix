...
@endsection
<x-admin-layout>
    <x-admin.create-card title="Add New Page" :formUrl="route('admin.pages.store')">
        <div class="row mb-8">
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px" @checked(old('add_to_nav')) type="checkbox"
                           name="add_to_nav"/>
                </div>
            </div>
        </div>
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px" @checked(old('add_to_footer')) type="checkbox"
                           name="add_to_footer"/>
                </div>
            </div>
        </div>
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px" @checked(old('add_to_top_bar')) type="checkbox"
                           name="add_to_top_bar"/>
                </div>
            </div>
        </div>
