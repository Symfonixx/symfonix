...
return [
    ...
    'hints' => [
        ...
        'add_customer' => 'أضف عميلاً جديداً إذا لم يكن موجوداً في القائمة.',
    ...
    'filters' => [
        'activity_type' => 'تصفية حسب نوع النشاط',
        'all' => 'الكل',
    ],
    'validation' => [
        'fix_errors' => 'يرجى تصحيح الأخطاء التالية ثم المحاولة مرة أخرى.',
        'email_unique' => 'هذا البريد الإلكتروني مستخدم بالفعل من قبل شركة أخرى.',
    ],
];
