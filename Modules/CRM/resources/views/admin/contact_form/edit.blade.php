...
@section('toolbar')
    @php
        $breadcrumbItems = [
            ...
            ['label' => __('crm::contact.pages.index_title'), 'url' => route('admin.contact_forms.index')],
...
<x-admin-layout>
    <x-admin.create-card :title="__('crm::contact.pages.edit_title')" :formUrl="route('admin.contact_forms.update', $contact)">
        @method('PATCH')
