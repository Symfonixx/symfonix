...
return [
    ...
    'pages' => [
        ...
        'website_title' => 'دراسات الحالة',
        'website_details' => 'دراسة حالة',
    ],
    'meta' => [
        'index_description' => 'استكشف دراسات الحالة لدينا وكيف نساعد الشركات بحلول تقنية مبتكرة.',
        'index_keywords' => 'دراسات حالة، حلول تقنية، تطوير ويب',
    ],
    'fields' => [
        'title' => 'العنوان',
        'slug' => 'رابط URL',
