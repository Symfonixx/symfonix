...
@section('toolbar')
    ...
    <div class="d-flex align-items-center gap-2 gap-lg-3 sx-actions">
        <x-can perform="support.ticket_categories.create">
            <a href="{{ route('admin.ticket_categories.create') }}" class="btn btn-sm fw-bold btn-success" data-action="create">
        ...
        @foreach($model as $category)
            <tr>
                ...
                <td class="text-end sx-actions">
                    <a href="{{ route('admin.ticket_categories.edit', $category) }}" class="btn btn-sm btn-light-warning" data-action="edit">
                        {{ __('Edit') }}
                    </a>
                </td>
            </tr>
