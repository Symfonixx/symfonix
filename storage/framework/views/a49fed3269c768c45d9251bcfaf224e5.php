<?php $__env->startSection('title', __('Add New Service')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.breadcrumb','data' => ['pageTitle' => __('Add New Service'),'breadcrumbItems' => $breadcrumbItems]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['pageTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Add New Service')),'breadcrumbItems' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($breadcrumbItems)]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.create-card','data' => ['title' => 'Add New Service','formUrl' => route('admin.services.store')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Add New Service','formUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.services.store'))]); ?>
            ...
            <div class="col-xl-9 fv-row">
                <select name="service_category_id" class="form-select form-select-solid">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
                            value="<?php echo e($cat->id); ?>" <?php if(old('service_category_id') == $cat->id): echo 'selected'; endif; ?>><?php echo e($cat->title); ?></option>
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <input class="form-control" value="<?php echo e(old('keywords', 'Service,')); ?>" name="keywords"
                       id="kt_tagify_1"/>
            </div>
        </div>
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px"
                           <?php if(old('status') == 'published'): echo 'checked'; endif; ?> type="checkbox" name="status"
                           id="flexSwitch30x50"/>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH D:\websites\symfonix\Modules/Services\resources/views/admin/service/create.blade.php ENDPATH**/ ?>