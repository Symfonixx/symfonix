...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.breadcrumb','data' => ['pageTitle' => $service->title,'breadcrumbItems' => $breadcrumbItems]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['pageTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($service->title),'breadcrumbItems' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($breadcrumbItems)]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.create-card','data' => ['title' => 'Edit Service','formUrl' => route('admin.services.update' , $service->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Service','formUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.services.update' , $service->id))]); ?>
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <div class="image-input image-input-outline " data-kt-image-input="true"
                     style="background-image: url('<?php echo e($service->image_link); ?>')">
                    <div class="image-input-wrapper w-500px h-250px bgi-position-center"
                         style="background-size: 75%; background-image: url(<?php echo e($service->image_link); ?>)"></div>
        ...
        <div class="row mb-8">
            <div class="col-xl-3">
                <div class="fs-6 fw-bold mt-2 mb-3"><?php echo e(__('Service Category')); ?></div>
            </div>
            <div class="col-xl-9 fv-row">
                <select name="service_category_id" class="form-select form-select-solid">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
                            value="<?php echo e($cat->id); ?>" <?php if(old('service_category_id', $service->service_category_id) == $cat->id): echo 'selected'; endif; ?>><?php echo e($cat->title); ?></option>
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                ...
                <input type="text" class="form-control form-control-solid" name="description" id="description"
                       value="<?php echo e(old('description' , $service->description)); ?>"
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <textarea name="content" class="form-control form-control-solid "
                          id="tinymce"><?php echo old('content', $service->content); ?></textarea>
            </div>
        </div>
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <input class="form-control" value="<?php echo e(old('keywords', $service->keywords)); ?>" name="keywords"
                       id="kt_tagify_1"/>
            </div>
        </div>
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px"
                           <?php if(old('status', $service->status) == 'Published'): echo 'checked'; endif; ?> type="checkbox" name="status"
                           id="flexSwitch30x50"/>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px"
                           <?php if(old('featured',$service->featured )): echo 'checked'; endif; ?> type="checkbox"
                           name="featured"
                           id="flexSwitch30x50"/>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\websites\symfonix\Modules/Services\resources/views/admin/service/edit.blade.php ENDPATH**/ ?>