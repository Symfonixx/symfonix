...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.breadcrumb','data' => ['pageTitle' => __('Edit Page'),'breadcrumbItems' => $breadcrumbItems]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['pageTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Edit Page')),'breadcrumbItems' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($breadcrumbItems)]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.create-card','data' => ['title' => 'Edit Page','formUrl' => route('admin.pages.update' , $page->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Page','formUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.pages.update' , $page->id))]); ?>
            ...
            <div class="col-xl-9 fv-row">
                ...
                <div class="image-input image-input-outline " data-kt-image-input="true"
                    ...
                    <div class="image-input-wrapper w-500px h-250px bgi-position-center"
                         style="background-size: 75%; background-image: url(<?php echo e($page->image_link); ?>)"></div>
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                ...
                <input type="text" class="form-control form-control-solid" name="description" id="description"
                       value="<?php echo e(old('description' , $page->description)); ?>" placeholder="We are a powerfull company..."/>
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <textarea name="content" class="form-control form-control-solid "
                          id="tinymce"><?php echo old('content', $page->content); ?></textarea>
            </div>
        </div>
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-9 fv-row">
                <input class="form-control" value="<?php echo e(old('keywords' , $page->keywords)); ?>" name="keywords"
                       id="kt_tagify_1"/>
            </div>
        </div>
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px"
                           <?php if(old('publish' , $page->status) == 'Published'): echo 'checked'; endif; ?> type="checkbox" name="publish"
                           id="flexSwitch30x50"/>
                </div>
            </div>
        </div>
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px"
                           <?php if(old('featured' , $page->featured)): echo 'checked'; endif; ?> type="checkbox" name="featured"
                           id="flexSwitch30x50"/>
                </div>
            </div>
        </div>
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px"
                           <?php if(old('add_to_nav' , $page->add_to_nav)): echo 'checked'; endif; ?> type="checkbox" name="add_to_nav"/>
                </div>
            </div>
        </div>
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px"
                           <?php if(old('add_to_footer' , $page->add_to_footer)): echo 'checked'; endif; ?> type="checkbox" name="add_to_footer"/>
                </div>
            </div>
        </div>
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <div class="form-check form-switch form-check-custom form-check-solid me-10">
                    <input class="form-check-input h-30px w-50px"
                           <?php if(old('add_to_top_bar' , $page->add_to_top_bar)): echo 'checked'; endif; ?> type="checkbox" name="add_to_top_bar"/>
                </div>
            </div>
        </div>
     <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH D:\websites\symfonix\Modules/Cms\resources/views/admin/page/edit.blade.php ENDPATH**/ ?>