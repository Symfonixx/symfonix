      ...
      if (__props.variant === "featured") {
        ...
        _push(ssrRenderComponent(unref(Link), { href: postUrl.value }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", imageSrc.value)}${ssrRenderAttr("alt", translateField(__props.post.title))} width="800" height="500" loading="lazy" decoding="async"${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
                  src: imageSrc.value,
...
const _sfc_main$G = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "services-three__single" }, _attrs))} data-v-6826fe71><div class="services-three__media" data-v-6826fe71>`);
      if (__props.image) {
        _push(`<img${ssrRenderAttr("src", __props.image)}${ssrRenderAttr("alt", __props.title)} class="services-three__image" width="640" height="420" loading="lazy" decoding="async" data-v-6826fe71>`);
      } else {
        _push(`<div class="services-three__image-placeholder" data-v-6826fe71><span class="icon-technical-support" data-v-6826fe71></span></div>`);
      }
      _push(`</div><h3 class="services-three__title" data-v-6826fe71>`);
      ...
      if (shortDescription.value) {
        _push(`<p class="services-three__text" data-v-6826fe71>${ssrInterpolate(shortDescription.value)}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.readingTime) {
        _push(`<p class="services-three__meta" data-v-6826fe71><span class="far fa-clock mx-1" data-v-6826fe71></span>${ssrInterpolate(__props.readingTime)} ${ssrInterpolate(__props.readingTimeLabel)}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (safeHighlights.value.length) {
        _push(`<ul class="list-unstyled services-three__list" data-v-6826fe71><!--[-->`);
        ssrRenderList(safeHighlights.value, (item, index) => {
          _push(`<li data-v-6826fe71><div class="icon" data-v-6826fe71><span class="icon-tick-inside-circle" data-v-6826fe71></span></div><div class="text" data-v-6826fe71><p data-v-6826fe71>${ssrInterpolate(item)}</p></div></li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
        _push(`<!---->`);
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(trans("Read More"))} <span class="${ssrRenderClass(`icon-${__props.isRtl ? "left" : "right"}-arrow-1`)}" data-v-6826fe71${_scopeId}></span>`);
          } else {
            return [
              createTextVNode(toDisplayString(trans("Read More")) + " ", 1),
              createVNode("span", {
...
const ServiceCardThree = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["__scopeId", "data-v-6826fe71"]]);
const _sfc_main$F = {
  __name: "MainMenuList",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    const safeRoute = (name, fallback = "#", params = void 0) => {
      try {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li>`);
      if (!auth.value) {
        _push(`<li class="${ssrRenderClass([{ current: isActive("login") }, "d-md-none"])}">`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("login")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="fas fa-sign-in-alt mx-1"${_scopeId}></i> ${ssrInterpolate(trans("Login"))}`);
            } else {
              return [
                createVNode("i", { class: "fas fa-sign-in-alt mx-1" }),
      ...
      if (((_a = auth.value) == null ? void 0 : _a.type) === "admin") {
        _push(`<li class="${ssrRenderClass({ active: isActive("admin.dashboard.index") })}"><a${ssrRenderAttr("href", safeRoute("admin.dashboard.index", "/admin"))}>${ssrInterpolate(trans("Dashboard"))}</a></li>`);
      } else {
        _push(`<!---->`);
      }
      if (((_b = auth.value) == null ? void 0 : _b.type) === "customer") {
        _push(`<li class="dropdown portal-account-dropdown"><a href="#" aria-label="Customer account"><i class="fas fa-user-circle mx-1"></i>${ssrInterpolate(auth.value.name)}</a><ul class="shadow-box portal-account-menu"><li class="${ssrRenderClass([{ current: isActive("portal.dashboard") }, "portal-menu-item"])}">`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("portal.dashboard")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="fas fa-th-large mx-1"${_scopeId}></i> ${ssrInterpolate(portalLabel("menu.my_dashboard"))}`);
            } else {
              return [
                createVNode("i", { class: "fas fa-th-large mx-1" }),
        ...
        _push(`</li><li class="${ssrRenderClass([{ current: isActive(["portal.projects.index", "portal.projects.show"], { prefixes: ["/portal/projects"] }) }, "portal-menu-item"])}">`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("portal.projects.index")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="fas fa-folder-open mx-1"${_scopeId}></i> ${ssrInterpolate(portalLabel("menu.projects"))} `);
              if (unreadCount.value) {
                _push2(`<span class="portal-menu-badge"${_scopeId}>${ssrInterpolate(unreadCount.value)}</span>`);
              } else {
                _push2(`<!---->`);
              }
            } else {
              return [
                createVNode("i", { class: "fas fa-folder-open mx-1" }),
                createTextVNode(" " + toDisplayString(portalLabel("menu.projects")) + " ", 1),
                unreadCount.value ? (openBlock(), createBlock("span", {
                  key: 0,
                  class: "portal-menu-badge"
                }, toDisplayString(unreadCount.value), 1)) : createCommentVNode("", true)
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(`</li><li class="${ssrRenderClass([{ current: isActive("portal.subscriptions.index", { prefixes: ["/portal/subscriptions"] }) }, "portal-menu-item"])}">`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("portal.subscriptions.index")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="fas fa-sync-alt mx-1"${_scopeId}></i> ${ssrInterpolate(portalLabel("menu.subscriptions"))}`);
            } else {
              return [
                createVNode("i", { class: "fas fa-sync-alt mx-1" }),
                createTextVNode(" " + toDisplayString(portalLabel("menu.subscriptions")), 1)
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(`</li><li class="${ssrRenderClass([{ current: isActive(["portal.tickets.index", "portal.tickets.create", "portal.tickets.show"], { prefixes: ["/portal/tickets"] }) }, "portal-menu-item"])}">`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("portal.tickets.index")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="fas fa-life-ring mx-1"${_scopeId}></i> ${ssrInterpolate(portalLabel("menu.tickets"))}`);
            } else {
              return [
                createVNode("i", { class: "fas fa-life-ring mx-1" }),
        ...
        _push(`</li><li class="${ssrRenderClass([{ current: isActive("portal.profile.index", { prefixes: ["/portal/profile"] }) }, "portal-menu-item"])}">`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("portal.profile.index")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="fas fa-user-cog mx-1"${_scopeId}></i> ${ssrInterpolate(portalLabel("menu.profile"))}`);
            } else {
              return [
                createVNode("i", { class: "fas fa-user-cog mx-1" }),
                createTextVNode(" " + toDisplayString(portalLabel("menu.profile")), 1)
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(`</li><li class="portal-menu-item portal-menu-item--logout text-danger">`);
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="fas fa-sign-out-alt mx-1"${_scopeId}></i> ${ssrInterpolate(portalLabel("menu.logout"))}`);
            } else {
              return [
                createVNode("i", { class: "fas fa-sign-out-alt mx-1" }),
      ...
      _push(`<li class="dropdown"><a href="#" aria-label="Change language"><img${ssrRenderAttr("src", asset_path.value + `images/langs/${locale.value}.svg`)} width="20"${ssrRenderAttr("alt", trans("Current language"))}></a><ul class="shadow-box"><li><a href="#" class="${ssrRenderClass({ active: locale.value === "ar" })}"><img class="mx-1"${ssrRenderAttr("src", asset_path.value + "images/langs/ar.svg")} width="20"${ssrRenderAttr("alt", trans("Arabic"))}> ${ssrInterpolate(trans("Arabic"))}</a></li><li><a href="#" class="${ssrRenderClass({ active: locale.value === "en" })}"><img class="mx-1"${ssrRenderAttr("src", asset_path.value + "images/langs/en.svg")} width="20"${ssrRenderAttr("alt", trans("English"))}> ${ssrInterpolate(trans("English"))}</a></li><li><a href="#" class="${ssrRenderClass({ active: locale.value === "tr" })}"><img class="mx-1"${ssrRenderAttr("src", asset_path.value + "images/langs/tr.svg")} width="20"${ssrRenderAttr("alt", trans("Turkish"))}> ${ssrInterpolate(trans("Turkish"))}</a></li><li><a href="#" class="${ssrRenderClass({ active: locale.value === "de" })}"><img class="mx-1"${ssrRenderAttr("src", asset_path.value + "images/langs/de.svg")} width="20"${ssrRenderAttr("alt", trans("German"))}> ${ssrInterpolate(trans("German"))}</a></li></ul></li></ul>`);
    };
  }
};
...
const _sfc_main$E = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "main-menu main-menu-two" }, _attrs))} data-v-bcca7c9f><div class="main-menu-two__wrapper" data-v-bcca7c9f><div class="main-menu-two__wrapper-inner" data-v-bcca7c9f><div class="main-menu-two__left" data-v-bcca7c9f><div class="main-menu-two__logo" data-v-bcca7c9f>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("home"),
        class: "main-menu-two__logo-link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (logoSrc.value) {
              _push2(`<img${ssrRenderAttr("src", logoSrc.value)}${ssrRenderAttr("alt", brandName.value)} width="180" height="48" data-v-bcca7c9f${_scopeId}>`);
            } else {
              _push2(`<span class="brand-text-logo" data-v-bcca7c9f${_scopeId}>${ssrInterpolate(brandName.value)}</span>`);
            }
          } else {
            return [
      ...
      _push(`</div></div><div class="main-menu-two__main-menu-box" data-v-bcca7c9f><a href="#" class="mobile-nav__toggler" aria-label="Open mobile menu" data-v-bcca7c9f><i class="fa fa-bars" data-v-bcca7c9f></i></a>`);
      _push(ssrRenderComponent(_sfc_main$F, null, null, _parent));
      _push(`</div><div class="main-menu-two__right d-none d-md-flex align-items-center" data-v-bcca7c9f>`);
      if (!auth.value) {
        _push(`<div class="main-menu-two__btn-box" data-v-bcca7c9f>`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("login"),
          class: "thm-btn"
        }, {
      ...
      _push(`<div class="main-menu-two__search-box me-3" data-v-bcca7c9f><a href="#" class="main-menu-two__search searcher-toggler-box icon-search-interface-symbol" aria-label="Open search" data-v-bcca7c9f></a></div><div class="main-menu-two__nav-sidebar-icon" data-v-bcca7c9f><a class="navSidebar-button" href="#" aria-label="Open sidebar" data-v-bcca7c9f><span class="icon-dots-menu-one" data-v-bcca7c9f></span><span class="icon-dots-menu-two" data-v-bcca7c9f></span><span class="icon-dots-menu-three" data-v-bcca7c9f></span></a></div></div></div></div></nav>`);
    };
  }
};
...
const MainMenuNav = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["__scopeId", "data-v-bcca7c9f"]]);
const _sfc_main$D = {
  __name: "App",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    onMounted(() => {
      ...
      const onMobileNavToggleClick = (e) => {
        var _a, _b;
        const toggler = (_b = (_a = e.target).closest) == null ? void 0 : _b.call(_a, ".mobile-nav__toggler");
        if (!toggler) return;
        e.preventDefault();
        e.stopPropagation();
      ...
      const unregisterNavigate = router.on("navigate", () => {
        ...
        (_a = document.querySelector(".info-group")) == null ? void 0 : _a.classList.remove("isActive");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<footer class="site-footer-two"><div class="site-footer-two__top"><div class="container"><div class="row"><div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms"><div class="site-footer-two__about"><div class="site-footer-two__logo">`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("home")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass(locale.value === "ar" ? "icon-left-arrow-2" : "icon-right-arrow-2")}"${_scopeId}></span>${ssrInterpolate(trans("Products"))}`);
          } else {
            return [
              createVNode("span", {
                class: locale.value === "ar" ? "icon-left-arrow-2" : "icon-right-arrow-2"
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass(locale.value === "ar" ? "icon-left-arrow-2" : "icon-right-arrow-2")}"${_scopeId}></span>${ssrInterpolate(trans("Case Studies"))}`);
          } else {
            return [
              createVNode("span", {
                class: locale.value === "ar" ? "icon-left-arrow-2" : "icon-right-arrow-2"
      ...
      _push(`</li></ul></div></div><div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms"><div class="footer-widget-two__quick-links"><h4 class="footer-widget-two__title">${ssrInterpolate(trans("Pages"))}</h4><ul class="footer-widget-two__quick-links-list list-unstyled"><li>`);
      _push(ssrRenderComponent(unref(Link), {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass(locale.value === "ar" ? "icon-left-arrow-2" : "icon-right-arrow-2")}"${_scopeId}></span>${ssrInterpolate(trans("FAQs"))}`);
          } else {
            return [
              createVNode("span", {
                class: locale.value === "ar" ? "icon-left-arrow-2" : "icon-right-arrow-2"
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (logoSrc.value) {
              ...
              _push2(`<span class="brand-text-logo brand-text-logo--light"${_scopeId}>${ssrInterpolate(brandName.value)}</span>`);
            }
          } else {
            return [
              logoSrc.value ? (openBlock(), createBlock("img", {
                ...
                key: 1,
                class: "brand-text-logo brand-text-logo--light"
              }, toDisplayString(brandName.value), 1))
            ];
          }
        }),
      ...
      _push(`</div></div></div></div><div class="search-popup"><div class="color-layer"></div><button class="close-search" type="button"${ssrRenderAttr("aria-label", trans("Close search"))}><span class="far fa-times fa-fw"></span></button><form><div class="form-group"><input type="search" name="search"${ssrRenderAttr("value", unref(searchForm).search)}${ssrRenderAttr("placeholder", trans("Search Here"))} required=""><button type="submit"${ssrRenderAttr("aria-label", trans("Submit search"))}><i class="fas fa-search"></i></button></div></form></div><!--]-->`);
    };
  }
};
...
const _sfc_main$C = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-0c9c4e06><div class="use-case-card__glow" aria-hidden="true" data-v-0c9c4e06></div><header class="use-case-card__header" data-v-0c9c4e06>`);
      _push(ssrRenderComponent(unref(Link), {
        href: cardUrl.value,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", __props.item.image_link)}${ssrRenderAttr("alt", __props.item.title)} width="96" height="96" loading="lazy" decoding="async" data-v-0c9c4e06${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
      ...
      _push(`<div class="use-case-card__identity" data-v-0c9c4e06><h3 class="use-case-card__title" data-v-0c9c4e06>`);
      ...
      if (__props.item.client_name) {
        _push(`<p class="use-case-card__subtitle" data-v-0c9c4e06>${ssrInterpolate(__props.item.client_name)}</p>`);
      } else if (__props.item.category_tag) {
        _push(`<p class="use-case-card__subtitle" data-v-0c9c4e06>${ssrInterpolate(__props.item.category_tag)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></header>`);
      if (__props.item.summary && __props.variant !== "compact") {
        _push(`<div class="use-case-card__section" data-v-0c9c4e06><div class="use-case-card__section-head" data-v-0c9c4e06><span class="use-case-card__section-icon" data-v-0c9c4e06><i class="fas fa-lightbulb" data-v-0c9c4e06></i></span><span class="use-case-card__section-label" data-v-0c9c4e06>${ssrInterpolate(trans("Overview"))}</span></div><p class="use-case-card__summary" data-v-0c9c4e06>${ssrInterpolate(truncate(__props.item.summary, __props.variant === "compact" ? 90 : 140))}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.item.category_tag || __props.item.technologies && __props.item.technologies.length) {
        _push(`<div class="use-case-card__section use-case-card__section--tags" data-v-0c9c4e06><div class="use-case-card__section-head" data-v-0c9c4e06><span class="use-case-card__section-icon" data-v-0c9c4e06><i class="fas fa-code" data-v-0c9c4e06></i></span><span class="use-case-card__section-label" data-v-0c9c4e06>${ssrInterpolate(trans("Technologies"))}</span></div><div class="use-case-card__tags" data-v-0c9c4e06>`);
        if (__props.item.category_tag) {
          _push(`<span class="use-case-card__tag use-case-card__tag--category" data-v-0c9c4e06>${ssrInterpolate(__props.item.category_tag)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
        ssrRenderList((__props.item.technologies || []).slice(0, __props.variant === "compact" ? 2 : 4), (tech) => {
          _push(`<span class="use-case-card__tag" data-v-0c9c4e06>${ssrInterpolate(tech)}</span>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<footer class="use-case-card__footer" data-v-0c9c4e06>`);
      if (__props.item.completed_year) {
        _push(`<div class="use-case-card__pill" data-v-0c9c4e06><i class="far fa-calendar-alt" data-v-0c9c4e06></i><span data-v-0c9c4e06>${ssrInterpolate(__props.item.completed_year)}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(unref(Link), {
        href: cardUrl.value,
        class: "use-case-card__pill use-case-card__pill--cta"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-0c9c4e06${_scopeId}>${ssrInterpolate(trans("View Case Study"))}</span><span class="${ssrRenderClass(`icon-${__props.locale === "ar" ? "left" : "right"}-arrow`)}" data-v-0c9c4e06${_scopeId}></span>`);
          } else {
            return [
...
const UseCaseCard = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["__scopeId", "data-v-0c9c4e06"]]);
const _sfc_main$B = {
  __name: "ProductCard",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<article${ssrRenderAttrs(mergeProps({
        class: ["product-card", [`product-card--${__props.variant}`, { "product-card--featured": __props.item.is_featured }]]
      }, _attrs))} data-v-80e9306c><div class="product-card__glow" aria-hidden="true" data-v-80e9306c></div>`);
      _push(ssrRenderComponent(unref(Link), {
        href: cardUrl.value,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", __props.item.main_image_link)}${ssrRenderAttr("alt", __props.item.name)} width="640" height="400" loading="lazy" decoding="async" data-v-80e9306c${_scopeId}><div class="product-card__media-overlay" aria-hidden="true" data-v-80e9306c${_scopeId}></div>`);
            if (__props.item.is_featured) {
              _push2(`<span class="product-card__badge" data-v-80e9306c${_scopeId}><i class="fas fa-star" data-v-80e9306c${_scopeId}></i> ${ssrInterpolate(trans("Featured"))}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              __props.item.is_featured ? (openBlock(), createBlock("span", {
                key: 0,
                class: "product-card__badge"
              }, [
                createVNode("i", { class: "fas fa-star" }),
                createTextVNode(" " + toDisplayString(trans("Featured")), 1)
      ...
      _push(`<div class="product-card__body" data-v-80e9306c>`);
      if (__props.item.category) {
        _push(`<p class="product-card__category" data-v-80e9306c>${ssrInterpolate(__props.item.category.name)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<h3 class="product-card__title" data-v-80e9306c>`);
      _push(ssrRenderComponent(unref(Link), { href: cardUrl.value }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      if (__props.item.short_description && __props.variant !== "compact") {
        _push(`<p class="product-card__summary" data-v-80e9306c>${ssrInterpolate(truncate(__props.item.short_description, __props.variant === "compact" ? 80 : 130))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><footer class="product-card__footer" data-v-80e9306c>`);
      _push(ssrRenderComponent(unref(Link), {
        href: cardUrl.value,
        class: "product-card__pill product-card__pill--cta"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-80e9306c${_scopeId}>${ssrInterpolate(trans("View Details"))}</span><span class="${ssrRenderClass(`icon-${__props.locale === "ar" ? "left" : "right"}-arrow`)}" data-v-80e9306c${_scopeId}></span>`);
          } else {
            return [
              createVNode("span", null, toDisplayString(trans("View Details")), 1),
              createVNode("span", {
                class: `icon-${__props.locale === "ar" ? "left" : "right"}-arrow`
              }, null, 2)
            ];
...
const ProductCard = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["__scopeId", "data-v-80e9306c"]]);
const __default__$h = {
  components: {
    AppLayout: _sfc_main$D,
    UseCaseCard,
    ProductCard
  }
};
const _sfc_main$A = /* @__PURE__ */ Object.assign(__default__$h, {
  __name: "Index",
  __ssrInlineRender: true,
  setup(__props) {
    const page = usePage();
    ...
    onMounted(() => {
      nextTick(() => {
        ...
        const initHomeWidgets = () => {
          var _a, _b, _c;
          if (typeof $ !== "undefined" && typeof ((_a = $.fn) == null ? void 0 : _a.owlCarousel) === "function" && $(".services-three__carousel").length) {
          ...
          if (typeof $ !== "undefined" && typeof ((_b = $.fn) == null ? void 0 : _b.owlCarousel) === "function" && $(".team-two__carousel").length && teams.value.length > 0) {
          ...
          if (typeof $ !== "undefined" && typeof ((_c = $.fn) == null ? void 0 : _c.owlCarousel) === "function" && $(".testimonial-one__carousel").length) {
        ...
        waitForTheme(() => {
          var _a;
          return typeof window.$ !== "undefined" && typeof ((_a = window.$.fn) == null ? void 0 : _a.owlCarousel) === "function";
        }).then((ready) => {
          if (ready) {
            initHomeWidgets();
          }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title data-v-8b32445e${_scopeId}>${ssrInterpolate(metaTitle.value)}</title><meta name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-8b32445e${_scopeId}><meta name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-8b32445e${_scopeId}><meta name="robots"${ssrRenderAttr("content", metaRobots.value)} data-v-8b32445e${_scopeId}>`);
            if (metaCanonical.value) {
              _push2(`<link rel="canonical"${ssrRenderAttr("href", metaCanonical.value)} data-v-8b32445e${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:title"${ssrRenderAttr("content", metaTitle.value)} data-v-8b32445e${_scopeId}><meta property="og:description"${ssrRenderAttr("content", metaDescription.value)} data-v-8b32445e${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta property="og:image"${ssrRenderAttr("content", metaImage.value)} data-v-8b32445e${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (metaCanonical.value) {
              _push2(`<meta property="og:url"${ssrRenderAttr("content", metaCanonical.value)} data-v-8b32445e${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:type" content="website" data-v-8b32445e${_scopeId}><meta name="twitter:card" content="summary_large_image" data-v-8b32445e${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", metaTitle.value)} data-v-8b32445e${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", metaDescription.value)} data-v-8b32445e${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta name="twitter:image"${ssrRenderAttr("content", metaImage.value)} data-v-8b32445e${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_sfc_main$D, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="banner-one" data-v-8b32445e${_scopeId}><div class="banner-one__bg" style="${ssrRenderStyle({
              backgroundImage: `url(${asset_path.value}images/home/banner-bg.webp), url(${asset_path.value}images/home/banner-bg.jpg)`
            })}" data-v-8b32445e${_scopeId}></div><div class="banner-one__shape-bg float-bob-y" style="${ssrRenderStyle({
              backgroundImage: `url(${asset_path.value}images/shapes/banner-one-shape-bg.png)`
            })}" data-v-8b32445e${_scopeId}></div><div class="container" data-v-8b32445e${_scopeId}><div class="banner-one__inner" data-v-8b32445e${_scopeId}><h1 class="banner-one__title px-4" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Transform complex technical ideas into intelligent systems"))} <br data-v-8b32445e${_scopeId}><span data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Help companies build practical technology solutions in Web, AI, automation, and cloud computing — designed for growth and sustainability"))}</span></h1><div class="banner-one__btn-box mb-5" data-v-8b32445e${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="${ssrRenderClass(locale.value === "ar" ? "icon-message ms-2" : "icon-message me-2")}" data-v-8b32445e${_scopeId2}></span> ${ssrInterpolate(trans("Book your free consultation"))}`);
                } else {
                  return [
                    createVNode("span", {
                      class: locale.value === "ar" ? "icon-message ms-2" : "icon-message me-2"
                    }, null, 2),
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="${ssrRenderClass(locale.value === "ar" ? "icon-search ms-2" : "icon-search me-2")}" data-v-8b32445e${_scopeId2}></span> ${ssrInterpolate(trans("Explore Our Services"))}`);
                } else {
                  return [
                    createVNode("span", {
                      class: locale.value === "ar" ? "icon-search ms-2" : "icon-search me-2"
                    }, null, 2),
            ...
            _push2(`</div></div></div></section><section class="about-three" data-v-8b32445e${_scopeId}><div class="container" data-v-8b32445e${_scopeId}><div class="row" data-v-8b32445e${_scopeId}><div class="col-xl-6" data-v-8b32445e${_scopeId}><div class="${ssrRenderClass(`about-three__left wow slideIn${locale.value !== "ar" ? "Left" : "Right"}`)}" data-wow-delay="100ms" data-wow-duration="2500ms" data-v-8b32445e${_scopeId}><div class="about-three__img-box" data-v-8b32445e${_scopeId}><div class="about-three__img" data-v-8b32445e${_scopeId}><picture data-v-8b32445e${_scopeId}><source${ssrRenderAttr("srcset", asset_path.value + "images/home/about_us.webp")} type="image/webp" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", asset_path.value + "images/home/about_us.jpg")}${ssrRenderAttr("alt", trans("About us"))} width="636" height="636" decoding="async" data-v-8b32445e${_scopeId}></picture></div></div></div></div><div class="col-xl-6" data-v-8b32445e${_scopeId}><div class="about-three__right" data-v-8b32445e${_scopeId}><div class="section-title sec-title-animation animation-style1" data-v-8b32445e${_scopeId}><div class="section-title__tagline-box" data-v-8b32445e${_scopeId}><div class="section-title__tagline-shape-1" data-v-8b32445e${_scopeId}></div><span class="section-title__tagline" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Our Tech Solutions"))}</span><div class="section-title__tagline-shape-2" data-v-8b32445e${_scopeId}></div></div><h2 class="section-title__title title-animation" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Why Choose Symfonix for Web, AI, and Cloud"))}</h2></div><p class="about-three__text" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Transform your business with our innovative IT solutions, tailored to address your unique challenges and drive growth in today's digital landscape."))}</p><ul class="about-three__points list-unstyled" data-v-8b32445e${_scopeId}><li data-v-8b32445e${_scopeId}><div class="icon" data-v-8b32445e${_scopeId}><span class="icon-tick-inside-circle" data-v-8b32445e${_scopeId}></span></div><div class="content" data-v-8b32445e${_scopeId}><h2 class="h3" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Developing Secure & Scalable Systems"))}</h2></div></li><li data-v-8b32445e${_scopeId}><div class="icon" data-v-8b32445e${_scopeId}><span class="icon-tick-inside-circle" data-v-8b32445e${_scopeId}></span></div><div class="content" data-v-8b32445e${_scopeId}><h2 class="h3" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Innovative IT Solutions Expert"))}</h2></div></li><li data-v-8b32445e${_scopeId}><div class="icon" data-v-8b32445e${_scopeId}><span class="icon-tick-inside-circle" data-v-8b32445e${_scopeId}></span></div><div class="content" data-v-8b32445e${_scopeId}><h2 class="h3" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Cloud Solutions for Modern"))}</h2></div></li><li data-v-8b32445e${_scopeId}><div class="icon" data-v-8b32445e${_scopeId}><span class="icon-tick-inside-circle" data-v-8b32445e${_scopeId}></span></div><div class="content" data-v-8b32445e${_scopeId}><h2 class="h3" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("AI-Driven Business Automation"))}</h2></div></li></ul><div class="about-three__btn-and-call-box" data-v-8b32445e${_scopeId}><div class="about-three__btn-box" data-v-8b32445e${_scopeId}><a${ssrRenderAttr("href", _ctx.route("about-us"))} class="thm-btn" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Get in Touch"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow `)}" data-v-8b32445e${_scopeId}></span></a></div><div class="about-three__call-box" data-v-8b32445e${_scopeId}><div class="icon" data-v-8b32445e${_scopeId}><span class="icon-customer-service-headset" data-v-8b32445e${_scopeId}></span></div><div class="content" data-v-8b32445e${_scopeId}><span data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Call Any Time"))}</span><p data-v-8b32445e${_scopeId}><a dir="ltr"${ssrRenderAttr("href", `tel:${settings.value.phone}`)} data-v-8b32445e${_scopeId}>${ssrInterpolate(settings.value.phone)}</a></p></div></div></div></div></div></div></div></section>`);
            if (servicesCategories.value && servicesCategories.value.length) {
              _push2(`<section class="services-three" data-v-8b32445e${_scopeId}><div class="container" data-v-8b32445e${_scopeId}><div class="section-title text-center sec-title-animation animation-style1" data-v-8b32445e${_scopeId}><div class="section-title__tagline-box" data-v-8b32445e${_scopeId}><div class="section-title__tagline-shape-1" data-v-8b32445e${_scopeId}></div><span class="section-title__tagline" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Our Services"))}</span><div class="section-title__tagline-shape-2" data-v-8b32445e${_scopeId}></div></div><h2 class="section-title__title title-animation core-services-title" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("What We Do"))}! <span data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Core Services"))}</span></h2></div><div class="services-three__carousel owl-theme owl-carousel" data-v-8b32445e${_scopeId}><!--[-->`);
              ssrRenderList(servicesCategories.value, (servicesCategory) => {
                _push2(`<div class="item" data-v-8b32445e${_scopeId}>`);
              ...
              _push2(`<!--]--></div><div class="text-center mt-4" data-v-8b32445e${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("services.index"),
                class: "thm-btn"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(trans("View All Services"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow `)}" data-v-8b32445e${_scopeId2}></span>`);
                  } else {
                    return [
            ...
            if (products.value && products.value.length) {
              _push2(`<section class="home-products products-page" data-v-8b32445e${_scopeId}><div class="products-page__bg" aria-hidden="true" data-v-8b32445e${_scopeId}><div class="products-page__orb products-page__orb--one" data-v-8b32445e${_scopeId}></div><div class="products-page__orb products-page__orb--two" data-v-8b32445e${_scopeId}></div><div class="products-page__orb products-page__orb--three" data-v-8b32445e${_scopeId}></div></div><div class="container position-relative" data-v-8b32445e${_scopeId}><div class="section-title text-center sec-title-animation animation-style1 home-products__head" data-v-8b32445e${_scopeId}><div class="section-title__tagline-box" data-v-8b32445e${_scopeId}><div class="section-title__tagline-shape-1" data-v-8b32445e${_scopeId}></div><span class="section-title__tagline" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Our Products"))}</span><div class="section-title__tagline-shape-2" data-v-8b32445e${_scopeId}></div></div><h2 class="section-title__title title-animation" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("B2B Solutions Built for Scale"))}</h2><p class="home-products__intro" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Discover enterprise-ready platforms and services designed to grow with your business."))}</p></div><div class="home-products__grid" data-v-8b32445e${_scopeId}><div class="row g-4" data-v-8b32445e${_scopeId}><!--[-->`);
              ssrRenderList(products.value, (product, index) => {
                _push2(`<div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp"${ssrRenderAttr("data-wow-delay", `${(index % 3 + 1) * 100}ms`)} data-v-8b32445e${_scopeId}>`);
              ...
              _push2(`<!--]--></div></div><div class="text-center home-products__cta" data-v-8b32445e${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("product.index"),
                class: "thm-btn"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(trans("View All Products"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow `)}" data-v-8b32445e${_scopeId2}></span>`);
                  } else {
                    return [
            ...
            if (useCases.value && useCases.value.length) {
              _push2(`<section class="home-case-studies use-cases-page" data-v-8b32445e${_scopeId}><div class="use-cases-page__bg" aria-hidden="true" data-v-8b32445e${_scopeId}><div class="use-cases-page__orb use-cases-page__orb--one" data-v-8b32445e${_scopeId}></div><div class="use-cases-page__orb use-cases-page__orb--two" data-v-8b32445e${_scopeId}></div></div><div class="container position-relative" data-v-8b32445e${_scopeId}><div class="section-title text-center sec-title-animation animation-style1" data-v-8b32445e${_scopeId}><div class="section-title__tagline-box" data-v-8b32445e${_scopeId}><div class="section-title__tagline-shape-1" data-v-8b32445e${_scopeId}></div><span class="section-title__tagline" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Case Studies"))}</span><div class="section-title__tagline-shape-2" data-v-8b32445e${_scopeId}></div></div><h2 class="section-title__title title-animation" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("How We've Empowered Businesses with Innovative Tech Solutions"))}</h2><p class="home-case-studies__intro" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Explore our success stories and real-world solutions we've delivered for businesses."))}</p></div><div class="use-cases-page__grid" data-v-8b32445e${_scopeId}><div class="row g-4" data-v-8b32445e${_scopeId}><!--[-->`);
              ssrRenderList(useCases.value, (item) => {
                _push2(`<div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms" data-v-8b32445e${_scopeId}>`);
              ...
              _push2(`<!--]--></div></div><div class="text-center home-case-studies__cta" data-v-8b32445e${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("use-cases.index"),
                class: "thm-btn"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(trans("View All Case Studies"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow `)}" data-v-8b32445e${_scopeId2}></span>`);
                  } else {
                    return [
            ...
            _push2(`<section class="why-choose-two" data-v-8b32445e${_scopeId}><div class="why-choose-two__shape-1 float-bob-y" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", asset_path.value + "site/images/shapes/why-choose-two-shape-1.png")}${ssrRenderAttr("alt", trans("Decorative shape"))} width="120" height="120" loading="lazy" decoding="async" data-v-8b32445e${_scopeId}></div><div class="container" data-v-8b32445e${_scopeId}><div class="row" data-v-8b32445e${_scopeId}><div class="col-xl-6" data-v-8b32445e${_scopeId}><div class="${ssrRenderClass(`why-choose-two__left wow ${locale.value !== "ar" ? "Left" : "Right"}`)}" data-wow-delay="100ms" data-wow-duration="2500ms" data-v-8b32445e${_scopeId}><div class="why-choose-two__img" data-v-8b32445e${_scopeId}><picture data-v-8b32445e${_scopeId}><source${ssrRenderAttr("srcset", asset_path.value + "images/home/why_choose_us.webp")} type="image/webp" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", asset_path.value + "images/home/why_choose_us.jpg")}${ssrRenderAttr("alt", trans("Why choose us"))} width="636" height="700" loading="lazy" decoding="async" data-v-8b32445e${_scopeId}></picture></div></div></div><div class="col-xl-6" data-v-8b32445e${_scopeId}><div class="why-choose-two__right" data-v-8b32445e${_scopeId}><div class="section-title text-left sec-title-animation animation-style2" data-v-8b32445e${_scopeId}><div class="section-title__tagline-box" data-v-8b32445e${_scopeId}><div class="section-title__tagline-shape-1" data-v-8b32445e${_scopeId}></div><span class="section-title__tagline" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Why Choose Us"))}</span><div class="section-title__tagline-shape-2" data-v-8b32445e${_scopeId}></div></div><h2 class="section-title__title title-animation" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("How do we deliver reliable, future-ready IT solutions?"))}</h2></div><p class="why-choose-one__text" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("We deliver exceptional products and services that consistently exceed expectations. Backed by years of experience and a proven track record, we are your reliable partner for success."))}</p><ul class="list-unstyled why-choose-two__points" data-v-8b32445e${_scopeId}><li data-v-8b32445e${_scopeId}><div class="icon" data-v-8b32445e${_scopeId}><span class="icon-quality" data-v-8b32445e${_scopeId}></span></div><div class="content" data-v-8b32445e${_scopeId}><h3 class="h4" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Unmatched Quality"))}</h3><p data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("We deliver exceptional products and services that exceed expectations every time."))}</p></div></li><li data-v-8b32445e${_scopeId}><div class="icon" data-v-8b32445e${_scopeId}><span class="icon-team" data-v-8b32445e${_scopeId}></span></div><div class="content" data-v-8b32445e${_scopeId}><h3 class="h4" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Trusted Expertise"))}</h3><p data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Backed by years of experience and a proven track record, we are your reliable partner for success."))}</p></div></li><li data-v-8b32445e${_scopeId}><div class="icon" data-v-8b32445e${_scopeId}><span class="icon-customer-centricity" data-v-8b32445e${_scopeId}></span></div><div class="content" data-v-8b32445e${_scopeId}><h3 class="h4" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("User-Centric Approach"))}</h3><p data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Your satisfaction is our priority, and we tailor solutions to meet your unique needs. Your happiness comes first."))}</p></div></li></ul></div></div></div></div></section>`);
            if (teams.value && teams.value.length > 0) {
              _push2(`<section class="team-two d-none" data-v-8b32445e${_scopeId}><div class="team-two__bg-shape float-bob-y" style="${ssrRenderStyle({ backgroundImage: `url(${asset_path.value}images/shapes/team-two-bg-shape.png)` })}" data-v-8b32445e${_scopeId}></div><div class="container" data-v-8b32445e${_scopeId}><div class="row" data-v-8b32445e${_scopeId}><div class="col-xl-5" data-v-8b32445e${_scopeId}><div class="team-two__left" data-v-8b32445e${_scopeId}><div class="section-title text-left sec-title-animation animation-style2" data-v-8b32445e${_scopeId}><div class="section-title__tagline-box" data-v-8b32445e${_scopeId}><div class="section-title__tagline-shape-1" data-v-8b32445e${_scopeId}></div><span class="section-title__tagline" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Our Members"))}</span><div class="section-title__tagline-shape-2" data-v-8b32445e${_scopeId}></div></div><h2 class="section-title__title title-animation" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Meet Our Team."))} <span data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Get to"))}</span><br data-v-8b32445e${_scopeId}><span data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Know the Talented"))}</span> ${ssrInterpolate(trans("Minds Behind Our Team"))}</h2></div><p class="team-two__text" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Our dedicated team combines expertise, creativity, and passion to deliver exceptional results and ensure your satisfaction every step of the way."))}</p></div></div><div class="col-xl-7" data-v-8b32445e${_scopeId}><div class="team-two__right" data-v-8b32445e${_scopeId}><div class="team-two__carousel owl-theme owl-carousel" data-v-8b32445e${_scopeId}><!--[-->`);
              ssrRenderList(teams.value, (team) => {
                _push2(`<div class="item" data-v-8b32445e${_scopeId}><div class="team-two__single" data-v-8b32445e${_scopeId}><div class="team-two__img-box" data-v-8b32445e${_scopeId}><div class="team-two__img" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", team.avatar_link)}${ssrRenderAttr("alt", translateField(team.name))} width="200" height="200" loading="lazy" decoding="async" data-v-8b32445e${_scopeId}></div><div class="team-two__social" data-v-8b32445e${_scopeId}>`);
                if (team.facebook) {
                  _push2(`<a${ssrRenderAttr("href", team.facebook)} target="_blank" data-v-8b32445e${_scopeId}><span class="icon-facebook" data-v-8b32445e${_scopeId}></span></a>`);
                } else {
                  _push2(`<!---->`);
                }
                if (team.behance) {
                  _push2(`<a${ssrRenderAttr("href", team.behance)} target="_blank" data-v-8b32445e${_scopeId}><span class="icon-dribble" data-v-8b32445e${_scopeId}></span></a>`);
                } else {
                  _push2(`<!---->`);
                }
                if (team.linked_in) {
                  _push2(`<a${ssrRenderAttr("href", team.linked_in)} target="_blank" data-v-8b32445e${_scopeId}><span class="icon-linkedin" data-v-8b32445e${_scopeId}></span></a>`);
                } else {
                  _push2(`<!---->`);
                }
                if (team.github) {
                  _push2(`<a${ssrRenderAttr("href", team.github)} target="_blank" data-v-8b32445e${_scopeId}><span class="icon-github" data-v-8b32445e${_scopeId}></span></a>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><div class="team-two__title-box" data-v-8b32445e${_scopeId}><h3 data-v-8b32445e${_scopeId}><a href="#" data-v-8b32445e${_scopeId}>${ssrInterpolate(translateField(team.name))}</a></h3><p data-v-8b32445e${_scopeId}>${ssrInterpolate(translateField(team.position))}</p></div></div></div></div>`);
              });
              _push2(`<!--]--></div></div></div></div></div></section>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<section class="feature-one" data-v-8b32445e${_scopeId}><div class="feature-one__shape-2 float-bob-y" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", asset_path.value + "site/images/shapes/feature-one-shape-2.png")}${ssrRenderAttr("alt", trans("Decorative shape"))} width="120" height="120" loading="lazy" decoding="async" data-v-8b32445e${_scopeId}></div><div class="container" data-v-8b32445e${_scopeId}><div class="row" data-v-8b32445e${_scopeId}><div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms" data-v-8b32445e${_scopeId}><div class="feature-one__single" data-v-8b32445e${_scopeId}><div class="feature-one__img" data-v-8b32445e${_scopeId}><picture data-v-8b32445e${_scopeId}><source${ssrRenderAttr("srcset", asset_path.value + "images/home/website.webp")} type="image/webp" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", asset_path.value + "images/home/website.png")}${ssrRenderAttr("alt", trans("Web Development"))} width="80" height="80" loading="lazy" decoding="async" data-v-8b32445e${_scopeId}></picture></div><h3 class="feature-one__title" data-v-8b32445e${_scopeId}><a${ssrRenderAttr("href", _ctx.route("services.index"))} data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Web Development"))}</a></h3><p class="feature-one__text" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Custom web solutions built with cutting-edge technology to drive your business forward."))}</p></div></div><div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms" data-v-8b32445e${_scopeId}><div class="feature-one__single" data-v-8b32445e${_scopeId}><div class="feature-one__img" data-v-8b32445e${_scopeId}><picture data-v-8b32445e${_scopeId}><source${ssrRenderAttr("srcset", asset_path.value + "images/home/app-development.webp")} type="image/webp" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", asset_path.value + "images/home/app-development.png")}${ssrRenderAttr("alt", trans("Mobile Development"))} width="80" height="80" loading="lazy" decoding="async" data-v-8b32445e${_scopeId}></picture></div><h3 class="feature-one__title" data-v-8b32445e${_scopeId}><a${ssrRenderAttr("href", _ctx.route("services.index"))} data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Mobile Development"))}</a></h3><p class="feature-one__text" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Native and cross-platform mobile applications that deliver exceptional user experiences."))}</p></div></div><div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="500ms" data-v-8b32445e${_scopeId}><div class="feature-one__single" data-v-8b32445e${_scopeId}><div class="feature-one__img" data-v-8b32445e${_scopeId}><picture data-v-8b32445e${_scopeId}><source${ssrRenderAttr("srcset", asset_path.value + "images/home/microchip.webp")} type="image/webp" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", asset_path.value + "images/home/microchip.png")}${ssrRenderAttr("alt", trans("AI Agents & Automation"))} width="80" height="80" loading="lazy" decoding="async" data-v-8b32445e${_scopeId}></picture></div><h3 class="feature-one__title" data-v-8b32445e${_scopeId}><a${ssrRenderAttr("href", _ctx.route("services.index"))} data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("AI Agents & Automation"))}</a></h3><p class="feature-one__text" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Intelligent automation solutions powered by AI to streamline your business processes."))}</p></div></div><div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="700ms" data-v-8b32445e${_scopeId}><div class="feature-one__single" data-v-8b32445e${_scopeId}><div class="feature-one__img" data-v-8b32445e${_scopeId}><picture data-v-8b32445e${_scopeId}><source${ssrRenderAttr("srcset", asset_path.value + "images/home/cloud.webp")} type="image/webp" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", asset_path.value + "images/home/cloud.png")}${ssrRenderAttr("alt", trans("Cloud & Infrastructure"))} width="80" height="80" loading="lazy" decoding="async" data-v-8b32445e${_scopeId}></picture></div><h3 class="feature-one__title" data-v-8b32445e${_scopeId}><a${ssrRenderAttr("href", _ctx.route("services.index"))} data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Cloud & Infrastructure"))}</a></h3><p class="feature-one__text" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Secure, scalable, and efficient cloud services to power your growth and digital transformation."))}</p></div></div></div></div></section><section class="cta-one" data-v-8b32445e${_scopeId}><div class="cta-one__shape-bg float-bob-y" style="${ssrRenderStyle({ backgroundImage: `url(${asset_path.value}site/images/shapes/cta-one-shape-bg.png)` })}" data-v-8b32445e${_scopeId}></div><div class="container" data-v-8b32445e${_scopeId}><div class="cta-one__inner" data-v-8b32445e${_scopeId}><h3 class="cta-one__title" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Let the Symfonix experts review your technical idea"))}</h3><div class="cta-one__contact-info" data-v-8b32445e${_scopeId}><div class="cta-one__contact-icon" data-v-8b32445e${_scopeId}><span class="icon-customer-service-headset" data-v-8b32445e${_scopeId}></span></div><div class="cta-one__contact-details" data-v-8b32445e${_scopeId}><p data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Book your free consultation"))}</p><h4 data-v-8b32445e${_scopeId}><a dir="ltr"${ssrRenderAttr("href", `tel:${settings.value.phone}`)} data-v-8b32445e${_scopeId}>${ssrInterpolate(settings.value.phone)}</a></h4></div></div></div></div></section>`);
            if (testimonials.value && testimonials.value.length) {
              _push2(`<section class="testimonial-one pb-5" data-v-8b32445e${_scopeId}><div class="testimonial-one__shape-2 float-bob-y" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", asset_path.value + "images/shapes/testimonial-one-shape-2.png")}${ssrRenderAttr("alt", trans("Decorative shape"))} width="120" height="120" loading="lazy" decoding="async" data-v-8b32445e${_scopeId}></div><div class="container" data-v-8b32445e${_scopeId}><div class="row" data-v-8b32445e${_scopeId}><div class="col-xl-3" data-v-8b32445e${_scopeId}></div><div class="col-xl-9" data-v-8b32445e${_scopeId}><div class="testimonial-one__content-box" data-v-8b32445e${_scopeId}><div class="section-title text-left sec-title-animation animation-style2" data-v-8b32445e${_scopeId}><div class="section-title__tagline-box" data-v-8b32445e${_scopeId}><div class="section-title__tagline-shape-1" data-v-8b32445e${_scopeId}></div><span class="section-title__tagline" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Testimonials"))}</span><div class="section-title__tagline-shape-2" data-v-8b32445e${_scopeId}></div></div><h2 class="section-title__title title-animation" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("What Our Clients Say"))}</h2></div><div class="testimonial-one__carousel owl-theme owl-carousel" data-v-8b32445e${_scopeId}><!--[-->`);
              ssrRenderList(testimonials.value, (testimonial) => {
                _push2(`<div class="item" data-v-8b32445e${_scopeId}><div class="testimonial-one__single" data-v-8b32445e${_scopeId}><div class="testimonial-one__img-box" data-v-8b32445e${_scopeId}><div class="testimonial-one__img" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", testimonial.avatar_link)}${ssrRenderAttr("alt", translateField(testimonial.name))} width="100" height="100" loading="lazy" decoding="async" data-v-8b32445e${_scopeId}></div></div><div class="testimonial-one__content" data-v-8b32445e${_scopeId}><p class="testimonial-one__text" data-v-8b32445e${_scopeId}> “${ssrInterpolate(translateField(testimonial.quote))}” </p><div class="testimonial-one__bottom" data-v-8b32445e${_scopeId}><div class="testimonial-one__quote-and-client-info" data-v-8b32445e${_scopeId}><div class="testimonial-one__quote" data-v-8b32445e${_scopeId}><span class="icon-left" data-v-8b32445e${_scopeId}></span></div><div class="testimonial-one__client-info" data-v-8b32445e${_scopeId}><p class="testimonial-one__client-sub-title" data-v-8b32445e${_scopeId}>${ssrInterpolate(translateField(testimonial.position))}</p><h3 class="testimonial-one__client-name" data-v-8b32445e${_scopeId}><a href="#" data-v-8b32445e${_scopeId}>${ssrInterpolate(translateField(testimonial.name))}</a></h3></div></div></div></div></div></div>`);
              });
              _push2(`<!--]--></div></div></div></div></div></section>`);
            } else {
              _push2(`<!---->`);
            ...
            if (posts.value && posts.value.length) {
              _push2(`<section class="blog-two blog-three" data-v-8b32445e${_scopeId}><div class="container" data-v-8b32445e${_scopeId}><div class="row" data-v-8b32445e${_scopeId}><div class="col-xl-6" data-v-8b32445e${_scopeId}><div class="${ssrRenderClass(`blog-two__left wow fadeIn${locale.value !== "ar" ? "Left" : "Right"}`)}" data-wow-delay="100ms" data-v-8b32445e${_scopeId}><div class="section-title text-left sec-title-animation animation-style1" data-v-8b32445e${_scopeId}><div class="section-title__tagline-box" data-v-8b32445e${_scopeId}><div class="section-title__tagline-shape-1" data-v-8b32445e${_scopeId}></div><span class="section-title__tagline" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Our Blogs"))}</span><div class="section-title__tagline-shape-2" data-v-8b32445e${_scopeId}></div></div><h2 class="section-title__title title-animation" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Explore Our Latest Blogs for Expert Insights"))}</h2></div><p class="blog-two-text" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Dive into our collection of blogs where we share expert insights, helpful tips, and the latest trends in the industry"))}</p><div class="blog-two__top-btn-box" data-v-8b32445e${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("blogs.index"),
                class: "thm-btn"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(trans("View All Blogs"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow `)}" data-v-8b32445e${_scopeId2}></span>`);
                  } else {
                    return [
              ...
              if (featuredPost.value) {
                _push2(`<div class="blog-two__left-content-box d-none d-md-block" data-v-8b32445e${_scopeId}>`);
              ...
              _push2(`</div></div><div class="col-xl-6" data-v-8b32445e${_scopeId}><div class="blog-two__right" data-v-8b32445e${_scopeId}><!--[-->`);
            ...
            _push2(`<section class="contact-two" data-v-8b32445e${_scopeId}><div class="contact-two__sliding-text-list marquee_mode-2" data-v-8b32445e${_scopeId}><div class="contact-two__sliding-text-item" data-v-8b32445e${_scopeId}><h2 data-hover="Branding" class="contact-two__sliding-text-title" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("GET IN TOUCH *"))}</h2></div><div class="contact-two__sliding-text-item" data-v-8b32445e${_scopeId}><h2 data-hover="Branding" class="contact-two__sliding-text-title" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("GET IN TOUCH *"))}</h2></div><div class="contact-two__sliding-text-item" data-v-8b32445e${_scopeId}><h2 data-hover="Branding" class="contact-two__sliding-text-title" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("GET IN TOUCH *"))}</h2></div></div><div class="contact-two__shape-1 float-bob-y" data-v-8b32445e${_scopeId}><img${ssrRenderAttr("src", asset_path.value + "site/images/shapes/contact-two-shape-1.png")}${ssrRenderAttr("alt", trans("Decorative shape"))} width="120" height="120" loading="lazy" decoding="async" data-v-8b32445e${_scopeId}></div><div class="container" data-v-8b32445e${_scopeId}><div class="row" data-v-8b32445e${_scopeId}><div class="col-xl-6" data-v-8b32445e${_scopeId}><div class="contact-two__left" data-v-8b32445e${_scopeId}><div class="section-title text-left sec-title-animation animation-style2" data-v-8b32445e${_scopeId}><div class="section-title__tagline-box" data-v-8b32445e${_scopeId}><div class="section-title__tagline-shape-1" data-v-8b32445e${_scopeId}></div><span class="section-title__tagline" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Get In Touch"))}</span><div class="section-title__tagline-shape-2" data-v-8b32445e${_scopeId}></div></div><h2 class="section-title__title title-animation" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Contact Us"))}</h2></div><p class="contact-two__text" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Fill out the form below and we'll get back to you as soon as possible"))}</p><ul class="contact-two__contact-list list-unstyled" data-v-8b32445e${_scopeId}>`);
            if (settings.value.email) {
              _push2(`<li data-v-8b32445e${_scopeId}><div class="icon" data-v-8b32445e${_scopeId}><span class="icon-mail" data-v-8b32445e${_scopeId}></span></div><div class="content" data-v-8b32445e${_scopeId}><h3 class="h4" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Email"))}</h3><p data-v-8b32445e${_scopeId}><a dir="ltr"${ssrRenderAttr("href", `mailto:${settings.value.email}`)} data-v-8b32445e${_scopeId}>${ssrInterpolate(settings.value.email)}</a></p></div></li>`);
            } else {
              _push2(`<!---->`);
            }
            if (settings.value.phone) {
              _push2(`<li data-v-8b32445e${_scopeId}><div class="icon" data-v-8b32445e${_scopeId}><span class="icon-phone-call" data-v-8b32445e${_scopeId}></span></div><div class="content" data-v-8b32445e${_scopeId}><h3 class="h4" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Phone"))}</h3><p data-v-8b32445e${_scopeId}><a dir="ltr"${ssrRenderAttr("href", `tel:${settings.value.phone}`)} data-v-8b32445e${_scopeId}>${ssrInterpolate(settings.value.phone)}</a></p></div></li>`);
            } else {
              _push2(`<!---->`);
            }
            if (settings.value.address) {
              _push2(`<li data-v-8b32445e${_scopeId}><div class="icon" data-v-8b32445e${_scopeId}><span class="icon-pin" data-v-8b32445e${_scopeId}></span></div><div class="content" data-v-8b32445e${_scopeId}><h3 class="h4" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Our Location"))}</h3><p data-v-8b32445e${_scopeId}>${ssrInterpolate(settings.value.address)}</p></div></li>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</ul></div></div><div class="col-xl-6" data-v-8b32445e${_scopeId}><div class="${ssrRenderClass(`contact-two__right wow slideIn${locale.value === "ar" ? "Left" : "Right"}`)}" data-wow-delay="100ms" data-wow-duration="2500ms" data-v-8b32445e${_scopeId}><form class="contact-form-validated contact-one__form" data-v-8b32445e${_scopeId}><div class="row" data-v-8b32445e${_scopeId}><div class="col-xl-6 col-lg-6" data-v-8b32445e${_scopeId}><h3 class="h4 contact-one__input-title" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Full Name"))}</h3><div class="contact-one__input-box" data-v-8b32445e${_scopeId}><div class="contact-one__input-icon" data-v-8b32445e${_scopeId}><span class="icon-user-1" data-v-8b32445e${_scopeId}></span></div><input${ssrRenderAttr("value", unref(contactForm).name)} type="text" name="name"${ssrRenderAttr("placeholder", trans("Full Name"))} class="${ssrRenderClass({ "error": unref(contactForm).errors.name })}"${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} required data-v-8b32445e${_scopeId}></div>`);
            if (unref(contactForm).errors.name) {
              _push2(`<div class="text-danger mt-1 small" data-v-8b32445e${_scopeId}>${ssrInterpolate(unref(contactForm).errors.name)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="col-xl-6 col-lg-6" data-v-8b32445e${_scopeId}><h3 class="h4 contact-one__input-title" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Email"))}</h3><div class="contact-one__input-box" data-v-8b32445e${_scopeId}><div class="contact-one__input-icon" data-v-8b32445e${_scopeId}><span class="icon-email" data-v-8b32445e${_scopeId}></span></div><input type="email" name="email"${ssrRenderAttr("value", unref(contactForm).email)}${ssrRenderAttr("placeholder", trans("Email"))}${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} class="${ssrRenderClass({ "error": unref(contactForm).errors.email })}" required data-v-8b32445e${_scopeId}>`);
            if (unref(contactForm).errors.email) {
              _push2(`<div class="text-danger mt-1 small" data-v-8b32445e${_scopeId}>${ssrInterpolate(unref(contactForm).errors.email)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="col-xl-6 col-lg-6" data-v-8b32445e${_scopeId}><h3 class="h4 contact-one__input-title" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Phone Number"))}</h3><div class="contact-one__input-box" data-v-8b32445e${_scopeId}><div class="contact-one__input-icon" data-v-8b32445e${_scopeId}><span class="icon-phone-call" data-v-8b32445e${_scopeId}></span></div><input${ssrRenderAttr("value", unref(contactForm).mobile)} type="text" name="mobile"${ssrRenderAttr("placeholder", trans("Phone Number"))} class="${ssrRenderClass({ "error": unref(contactForm).errors.mobile })}"${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} required data-v-8b32445e${_scopeId}></div>`);
            if (unref(contactForm).errors.mobile) {
              _push2(`<div class="text-danger mt-1 small" data-v-8b32445e${_scopeId}>${ssrInterpolate(unref(contactForm).errors.mobile)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="col-xl-6 col-lg-6" data-v-8b32445e${_scopeId}><h3 class="h4 contact-one__input-title" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Subject"))}</h3><div class="contact-one__input-box" data-v-8b32445e${_scopeId}><div class="contact-one__input-icon" data-v-8b32445e${_scopeId}><span class="icon-edit" data-v-8b32445e${_scopeId}></span></div><input type="text" name="subject"${ssrRenderAttr("value", unref(contactForm).subject)}${ssrRenderAttr("placeholder", trans("Subject"))}${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} class="${ssrRenderClass({ "error": unref(contactForm).errors.subject })}" required data-v-8b32445e${_scopeId}>`);
            if (unref(contactForm).errors.subject) {
              _push2(`<div class="text-danger mt-1 small" data-v-8b32445e${_scopeId}>${ssrInterpolate(unref(contactForm).errors.subject)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="col-xl-12" data-v-8b32445e${_scopeId}><h3 class="h4 contact-one__input-title" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Message"))}</h3><div class="contact-one__input-box text-message-box" data-v-8b32445e${_scopeId}><div class="contact-one__input-icon" data-v-8b32445e${_scopeId}><span class="icon-edit" data-v-8b32445e${_scopeId}></span></div><textarea name="message"${ssrRenderAttr("placeholder", trans("Write your message"))} class="${ssrRenderClass({ "error": unref(contactForm).errors.message })}"${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} required data-v-8b32445e${_scopeId}>${ssrInterpolate(unref(contactForm).message)}</textarea></div>`);
            if (unref(contactForm).errors.message) {
              _push2(`<div class="text-danger mt-1 small" data-v-8b32445e${_scopeId}>${ssrInterpolate(unref(contactForm).errors.message)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="contact-one__btn-box" data-v-8b32445e${_scopeId}><button type="submit"${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} class="${ssrRenderClass([{ "opacity-50": unref(contactForm).processing }, "thm-btn"])}" data-v-8b32445e${_scopeId}>`);
            if (unref(contactForm).processing) {
              _push2(`<span data-v-8b32445e${_scopeId}><i class="fa-solid fa-spinner fa-spin me-2" data-v-8b32445e${_scopeId}></i>${ssrInterpolate(trans("Sending..."))}</span>`);
            } else {
              _push2(`<span data-v-8b32445e${_scopeId}><span data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Submit"))}</span> <i class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow mx-1`)}" data-v-8b32445e${_scopeId}></i></span>`);
            }
            _push2(`</button></div></div>`);
            if (contactSubmitSuccess.value) {
              _push2(`<div class="col-12 mt-3" data-v-8b32445e${_scopeId}><div class="alert alert-success" data-v-8b32445e${_scopeId}>${ssrInterpolate(trans("Thank you for contacting us! We will get back to you soon."))}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</form><div class="result" data-v-8b32445e${_scopeId}></div></div></div></div></div></section>`);
          } else {
            return [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "banner-one__inner" }, [
                    createVNode("h1", { class: "banner-one__title px-4" }, [
                      ...
                      createVNode("br"),
                      createVNode("span", null, toDisplayString(trans("Help companies build practical technology solutions in Web, AI, automation, and cloud computing — designed for growth and sustainability")), 1)
                    ]),
                  ...
                  createVNode("div", { class: "row" }, [
                        ...
                        createVNode("div", { class: "about-three__img-box" }, [
                          createVNode("div", { class: "about-three__img" }, [
                            createVNode("picture", null, [
                              createVNode("source", {
                                srcset: asset_path.value + "images/home/about_us.webp",
                                type: "image/webp"
                              }, null, 8, ["srcset"]),
                              createVNode("img", {
                    ...
                    createVNode("div", { class: "col-xl-6" }, [
                      createVNode("div", { class: "about-three__right" }, [
                        createVNode("div", { class: "section-title sec-title-animation animation-style1" }, [
                          createVNode("div", { class: "section-title__tagline-box" }, [
                            createVNode("div", { class: "section-title__tagline-shape-1" }),
                            createVNode("span", { class: "section-title__tagline" }, toDisplayString(trans("Our Tech Solutions")), 1),
                            createVNode("div", { class: "section-title__tagline-shape-2" })
                          ]),
                          createVNode("h2", { class: "section-title__title title-animation" }, toDisplayString(trans("Why Choose Symfonix for Web, AI, and Cloud")), 1)
                        ]),
                        ...
                        createVNode("ul", { class: "about-three__points list-unstyled" }, [
                          createVNode("li", null, [
                            ...
                            createVNode("div", { class: "content" }, [
                              createVNode("h2", { class: "h3" }, toDisplayString(trans("Developing Secure & Scalable Systems")), 1)
                            ])
                          ]),
                          createVNode("li", null, [
                            createVNode("div", { class: "icon" }, [
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(servicesCategories.value, (servicesCategory) => {
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode(ServiceCardThree, {
                          ...
                          "button-label": trans("Read More"),
                          "is-rtl": locale.value === "ar"
                        }, null, 8, ["title", "short-desc", "description", "highlights", "link", "image", "button-label", "is-rtl"])
                      ]);
                    }), 128))
                  ]),
              ...
              products.value && products.value.length ? (openBlock(), createBlock("section", {
                key: 1,
                class: "home-products products-page"
              }, [
                createVNode("div", {
                ...
                createVNode("div", { class: "container position-relative" }, [
                  createVNode("div", { class: "section-title text-center sec-title-animation animation-style1 home-products__head" }, [
                    createVNode("div", { class: "section-title__tagline-box" }, [
                      createVNode("div", { class: "section-title__tagline-shape-1" }),
                      createVNode("span", { class: "section-title__tagline" }, toDisplayString(trans("Our Products")), 1),
                      createVNode("div", { class: "section-title__tagline-shape-2" })
                    ]),
                    createVNode("h2", { class: "section-title__title title-animation" }, toDisplayString(trans("B2B Solutions Built for Scale")), 1),
                    createVNode("p", { class: "home-products__intro" }, toDisplayString(trans("Discover enterprise-ready platforms and services designed to grow with your business.")), 1)
                  ]),
                  createVNode("div", { class: "home-products__grid" }, [
                  ...
                  createVNode("div", { class: "text-center home-products__cta" }, [
                    createVNode(unref(Link), {
                      href: _ctx.route("product.index"),
                      class: "thm-btn"
                    }, {
              ...
              useCases.value && useCases.value.length ? (openBlock(), createBlock("section", {
                key: 2,
                class: "home-case-studies use-cases-page"
              }, [
                createVNode("div", {
                ...
                createVNode("div", { class: "container position-relative" }, [
                  createVNode("div", { class: "section-title text-center sec-title-animation animation-style1" }, [
                    ...
                    createVNode("p", { class: "home-case-studies__intro" }, toDisplayString(trans("Explore our success stories and real-world solutions we've delivered for businesses.")), 1)
                  ]),
                  createVNode("div", { class: "use-cases-page__grid" }, [
                    createVNode("div", { class: "row g-4" }, [
                  ...
                  createVNode("div", { class: "text-center home-case-studies__cta" }, [
                    createVNode(unref(Link), {
                      href: _ctx.route("use-cases.index"),
                      class: "thm-btn"
                    }, {
                    ...
                    createVNode("div", { class: "col-xl-6" }, [
                      createVNode("div", {
                        ...
                        createVNode("div", { class: "why-choose-two__img" }, [
                          createVNode("picture", null, [
                            createVNode("source", {
                              srcset: asset_path.value + "images/home/why_choose_us.webp",
                              type: "image/webp"
                            }, null, 8, ["srcset"]),
                            createVNode("img", {
                    ...
                    createVNode("div", { class: "col-xl-6" }, [
                      createVNode("div", { class: "why-choose-two__right" }, [
                        createVNode("div", { class: "section-title text-left sec-title-animation animation-style2" }, [
                          ...
                          createVNode("h2", { class: "section-title__title title-animation" }, toDisplayString(trans("How do we deliver reliable, future-ready IT solutions?")), 1)
                        ]),
                    ...
                    createVNode("div", {
                      ...
                      createVNode("div", { class: "feature-one__single" }, [
                        createVNode("div", { class: "feature-one__img" }, [
                          createVNode("picture", null, [
                            createVNode("source", {
                              srcset: asset_path.value + "images/home/website.webp",
                              type: "image/webp"
                            }, null, 8, ["srcset"]),
                            createVNode("img", {
                        ...
                        createVNode("h3", { class: "feature-one__title" }, [
                          createVNode("a", {
                            href: _ctx.route("services.index")
                          }, toDisplayString(trans("Web Development")), 9, ["href"])
                        ]),
                    ...
                    createVNode("div", {
                      ...
                      createVNode("div", { class: "feature-one__single" }, [
                        createVNode("div", { class: "feature-one__img" }, [
                          createVNode("picture", null, [
                            createVNode("source", {
                              srcset: asset_path.value + "images/home/app-development.webp",
                              type: "image/webp"
                            }, null, 8, ["srcset"]),
                            createVNode("img", {
                        ...
                        createVNode("h3", { class: "feature-one__title" }, [
                          createVNode("a", {
                            href: _ctx.route("services.index")
                          }, toDisplayString(trans("Mobile Development")), 9, ["href"])
                        ]),
                    ...
                    createVNode("div", {
                      ...
                      createVNode("div", { class: "feature-one__single" }, [
                        createVNode("div", { class: "feature-one__img" }, [
                          createVNode("picture", null, [
                            createVNode("source", {
                              srcset: asset_path.value + "images/home/microchip.webp",
                              type: "image/webp"
                            }, null, 8, ["srcset"]),
                            createVNode("img", {
                        ...
                        createVNode("h3", { class: "feature-one__title" }, [
                          createVNode("a", {
                            href: _ctx.route("services.index")
                          }, toDisplayString(trans("AI Agents & Automation")), 9, ["href"])
                        ]),
                    ...
                    createVNode("div", {
                      ...
                      createVNode("div", { class: "feature-one__single" }, [
                        createVNode("div", { class: "feature-one__img" }, [
                          createVNode("picture", null, [
                            createVNode("source", {
                              srcset: asset_path.value + "images/home/cloud.webp",
                              type: "image/webp"
                            }, null, 8, ["srcset"]),
                            createVNode("img", {
                        ...
                        createVNode("h3", { class: "feature-one__title" }, [
                          createVNode("a", {
                            href: _ctx.route("services.index")
                          }, toDisplayString(trans("Cloud & Infrastructure")), 9, ["href"])
                        ]),
              ...
              createVNode("section", { class: "cta-one" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "cta-one__inner" }, [
                    createVNode("h3", { class: "cta-one__title" }, toDisplayString(trans("Let the Symfonix experts review your technical idea")), 1),
                    createVNode("div", { class: "cta-one__contact-info" }, [
                      ...
                      createVNode("div", { class: "cta-one__contact-details" }, [
                        createVNode("p", null, toDisplayString(trans("Book your free consultation")), 1),
                        createVNode("h4", null, [
                          createVNode("a", {
                            dir: "ltr",
                            href: `tel:${settings.value.phone}`
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["__scopeId", "data-v-8b32445e"]]);
              ...
              createVNode("section", { class: "page-header" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h1", null, toDisplayString(trans("Contact Us")), 1),
          ...
          if (_push2) {
            ...
            if (typeof _ctx.route !== "undefined") {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(trans("Get in Touch"))} <span class="${ssrRenderClass(`icon-${isRtl.value ? "left" : "right"}-arrow`)}"${_scopeId2}></span>`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(trans("Get in Touch")) + " ", 1),
                      createVNode("span", {
                        class: `icon-${isRtl.value ? "left" : "right"}-arrow`
                      }, null, 2)
                    ];
                  }
                }),
            ...
            return [
              createVNode("section", { class: "page-header" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h1", null, toDisplayString(trans("About Us")), 1),
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        createVNode("li", null, [
                        ...
                        createVNode("li", null, [
                          createVNode("span", {
                            class: `icon-${isRtl.value ? "left" : "right"}-arrow-1`
                          }, null, 2)
                        ]),
              ...
              createVNode("section", { class: "about-four" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "row" }, [
                    createVNode("div", { class: "col-xl-6" }, [
                      createVNode("div", {
                        class: `about-four__left wow slideIn${isRtl.value ? "Right" : "Left"}`,
                        "data-wow-delay": "100ms",
                        "data-wow-duration": "2500ms"
                      }, [
                        createVNode("div", { class: "about-four__img-box" }, [
                          ...
                          createVNode("div", { class: "about-four__img-2" }, [
                            createVNode("img", {
                              src: asset_path.value + "images/about/about-four-img-12.jpg",
                              alt: trans("About our company")
                            }, null, 8, ["src", "alt"])
                          ]),
                    ...
                    createVNode("div", { class: "col-xl-6" }, [
                      createVNode("div", { class: "about-four__right" }, [
                        createVNode("div", { class: "section-title text-left sec-title-animation animation-style2" }, [
                          ...
                          !isRtl.value ? (openBlock(), createBlock("h2", {
                            key: 0,
                            class: "section-title__title title-animation"
                          }, [
...
const _sfc_main$x = {
  ...
  setup(__props) {
    ...
    const locale = computed(() => page.props.locale);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "cta-two" }, _attrs))}><div class="cta-two__bg-color"><div class="cta-two__shape-1 img-bounce"><img${ssrRenderAttr("src", asset_path.value + "site/images/shapes/cta-two-shape-1.png")} alt=""></div><div class="cta-two__shape-2 float-bob-y"><img${ssrRenderAttr("src", asset_path.value + "site/images/shapes/cta-two-shape-2.png")} alt=""></div></div><div class="container"><div class="row"><div class="col-xl-7 col-lg-7"><div class="cta-two__left"><div class="section-title text-left sec-title-animation animation-style2"><div class="section-title__tagline-box"><div class="section-title__tagline-shape-1"></div><span class="section-title__tagline">${ssrInterpolate(trans("Start now"))}</span><div class="section-title__tagline-shape-2"></div></div><h2 class="section-title__title title-animation">${ssrInterpolate(trans("Are you ready to take your project to the next stage?"))}</h2></div><div class="cta-two__btn-box">`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("contact-us"),
        class: "thm-btn"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(trans("Book your free consultation"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow`)}"${_scopeId}></span>`);
          } else {
            return [
              createTextVNode(toDisplayString(trans("Book your free consultation")) + " ", 1),
              createVNode("span", {
      ...
      _push(`</div></div></div><div class="col-xl-5 col-lg-5"><div class="${ssrRenderClass(`cta-two__right wow slideIn${locale.value === "ar" ? "Left" : "Right"}`)}" data-wow-delay="100ms" data-wow-duration="2500ms"><h3 class="cta-two__title">${ssrInterpolate(trans("24/7 Technical Support"))}</h3><p class="cta-two__text">${ssrInterpolate(trans("Professional technical support and immediate solutions for your project to ensure the uninterrupted continuity of your business."))}</p><ul class="cta-two__list list-unstyled"><li><div class="icon"><span class="icon-mail"></span></div><div class="content"><h4>${ssrInterpolate(trans("Contact our experts"))}</h4><p><a${ssrRenderAttr("href", `mailto:${settings.value.email}`)}>${ssrInterpolate(settings.value.email)}</a></p></div></li><li><div class="icon"><span class="icon-phone-call"></span></div><div class="content"><h4>${ssrInterpolate(trans("Contact Us"))}</h4><p>${ssrInterpolate(trans("Tel:"))} <a${ssrRenderAttr("href", `tel:${settings.value.phone}`)}>${ssrInterpolate(settings.value.phone)}</a></p></div></li></ul></div></div></div></div></section>`);
    };
  }
};
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "page-header" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h1", null, toDisplayString(trans("Our Blogs")), 1),
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        createVNode("li", null, [
                          createVNode(unref(Link), {
...
const _sfc_main$v = /* @__PURE__ */ Object.assign(__default__$d, {
  __name: "BlogShow",
  __ssrInlineRender: true,
  setup(__props) {
    const page = usePage();
      ...
      _push(ssrRenderComponent(_sfc_main$D, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</li><li${_scopeId}><span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}"${_scopeId}></span></li><li${_scopeId}>${ssrInterpolate(blog.value.title)}</li></ul></div></div></div></section><section class="blog-details"${_scopeId}><div class="container"${_scopeId}><div class="row"${_scopeId}><div class="col-xl-8 col-lg-7"${_scopeId}><div class="blog-details__left"${_scopeId}><div class="blog-details__img"${_scopeId}><img${ssrRenderAttr("src", blog.value.image_link)}${ssrRenderAttr("alt", blog.value.title)} loading="lazy" decoding="async"${_scopeId}></div><div class="blog-details__single-content"${_scopeId}><ul class="blog-details__meta list-unstyled"${_scopeId}><li${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
            ...
            _push2(`</li></ul><h1 class="blog-details__title"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("blogs.show", blog.value.slug)
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            ...
            _push2(`</h1><div class="blog-details__text"${_scopeId}>${blog.value.content ?? ""}</div></div>`);
                  ...
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        ...
                        createVNode("li", null, toDisplayString(blog.value.title), 1)
                      ])
                    ])
                  ])
                ])
                    ...
                    createVNode("div", { class: "col-xl-8 col-lg-7" }, [
                      createVNode("div", { class: "blog-details__left" }, [
                        ...
                        createVNode("div", { class: "blog-details__single-content" }, [
                          ...
                          createVNode("h1", { class: "blog-details__title" }, [
                            createVNode(unref(Link), {
                              href: _ctx.route("blogs.show", blog.value.slug)
                            }, {
                              default: withCtx(() => [
...
const _sfc_main$u = /* @__PURE__ */ Object.assign(__default__$c, {
  __name: "Faq",
  __ssrInlineRender: true,
  setup(__props) {
    const page = usePage();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/page-header.css")} data-v-f57d8941${_scopeId}><link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/faq.css")} data-v-f57d8941${_scopeId}><title data-v-f57d8941${_scopeId}>${ssrInterpolate(metaTitle.value)}</title><meta name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-f57d8941${_scopeId}><meta name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-f57d8941${_scopeId}><meta name="robots"${ssrRenderAttr("content", metaRobots.value)} data-v-f57d8941${_scopeId}>`);
            if (metaCanonical.value) {
              _push2(`<link rel="canonical"${ssrRenderAttr("href", metaCanonical.value)} data-v-f57d8941${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:title"${ssrRenderAttr("content", metaTitle.value)} data-v-f57d8941${_scopeId}><meta property="og:description"${ssrRenderAttr("content", metaDescription.value)} data-v-f57d8941${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta property="og:image"${ssrRenderAttr("content", metaImage.value)} data-v-f57d8941${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (metaCanonical.value) {
              _push2(`<meta property="og:url"${ssrRenderAttr("content", metaCanonical.value)} data-v-f57d8941${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:type" content="website" data-v-f57d8941${_scopeId}><meta name="twitter:card" content="summary_large_image" data-v-f57d8941${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", metaTitle.value)} data-v-f57d8941${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", metaDescription.value)} data-v-f57d8941${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta name="twitter:image"${ssrRenderAttr("content", metaImage.value)} data-v-f57d8941${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              createVNode("link", {
                rel: "stylesheet",
                href: asset_path.value + "site/css/module-css/faq.css"
              }, null, 8, ["href"]),
              createVNode("title", null, toDisplayString(metaTitle.value), 1),
              createVNode("meta", {
                name: "description",
          ...
          if (_push2) {
            ...
            if (typeof _ctx.route !== "undefined") {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<i class="fas fa-home" data-v-f57d8941${_scopeId2}></i>${ssrInterpolate(trans("Home"))}`);
                  } else {
                    return [
                      createVNode("i", { class: "fas fa-home" }),
                      createTextVNode(toDisplayString(trans("Home")), 1)
              ...
              _push2(`<a${ssrRenderAttr("href", `/${locale.value === "ar" ? "ar" : ""}`)} data-v-f57d8941${_scopeId}><i class="fas fa-home" data-v-f57d8941${_scopeId}></i>${ssrInterpolate(trans("Home"))}</a>`);
            }
            _push2(`</li><li data-v-f57d8941${_scopeId}><span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-f57d8941${_scopeId}></span></li><li data-v-f57d8941${_scopeId}>${trans("FAQs") ?? ""}</li></ul></div></div></div></section><section class="faq-two faq-page" data-v-f57d8941${_scopeId}><div class="container" data-v-f57d8941${_scopeId}><div class="section-title text-center sec-title-animation animation-style1" data-v-f57d8941${_scopeId}><div class="section-title__tagline-box" data-v-f57d8941${_scopeId}><div class="section-title__tagline-shape-1" data-v-f57d8941${_scopeId}></div><span class="section-title__tagline" data-v-f57d8941${_scopeId}>${ssrInterpolate(trans("FAQs"))}</span><div class="section-title__tagline-shape-2" data-v-f57d8941${_scopeId}></div></div><h2 class="section-title__title title-animation" data-v-f57d8941${_scopeId}>${ssrInterpolate(trans("Get answers to the most common questions about our products, services, and policies."))}</h2></div><div class="faq-two__right" data-v-f57d8941${_scopeId}>`);
            if (faqs.value && faqs.value.length > 0) {
              _push2(`<div class="accrodion-grp" data-grp-name="faq-one-accrodion" data-v-f57d8941${_scopeId}><!--[-->`);
              ssrRenderList(faqs.value, (faq, index) => {
                _push2(`<div class="${ssrRenderClass([{ "active": activeIndex.value === index }, "accrodion"])}" data-v-f57d8941${_scopeId}><div class="accrodion-title" data-v-f57d8941${_scopeId}><h4 data-v-f57d8941${_scopeId}>${ssrInterpolate(translateField(faq.question))}</h4></div><div class="accrodion-content" style="${ssrRenderStyle(activeIndex.value === index ? null : { display: "none" })}" data-v-f57d8941${_scopeId}><div class="inner" data-v-f57d8941${_scopeId}><p class="accrodion-content__text-1" data-v-f57d8941${_scopeId}>${translateField(faq.answer) ?? ""}</p></div></div></div>`);
              });
              _push2(`<!--]--></div>`);
            } else {
              _push2(`<div class="text-center py-5" data-v-f57d8941${_scopeId}><p data-v-f57d8941${_scopeId}>${ssrInterpolate(trans("No FAQs found."))}</p></div>`);
            }
            _push2(`</div></div></section>`);
            _push2(ssrRenderComponent(_sfc_main$x, null, null, _parent2, _scopeId));
          } else {
            return [
              ...
              createVNode("section", { class: "faq-two faq-page" }, [
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "section-title text-center sec-title-animation animation-style1" }, [
                    createVNode("div", { class: "section-title__tagline-box" }, [
                      createVNode("div", { class: "section-title__tagline-shape-1" }),
...
const Faq = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["__scopeId", "data-v-f57d8941"]]);
...
const _sfc_main$t = /* @__PURE__ */ Object.assign(__default__$b, {
  __name: "PageShow",
  __ssrInlineRender: true,
  setup(__props) {
    const page = usePage();
          ...
          if (_push2) {
            ...
            return [
              createVNode("section", { class: "page-header" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h1", null, toDisplayString(custom_page.value.title[locale.value]), 1),
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        createVNode("li", null, [
                          typeof _ctx.route !== "undefined" ? (openBlock(), createBlock(unref(Link), {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/page-header.css")} data-v-e574eeb2${_scopeId}><title data-v-e574eeb2${_scopeId}>${ssrInterpolate(metaTitle.value)}</title><meta name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-e574eeb2${_scopeId}><meta name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-e574eeb2${_scopeId}><meta name="robots"${ssrRenderAttr("content", metaRobots.value)} data-v-e574eeb2${_scopeId}>`);
            if (metaCanonical.value) {
              _push2(`<link rel="canonical"${ssrRenderAttr("href", metaCanonical.value)} data-v-e574eeb2${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:title"${ssrRenderAttr("content", metaTitle.value)} data-v-e574eeb2${_scopeId}><meta property="og:description"${ssrRenderAttr("content", metaDescription.value)} data-v-e574eeb2${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta property="og:image"${ssrRenderAttr("content", metaImage.value)} data-v-e574eeb2${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (metaCanonical.value) {
              _push2(`<meta property="og:url"${ssrRenderAttr("content", metaCanonical.value)} data-v-e574eeb2${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:type" content="website" data-v-e574eeb2${_scopeId}><meta name="twitter:card" content="summary_large_image" data-v-e574eeb2${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", metaTitle.value)} data-v-e574eeb2${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", metaDescription.value)} data-v-e574eeb2${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta name="twitter:image"${ssrRenderAttr("content", metaImage.value)} data-v-e574eeb2${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_sfc_main$D, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<section class="page-header" data-v-e574eeb2${_scopeId}><div class="page-header__bg" style="${ssrRenderStyle({ backgroundImage: `url(${asset_path.value}images/contact-header-bg.jpg)` })}" data-v-e574eeb2${_scopeId}></div><div class="container" data-v-e574eeb2${_scopeId}><div class="page-header__inner" data-v-e574eeb2${_scopeId}><h1 data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Privacy Policy"))}</h1><div class="thm-breadcrumb__box" data-v-e574eeb2${_scopeId}><ul class="thm-breadcrumb list-unstyled" data-v-e574eeb2${_scopeId}><li data-v-e574eeb2${_scopeId}>`);
            if (typeof _ctx.route !== "undefined") {
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("home")
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<i class="fas fa-home" data-v-e574eeb2${_scopeId2}></i>${ssrInterpolate(trans("Home"))}`);
                  } else {
                    return [
                      createVNode("i", { class: "fas fa-home" }),
                      createTextVNode(toDisplayString(trans("Home")), 1)
              ...
              _push2(`<a${ssrRenderAttr("href", `/${locale.value === "ar" ? "ar" : ""}`)} data-v-e574eeb2${_scopeId}><i class="fas fa-home" data-v-e574eeb2${_scopeId}></i>${ssrInterpolate(trans("Home"))}</a>`);
            }
            _push2(`</li><li data-v-e574eeb2${_scopeId}><span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-e574eeb2${_scopeId}></span></li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Privacy Policy"))}</li></ul></div></div></div></section><section class="privacy-policy my-5" data-v-e574eeb2${_scopeId}><div class="container" data-v-e574eeb2${_scopeId}><div class="row" data-v-e574eeb2${_scopeId}><div class="col-xl-12" data-v-e574eeb2${_scopeId}><div class="privacy-policy__content" data-v-e574eeb2${_scopeId}><div class="privacy-policy__text" data-v-e574eeb2${_scopeId}><p class="privacy-policy__last-updated" data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Last Updated:"))}</strong> ${ssrInterpolate((/* @__PURE__ */ new Date()).toLocaleDateString())}</p><h3 class="privacy-policy__heading" data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("1. Introduction"))}</h3><p data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Welcome to our Privacy Policy. This document explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site."))}</p><h3 class="privacy-policy__heading" data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("2. Information We Collect"))}</h3><p data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("We may collect information about you in a variety of ways. The information we may collect on the site includes:"))}</p><ul data-v-e574eeb2${_scopeId}><li data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Personal Data"))}</strong>: ${ssrInterpolate(trans("Personally identifiable information, such as your name, email address, phone number, and demographic information that you voluntarily give to us when you register with the site or when you choose to participate in various activities related to the site."))}</li><li data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Derivative Data"))}</strong>: ${ssrInterpolate(trans("Information our servers automatically collect when you access the site, such as your IP address, your browser type, your operating system, your access times, and the pages you have viewed directly before and after accessing the site."))}</li><li data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Financial Data"))}</strong>: ${ssrInterpolate(trans("Financial information, such as data related to your payment method (e.g., valid credit card number, card brand, expiration date) that we may collect when you purchase, order, return, exchange, or request information about our services from the site."))}</li><li data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Mobile Device Data"))}</strong>: ${ssrInterpolate(trans("Device information, such as your mobile device ID, model, and manufacturer, and information about the location of your device, if you access the site from a mobile device."))}</li></ul><h3 class="privacy-policy__heading" data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("3. How We Use Your Information"))}</h3><p data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Having accurate information about you permits us to provide you with a smooth, efficient, and customized experience. Specifically, we may use information collected about you via the site to:"))}</p><ul data-v-e574eeb2${_scopeId}><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Create and manage your account"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Process your transactions and send you related information"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Email you regarding your account or order"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Fulfill and manage purchases, orders, payments, and other transactions related to the site"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Generate a personal profile about you to make future visits more personalized"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Increase the efficiency and operation of the site"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Monitor and analyze usage and trends to improve your experience with the site"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Notify you of updates to the site"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Perform other business activities as needed"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Request feedback and contact you about your use of the site"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Resolve disputes and troubleshoot problems"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Respond to product and customer service requests"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Send you a newsletter"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Solicit support for the site"))}</li></ul><h3 class="privacy-policy__heading" data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("4. Disclosure of Your Information"))}</h3><p data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("We may share information we have collected about you in certain situations. Your information may be disclosed as follows:"))}</p><ul data-v-e574eeb2${_scopeId}><li data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("By Law or to Protect Rights"))}</strong>: ${ssrInterpolate(trans("If we believe the release of information about you is necessary to respond to legal process, to investigate or remedy potential violations of our policies, or to protect the rights, property, and safety of others, we may share your information as permitted or required by any applicable law, rule, or regulation."))}</li><li data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Third-Party Service Providers"))}</strong>: ${ssrInterpolate(trans("We may share your information with third parties that perform services for us or on our behalf, including payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance."))}</li><li data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Business Transfers"))}</strong>: ${ssrInterpolate(trans("We may share or transfer your information in connection with, or during negotiations of, any merger, sale of company assets, financing, or acquisition of all or a portion of our business to another company."))}</li><li data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Affiliates"))}</strong>: ${ssrInterpolate(trans("We may share your information with our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include our parent company and any subsidiaries, joint venture partners, or other companies that we control or that are under common control with us."))}</li><li data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Business Partners"))}</strong>: ${ssrInterpolate(trans("We may share your information with our business partners to offer you certain products, services, or promotions."))}</li></ul><h3 class="privacy-policy__heading" data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("5. Security of Your Information"))}</h3><p data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse. Any information disclosed online is vulnerable to interception and misuse by unauthorized parties. Therefore, we cannot guarantee complete security if you provide personal information."))}</p><h3 class="privacy-policy__heading" data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("6. Policy for Children"))}</h3><p data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("We do not knowingly solicit information from or market to children under the age of 13. If we learn that we have collected personal information from a child under age 13 without verification of parental consent, we will delete that information as quickly as possible. If you become aware of any data we have collected from children under age 13, please contact us."))}</p><h3 class="privacy-policy__heading" data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("7. Your Rights"))}</h3><p data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Depending on your location, you may have the following rights regarding your personal information:"))}</p><ul data-v-e574eeb2${_scopeId}><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("The right to access – You have the right to request copies of your personal data"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("The right to rectification – You have the right to request that we correct any information you believe is inaccurate"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("The right to erasure – You have the right to request that we erase your personal data, under certain conditions"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("The right to restrict processing – You have the right to request that we restrict the processing of your personal data, under certain conditions"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("The right to object to processing – You have the right to object to our processing of your personal data, under certain conditions"))}</li><li data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("The right to data portability – You have the right to request that we transfer the data that we have collected to another organization, or directly to you, under certain conditions"))}</li></ul><h3 class="privacy-policy__heading" data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("8. Cookies and Tracking Technologies"))}</h3><p data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("We may use cookies, web beacons, tracking pixels, and other tracking technologies on the site to help customize the site and improve your experience. When you access the site, your personal information is not collected through the use of tracking technology. Most browsers are set to accept cookies by default. You can remove or reject cookies, but be aware that such action could affect the availability and functionality of the site."))}</p><h3 class="privacy-policy__heading" data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("9. Third-Party Websites"))}</h3><p data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("The site may contain links to third-party websites and applications of interest, including advertisements and external services, that are not affiliated with us. Once you have used these links to leave the site, any information you provide to these third parties is not covered by this Privacy Policy, and we cannot guarantee the safety and privacy of your information. Before visiting and providing any information to any third-party websites, you should inform yourself of the privacy policies and practices (if any) of the third party responsible for that website, and should take those steps necessary to, in your discretion, protect the privacy of your information."))}</p><h3 class="privacy-policy__heading" data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("10. Changes to This Privacy Policy"))}</h3><p data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans('We may update this Privacy Policy from time to time in order to reflect, for example, changes to our practices or for other operational, legal, or regulatory reasons. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last Updated" date. You are advised to review this Privacy Policy periodically for any changes.'))}</p><h3 class="privacy-policy__heading" data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("11. Contact Us"))}</h3><p data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("If you have questions or comments about this Privacy Policy, please contact us at:"))}</p><p data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Email:"))}</strong> ${ssrInterpolate((_a = settings.value) == null ? void 0 : _a.email)}<br data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Phone:"))}</strong> ${ssrInterpolate((_b = settings.value) == null ? void 0 : _b.phone)}<br data-v-e574eeb2${_scopeId}><strong data-v-e574eeb2${_scopeId}>${ssrInterpolate(trans("Address:"))}</strong> ${ssrInterpolate((_c = settings.value) == null ? void 0 : _c.address)}</p></div></div></div></div></div></section>`);
          } else {
            return [
              createVNode("section", { class: "page-header" }, [
                createVNode("div", {
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h1", null, toDisplayString(trans("Privacy Policy")), 1),
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        createVNode("li", null, [
                          typeof _ctx.route !== "undefined" ? (openBlock(), createBlock(unref(Link), {
...
const PrivacyPolicy = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-e574eeb2"]]);
          ...
          if (_push2) {
            ...
            return [
              createVNode("section", { class: "page-header" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h1", null, toDisplayString(trans("Our Members")), 1),
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        createVNode("li", null, [
                          typeof _ctx.route !== "undefined" ? (openBlock(), createBlock(unref(Link), {
          ...
          if (_push2) {
            ...
            return [
              createVNode("section", { class: "page-header" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h1", null, toDisplayString(trans("Testimonials")), 1),
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        createVNode("li", null, [
                          typeof _ctx.route !== "undefined" ? (openBlock(), createBlock(unref(Link), {
...
const _sfc_main$p = /* @__PURE__ */ Object.assign(__default__$7, {
  ...
  setup(__props) {
    ...
    const featuredCount = computed(() => {
      var _a;
      return ((_a = products.value.data) == null ? void 0 : _a.filter((p) => p.is_featured).length) || 0;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/page-header.css")} data-v-ad6cf210${_scopeId}><title data-v-ad6cf210${_scopeId}>${ssrInterpolate(metaTitle.value)}</title><meta name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-ad6cf210${_scopeId}><meta name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-ad6cf210${_scopeId}><meta name="robots"${ssrRenderAttr("content", metaRobots.value)} data-v-ad6cf210${_scopeId}>`);
            if (metaCanonical.value) {
              _push2(`<link rel="canonical"${ssrRenderAttr("href", metaCanonical.value)} data-v-ad6cf210${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:title"${ssrRenderAttr("content", metaTitle.value)} data-v-ad6cf210${_scopeId}><meta property="og:description"${ssrRenderAttr("content", metaDescription.value)} data-v-ad6cf210${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta property="og:image"${ssrRenderAttr("content", metaImage.value)} data-v-ad6cf210${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (metaCanonical.value) {
              _push2(`<meta property="og:url"${ssrRenderAttr("content", metaCanonical.value)} data-v-ad6cf210${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:type" content="website" data-v-ad6cf210${_scopeId}><meta name="twitter:card" content="summary_large_image" data-v-ad6cf210${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", metaTitle.value)} data-v-ad6cf210${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", metaDescription.value)} data-v-ad6cf210${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta name="twitter:image"${ssrRenderAttr("content", metaImage.value)} data-v-ad6cf210${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="fas fa-home" data-v-ad6cf210${_scopeId2}></i>${ssrInterpolate(trans("Home"))}`);
                } else {
                  return [
                    createVNode("i", { class: "fas fa-home" }),
                    createTextVNode(toDisplayString(trans("Home")), 1)
            ...
            _push2(`</li><li data-v-ad6cf210${_scopeId}><span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-ad6cf210${_scopeId}></span></li><li data-v-ad6cf210${_scopeId}>${ssrInterpolate(trans("Products"))}</li></ul></div></div></div></div><section class="blog-page products-page" data-v-ad6cf210${_scopeId}><div class="products-page__bg" aria-hidden="true" data-v-ad6cf210${_scopeId}><div class="products-page__orb products-page__orb--one" data-v-ad6cf210${_scopeId}></div><div class="products-page__orb products-page__orb--two" data-v-ad6cf210${_scopeId}></div><div class="products-page__orb products-page__orb--three" data-v-ad6cf210${_scopeId}></div></div><div class="container position-relative" data-v-ad6cf210${_scopeId}><div class="section-title text-center sec-title-animation animation-style1 products-page__head" data-v-ad6cf210${_scopeId}><div class="section-title__tagline-box" data-v-ad6cf210${_scopeId}><div class="section-title__tagline-shape-1" data-v-ad6cf210${_scopeId}></div><span class="section-title__tagline" data-v-ad6cf210${_scopeId}>${ssrInterpolate(trans("Our Catalog"))}</span><div class="section-title__tagline-shape-2" data-v-ad6cf210${_scopeId}></div></div><h2 class="section-title__title title-animation" data-v-ad6cf210${_scopeId}>${ssrInterpolate(trans("B2B Solutions Built for Scale"))}</h2><p class="products-page__subtitle" data-v-ad6cf210${_scopeId}>${ssrInterpolate(trans("Discover enterprise-ready platforms and services designed to grow with your business."))}</p></div>`);
            if (products.value.data.length) {
              _push2(`<div class="products-page__stats" data-v-ad6cf210${_scopeId}><div class="products-page__stat" data-v-ad6cf210${_scopeId}><span class="products-page__stat-value" data-v-ad6cf210${_scopeId}>${ssrInterpolate(products.value.total)}</span><span class="products-page__stat-label" data-v-ad6cf210${_scopeId}>${ssrInterpolate(trans("Solutions Available"))}</span></div>`);
              if (featuredCount.value) {
                _push2(`<div class="products-page__stat" data-v-ad6cf210${_scopeId}><span class="products-page__stat-value" data-v-ad6cf210${_scopeId}>${ssrInterpolate(featuredCount.value)}</span><span class="products-page__stat-label" data-v-ad6cf210${_scopeId}>${ssrInterpolate(trans("Featured"))}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            _push2(`<div class="row" data-v-ad6cf210${_scopeId}><!--[-->`);
            ssrRenderList(products.value.data, (product, index) => {
              _push2(`<div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp"${ssrRenderAttr("data-wow-delay", `${(index % 3 + 1) * 100}ms`)} data-v-ad6cf210${_scopeId}>`);
              _push2(ssrRenderComponent(ProductCard, {
                item: product,
                locale: locale.value
              }, null, _parent2, _scopeId));
            ...
            _push2(`<!--]-->`);
            if (!products.value.data.length) {
              _push2(`<div class="col-12" data-v-ad6cf210${_scopeId}><div class="products-page__empty" data-v-ad6cf210${_scopeId}><div class="products-page__empty-icon" aria-hidden="true" data-v-ad6cf210${_scopeId}><i class="fas fa-box-open" data-v-ad6cf210${_scopeId}></i></div><h3 data-v-ad6cf210${_scopeId}>${ssrInterpolate(trans("No records found"))}</h3><p data-v-ad6cf210${_scopeId}>${ssrInterpolate(trans("Check back soon — we are adding new solutions to our catalog."))}</p></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (products.value.last_page > 1) {
              _push2(`<div class="blog-page__pagination products-page__pagination" data-v-ad6cf210${_scopeId}><ul class="pg-pagination list-unstyled" data-v-ad6cf210${_scopeId}>`);
              if (products.value.prev_page_url) {
                _push2(`<li class="prev" data-v-ad6cf210${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span class="icon-left-arrow-1" data-v-ad6cf210${_scopeId2}></span>`);
                    } else {
                      return [
                        createVNode("span", { class: "icon-left-arrow-1" })
                      ];
              ...
              ssrRenderList(products.value.links, (link, linkIndex) => {
                ...
                if (link.url && linkIndex > 0 && linkIndex < products.value.links.length - 1) {
                  _push2(`<li class="${ssrRenderClass(["count", link.active ? "active" : ""])}" data-v-ad6cf210${_scopeId}>`);
                  _push2(ssrRenderComponent(unref(Link), {
                    href: link.url
                  }, {
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              ...
              if (products.value.next_page_url) {
                _push2(`<li class="next" data-v-ad6cf210${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-ad6cf210${_scopeId2}></span>`);
                    } else {
                      return [
                        createVNode("span", {
                          class: `icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`
            ...
            return [
              createVNode("div", { class: "page-header" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h1", null, toDisplayString(trans("Products")), 1),
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        createVNode("li", null, [
                          createVNode(unref(Link), {
                        ...
                        createVNode("li", null, toDisplayString(trans("Products")), 1)
                      ])
                    ])
                  ])
                ])
              ]),
              createVNode("section", { class: "blog-page products-page" }, [
                createVNode("div", {
                  class: "products-page__bg",
                  "aria-hidden": "true"
                }, [
                ...
                createVNode("div", { class: "container position-relative" }, [
                  createVNode("div", { class: "section-title text-center sec-title-animation animation-style1 products-page__head" }, [
                    createVNode("div", { class: "section-title__tagline-box" }, [
                      createVNode("div", { class: "section-title__tagline-shape-1" }),
                      createVNode("span", { class: "section-title__tagline" }, toDisplayString(trans("Our Catalog")), 1),
                      createVNode("div", { class: "section-title__tagline-shape-2" })
                    ]),
                    createVNode("h2", { class: "section-title__title title-animation" }, toDisplayString(trans("B2B Solutions Built for Scale")), 1),
...
const ProductIndex = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-ad6cf210"]]);
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: modalElement
      }, _attrs))} data-v-b7a5a2ac><div class="modal-dialog modal-dialog-centered modal-lg" data-v-b7a5a2ac><div class="modal-content" data-v-b7a5a2ac><div class="modal-header border-0 pb-0" data-v-b7a5a2ac><h5 class="modal-title"${ssrRenderAttr("id", `${__props.modalId}Label`)} data-v-b7a5a2ac>${ssrInterpolate(__props.title)}</h5><button type="button" class="btn-close" data-bs-dismiss="modal"${ssrRenderAttr("aria-label", trans("Close"))} data-v-b7a5a2ac></button></div><div class="modal-body pt-2" data-v-b7a5a2ac>`);
      if (__props.description) {
        _push(`<p class="product-contact-modal__description mb-4" data-v-b7a5a2ac>${ssrInterpolate(__props.description)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<form class="contact-one__form" data-v-b7a5a2ac><div class="row" data-v-b7a5a2ac><div class="col-md-6 mb-3" data-v-b7a5a2ac><h4 class="contact-one__input-title" data-v-b7a5a2ac>${ssrInterpolate(trans("Full Name"))}</h4><div class="contact-one__input-box" data-v-b7a5a2ac><div class="contact-one__input-icon" data-v-b7a5a2ac><span class="icon-user-1" data-v-b7a5a2ac></span></div><input${ssrRenderAttr("value", unref(contactForm).name)} type="text" name="name"${ssrRenderAttr("placeholder", trans("Full Name"))}${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} required data-v-b7a5a2ac></div>`);
      if (unref(contactForm).errors.name) {
        _push(`<div class="text-danger mt-1 small" data-v-b7a5a2ac>${ssrInterpolate(unref(contactForm).errors.name)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="col-md-6 mb-3" data-v-b7a5a2ac><h4 class="contact-one__input-title" data-v-b7a5a2ac>${ssrInterpolate(trans("Email"))}</h4><div class="contact-one__input-box" data-v-b7a5a2ac><div class="contact-one__input-icon" data-v-b7a5a2ac><span class="icon-email" data-v-b7a5a2ac></span></div><input${ssrRenderAttr("value", unref(contactForm).email)} type="email" name="email"${ssrRenderAttr("placeholder", trans("Email"))}${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} required data-v-b7a5a2ac></div>`);
      if (unref(contactForm).errors.email) {
        _push(`<div class="text-danger mt-1 small" data-v-b7a5a2ac>${ssrInterpolate(unref(contactForm).errors.email)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="col-md-6 mb-3" data-v-b7a5a2ac><h4 class="contact-one__input-title" data-v-b7a5a2ac>${ssrInterpolate(trans("Phone Number"))}</h4><div class="contact-one__input-box" data-v-b7a5a2ac><div class="contact-one__input-icon" data-v-b7a5a2ac><span class="icon-phone-call" data-v-b7a5a2ac></span></div><input${ssrRenderAttr("value", unref(contactForm).mobile)} type="text" name="mobile"${ssrRenderAttr("placeholder", trans("Phone Number"))}${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} required data-v-b7a5a2ac></div>`);
      if (unref(contactForm).errors.mobile) {
        _push(`<div class="text-danger mt-1 small" data-v-b7a5a2ac>${ssrInterpolate(unref(contactForm).errors.mobile)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="col-md-6 mb-3" data-v-b7a5a2ac><h4 class="contact-one__input-title" data-v-b7a5a2ac>${ssrInterpolate(trans("Subject"))}</h4><div class="contact-one__input-box" data-v-b7a5a2ac><div class="contact-one__input-icon" data-v-b7a5a2ac><span class="icon-edit" data-v-b7a5a2ac></span></div><input${ssrRenderAttr("value", unref(contactForm).subject)} type="text" name="subject"${ssrRenderAttr("placeholder", trans("Subject"))}${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} required data-v-b7a5a2ac></div>`);
      if (unref(contactForm).errors.subject) {
        _push(`<div class="text-danger mt-1 small" data-v-b7a5a2ac>${ssrInterpolate(unref(contactForm).errors.subject)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="col-12 mb-3" data-v-b7a5a2ac><h4 class="contact-one__input-title" data-v-b7a5a2ac>${ssrInterpolate(trans("Message"))}</h4><div class="contact-one__input-box text-message-box" data-v-b7a5a2ac><div class="contact-one__input-icon" data-v-b7a5a2ac><span class="icon-edit" data-v-b7a5a2ac></span></div><textarea name="message"${ssrRenderAttr("placeholder", trans("Message"))}${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} required data-v-b7a5a2ac>${ssrInterpolate(unref(contactForm).message)}</textarea></div>`);
      if (unref(contactForm).errors.message) {
        _push(`<div class="text-danger mt-1 small" data-v-b7a5a2ac>${ssrInterpolate(unref(contactForm).errors.message)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
      if (submitSuccess.value) {
        _push(`<div class="alert alert-success" data-v-b7a5a2ac>${ssrInterpolate(trans("Thank you for contacting us! We will get back to you soon."))}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="contact-one__btn-box" data-v-b7a5a2ac><button type="submit" class="thm-btn"${ssrIncludeBooleanAttr(unref(contactForm).processing) ? " disabled" : ""} data-v-b7a5a2ac>`);
      if (unref(contactForm).processing) {
        _push(`<span data-v-b7a5a2ac>${ssrInterpolate(trans("Sending..."))}</span>`);
      } else {
        _push(`<span data-v-b7a5a2ac>${ssrInterpolate(__props.submitLabel)}</span>`);
      }
      _push(`<span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow`)}" data-v-b7a5a2ac></span></button></div></form></div></div></div></div>`);
    };
  }
};
...
const ContactRequestModal = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-b7a5a2ac"]]);
const __default__$6 = {
  components: {
    AppLayout: _sfc_main$D,
    CtaTwo: _sfc_main$x,
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/page-header.css")} data-v-85a417ae${_scopeId}><title data-v-85a417ae${_scopeId}>${ssrInterpolate(metaTitle.value)}</title><meta name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-85a417ae${_scopeId}><meta name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-85a417ae${_scopeId}><meta name="robots"${ssrRenderAttr("content", metaRobots.value)} data-v-85a417ae${_scopeId}><meta property="og:title"${ssrRenderAttr("content", metaTitle.value)} data-v-85a417ae${_scopeId}><meta property="og:description"${ssrRenderAttr("content", metaDescription.value)} data-v-85a417ae${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta property="og:image"${ssrRenderAttr("content", metaImage.value)} data-v-85a417ae${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:type" content="product" data-v-85a417ae${_scopeId}><meta name="twitter:card" content="summary_large_image" data-v-85a417ae${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", metaTitle.value)} data-v-85a417ae${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", metaDescription.value)} data-v-85a417ae${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta name="twitter:image"${ssrRenderAttr("content", metaImage.value)} data-v-85a417ae${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_sfc_main$D, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="page-header" data-v-85a417ae${_scopeId}><div class="page-header__bg" style="${ssrRenderStyle({ backgroundImage: `url(${asset_path.value}images/backgrounds/our-team-bg.jpg)` })}" data-v-85a417ae${_scopeId}></div><div class="container" data-v-85a417ae${_scopeId}><div class="page-header__inner" data-v-85a417ae${_scopeId}><h2 data-v-85a417ae${_scopeId}>${ssrInterpolate(product.value.name)}</h2><div class="thm-breadcrumb__box" data-v-85a417ae${_scopeId}><ul class="thm-breadcrumb list-unstyled" data-v-85a417ae${_scopeId}><li data-v-85a417ae${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("home")
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="fas fa-home" data-v-85a417ae${_scopeId2}></i>${ssrInterpolate(trans("Home"))}`);
                } else {
                  return [
                    createVNode("i", { class: "fas fa-home" }),
                    createTextVNode(toDisplayString(trans("Home")), 1)
            ...
            _push2(`</li><li data-v-85a417ae${_scopeId}><span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-85a417ae${_scopeId}></span></li><li data-v-85a417ae${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("product.index")
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(trans("Products"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(trans("Products")), 1)
                  ];
            ...
            _push2(`</li><li data-v-85a417ae${_scopeId}><span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-85a417ae${_scopeId}></span></li><li data-v-85a417ae${_scopeId}>${ssrInterpolate(product.value.name)}</li></ul></div></div></div></section><section class="blog-details products-page" data-v-85a417ae${_scopeId}><div class="products-page__bg" aria-hidden="true" data-v-85a417ae${_scopeId}><div class="products-page__orb products-page__orb--one" data-v-85a417ae${_scopeId}></div><div class="products-page__orb products-page__orb--two" data-v-85a417ae${_scopeId}></div><div class="products-page__orb products-page__orb--three" data-v-85a417ae${_scopeId}></div></div><div class="container position-relative" data-v-85a417ae${_scopeId}><div class="row" data-v-85a417ae${_scopeId}><div class="col-xl-12" data-v-85a417ae${_scopeId}><article class="product-detail" data-v-85a417ae${_scopeId}><div class="product-detail__glow" aria-hidden="true" data-v-85a417ae${_scopeId}></div><header class="product-detail__header" data-v-85a417ae${_scopeId}><div class="product-detail__identity" data-v-85a417ae${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("product.index"),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", product.value.main_image_link)}${ssrRenderAttr("alt", product.value.name)} data-v-85a417ae${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
            ...
            _push2(`<div class="product-detail__intro" data-v-85a417ae${_scopeId}>`);
            if (product.value.category) {
              _push2(`<p class="product-detail__category" data-v-85a417ae${_scopeId}>${ssrInterpolate(product.value.category.name)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<h1 class="product-detail__title" data-v-85a417ae${_scopeId}>${ssrInterpolate(product.value.name)}</h1>`);
            if (product.value.short_description) {
              _push2(`<p class="product-detail__subtitle" data-v-85a417ae${_scopeId}>${ssrInterpolate(product.value.short_description)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="product-detail__actions" data-v-85a417ae${_scopeId}><div class="product-detail__share" data-v-85a417ae${_scopeId}><span class="product-detail__share-label" data-v-85a417ae${_scopeId}>${ssrInterpolate(trans("Share now"))}</span><div class="product-detail__share-links" data-v-85a417ae${_scopeId}><a${ssrRenderAttr("href", getShareUrl("facebook"))} target="_blank" rel="noopener" class="product-detail__share-btn" aria-label="Facebook" data-v-85a417ae${_scopeId}><span class="icon-facebook" data-v-85a417ae${_scopeId}></span></a><a${ssrRenderAttr("href", getShareUrl("twitter"))} target="_blank" rel="noopener" class="product-detail__share-btn" aria-label="Twitter" data-v-85a417ae${_scopeId}><span class="fab fa-twitter" data-v-85a417ae${_scopeId}></span></a><a${ssrRenderAttr("href", getShareUrl("linkedin"))} target="_blank" rel="noopener" class="product-detail__share-btn" aria-label="LinkedIn" data-v-85a417ae${_scopeId}><span class="icon-linkedin" data-v-85a417ae${_scopeId}></span></a></div></div><button type="button" class="product-detail__pill product-detail__pill--cta" data-v-85a417ae${_scopeId}>${ssrInterpolate(trans("Request Live Demo"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow`)}" data-v-85a417ae${_scopeId}></span></button></div></header>`);
            if (product.value.category || product.value.is_featured) {
              _push2(`<div class="product-detail__meta" data-v-85a417ae${_scopeId}>`);
              if (product.value.category) {
                _push2(`<div class="product-detail__pill" data-v-85a417ae${_scopeId}><i class="fas fa-tag" data-v-85a417ae${_scopeId}></i><span data-v-85a417ae${_scopeId}>${ssrInterpolate(product.value.category.name)}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (product.value.is_featured) {
                _push2(`<div class="product-detail__pill product-detail__pill--featured" data-v-85a417ae${_scopeId}><i class="fas fa-star" data-v-85a417ae${_scopeId}></i><span data-v-85a417ae${_scopeId}>${ssrInterpolate(trans("Featured"))}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            _push2(`<div class="product-detail__hero" data-v-85a417ae${_scopeId}><img${ssrRenderAttr("src", product.value.main_image_link)}${ssrRenderAttr("alt", product.value.name)} data-v-85a417ae${_scopeId}></div>`);
            if (product.value.short_description) {
              _push2(`<div class="product-detail__section" data-v-85a417ae${_scopeId}><div class="product-detail__section-head" data-v-85a417ae${_scopeId}><span class="product-detail__section-icon" data-v-85a417ae${_scopeId}><i class="fas fa-lightbulb" data-v-85a417ae${_scopeId}></i></span><span class="product-detail__section-label" data-v-85a417ae${_scopeId}>${ssrInterpolate(trans("Overview"))}</span></div><p class="product-detail__text" data-v-85a417ae${_scopeId}>${ssrInterpolate(product.value.short_description)}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (product.value.description) {
              _push2(`<div class="product-detail__section" data-v-85a417ae${_scopeId}><div class="product-detail__section-head" data-v-85a417ae${_scopeId}><span class="product-detail__section-icon" data-v-85a417ae${_scopeId}><i class="fas fa-align-left" data-v-85a417ae${_scopeId}></i></span><span class="product-detail__section-label" data-v-85a417ae${_scopeId}>${ssrInterpolate(trans("Product Details"))}</span></div><div class="product-detail__content" data-v-85a417ae${_scopeId}>${product.value.description ?? ""}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<footer class="product-detail__footer" data-v-85a417ae${_scopeId}><button type="button" class="product-detail__pill product-detail__pill--cta" data-v-85a417ae${_scopeId}>${ssrInterpolate(trans("Request Live Demo"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow`)}" data-v-85a417ae${_scopeId}></span></button>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("contact-us"),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(trans("Get in Touch"))} <span class="icon-right-up" data-v-85a417ae${_scopeId2}></span>`);
                } else {
                  return [
                    createTextVNode(toDisplayString(trans("Get in Touch")) + " ", 1),
            ...
            if (relatedProducts.value.length) {
              _push2(`<div class="products-related" data-v-85a417ae${_scopeId}><div class="products-related__head" data-v-85a417ae${_scopeId}><div class="section-title__tagline-box justify-content-center" data-v-85a417ae${_scopeId}><div class="section-title__tagline-shape-1" data-v-85a417ae${_scopeId}></div><span class="section-title__tagline" data-v-85a417ae${_scopeId}>${ssrInterpolate(trans("More Products"))}</span><div class="section-title__tagline-shape-2" data-v-85a417ae${_scopeId}></div></div><h3 class="products-related__title" data-v-85a417ae${_scopeId}>${ssrInterpolate(trans("Explore More Solutions"))}</h3></div><div class="row" data-v-85a417ae${_scopeId}><!--[-->`);
              ssrRenderList(relatedProducts.value, (item) => {
                _push2(`<div class="col-xl-4 col-lg-6 col-md-6" data-v-85a417ae${_scopeId}>`);
                _push2(ssrRenderComponent(ProductCard, {
                  item,
                  locale: locale.value,
                  variant: "compact"
                  ...
                  createVNode("div", { class: "page-header__inner" }, [
                    ...
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        ...
                        createVNode("li", null, toDisplayString(product.value.name), 1)
                      ])
                    ])
                  ])
                ])
...
const ProductShow = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-85a417ae"]]);
...
const _sfc_main$m = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("portal.dashboard"),
        class: ["portal-tabs__link", { "portal-tabs__link--active": __props.active === "dashboard" }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="fas fa-th-large"${_scopeId}></i> ${ssrInterpolate(unref(t)("menu.my_dashboard"))}`);
          } else {
            return [
              createVNode("i", { class: "fas fa-th-large" }),
              createTextVNode(" " + toDisplayString(unref(t)("menu.my_dashboard")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("portal.projects.index"),
        class: ["portal-tabs__link", { "portal-tabs__link--active": __props.active === "projects" }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="fas fa-folder-open"${_scopeId}></i> ${ssrInterpolate(unref(t)("menu.projects"))}`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("portal.subscriptions.index"),
        class: ["portal-tabs__link", { "portal-tabs__link--active": __props.active === "subscriptions" }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="fas fa-sync-alt"${_scopeId}></i> ${ssrInterpolate(unref(t)("menu.subscriptions"))}`);
          } else {
            return [
              createVNode("i", { class: "fas fa-sync-alt" }),
              createTextVNode(" " + toDisplayString(unref(t)("menu.subscriptions")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("portal.tickets.index"),
        class: ["portal-tabs__link", { "portal-tabs__link--active": __props.active === "tickets" }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="fas fa-life-ring"${_scopeId}></i> ${ssrInterpolate(unref(t)("menu.tickets"))} `);
            if (openTicketsCount.value) {
              _push2(`<span class="portal-tabs__badge"${_scopeId}>${ssrInterpolate(openTicketsCount.value)}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              createVNode("i", { class: "fas fa-life-ring" }),
              createTextVNode(" " + toDisplayString(unref(t)("menu.tickets")) + " ", 1),
              openTicketsCount.value ? (openBlock(), createBlock("span", {
                key: 0,
                class: "portal-tabs__badge"
              }, toDisplayString(openTicketsCount.value), 1)) : createCommentVNode("", true)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("portal.profile.index"),
        class: ["portal-tabs__link", { "portal-tabs__link--active": __props.active === "profile" }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="fas fa-user-cog"${_scopeId}></i> ${ssrInterpolate(unref(t)("menu.profile"))}`);
          } else {
            return [
              createVNode("i", { class: "fas fa-user-cog" }),
              createTextVNode(" " + toDisplayString(unref(t)("menu.profile")), 1)
            ];
          }
        }),
        _: 1
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/page-header.css")}${_scopeId}><link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/portal.css")}${_scopeId}><title${_scopeId}>${ssrInterpolate(pageTitle.value)}</title><meta name="description"${ssrRenderAttr("content", pageDescription.value)}${_scopeId}><meta name="robots" content="noindex, nofollow"${_scopeId}>`);
          } else {
            return [
              createVNode("link", {
                rel: "stylesheet",
      ...
      _push(ssrRenderComponent(_sfc_main$D, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="page-header portal-page-header"${_scopeId}><div class="page-header__bg" style="${ssrRenderStyle({ backgroundImage: `url(${asset_path.value}images/backgrounds/login-bg.jpg)` })}"${_scopeId}></div><div class="container"${_scopeId}><div class="page-header__inner"${_scopeId}><h2${_scopeId}>${ssrInterpolate(__props.title)}</h2><div class="thm-breadcrumb__box"${_scopeId}><ul class="thm-breadcrumb list-unstyled"${_scopeId}><!--[-->`);
            ssrRenderList(flatBreadcrumbs.value, (item) => {
              _push2(`<li${_scopeId}>`);
              if (item.type === "separator") {
                _push2(`<span class="${ssrRenderClass(arrowClass.value)}"${_scopeId}></span>`);
                ...
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      if (item.home) {
                        _push3(`<i class="fas fa-home"${_scopeId2}></i>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      ...
                      return [
                        item.home ? (openBlock(), createBlock("i", {
                          key: 0,
                          class: "fas fa-home"
                        })) : createCommentVNode("", true),
            ...
            _push2(`<!--]--></ul></div>`);
            if (__props.subtitle) {
              _push2(`<p class="portal-page-header__subtitle"${_scopeId}>${ssrInterpolate(__props.subtitle)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></section><section class="portal-one"${_scopeId}><div class="container"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$m, { active: __props.active }, null, _parent2, _scopeId));
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
            _push2(`</div></section>`);
          } else {
            return [
              createVNode("section", { class: "page-header portal-page-header" }, [
                createVNode("div", {
                  class: "page-header__bg",
                  style: { backgroundImage: `url(${asset_path.value}images/backgrounds/login-bg.jpg)` }
                }, null, 4),
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    ...
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(flatBreadcrumbs.value, (item) => {
                          return openBlock(), createBlock("li", {
                            key: item.key
                          }, [
                            item.type === "separator" ? (openBlock(), createBlock("span", {
                              key: 0,
                              class: arrowClass.value
                            }, null, 2)) : item.type === "link" ? (openBlock(), createBlock(unref(Link), {
                              key: 1,
                              href: item.href
                            }, {
                              default: withCtx(() => [
                              ...
                              _: 2
                            }, 1032, ["href"])) : (openBlock(), createBlock(Fragment, { key: 2 }, [
                              createTextVNode(toDisplayString(item.label), 1)
                            ], 64))
                          ]);
                        }), 128))
                    ...
                    __props.subtitle ? (openBlock(), createBlock("p", {
                      key: 0,
                      class: "portal-page-header__subtitle"
                    }, toDisplayString(__props.subtitle), 1)) : createCommentVNode("", true)
                  ])
                ])
              ]),
              createVNode("section", { class: "portal-one" }, [
                createVNode("div", { class: "container" }, [
                  createVNode(_sfc_main$m, { active: __props.active }, null, 8, ["active"]),
...
const _sfc_main$k = {
  ...
  setup(__props) {
    ...
    const metaTitle = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.title) || t("pages.projects_title");
    });
    const metaDescription = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.description) || t("pages.projects_description");
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$l, mergeProps({
        ...
        subtitle: unref(t)("projects.subtitle"),
        active: "projects",
        breadcrumbs: [
          { label: unref(t)("menu.my_dashboard"), href: _ctx.route("portal.dashboard") },
          { label: unref(t)("projects.title") }
        ],
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (__props.projects.data.length === 0) {
              _push2(`<div class="portal-panel"${_scopeId}><div class="portal-empty"${_scopeId}><i class="fas fa-folder-open"${_scopeId}></i> ${ssrInterpolate(unref(t)("projects.no_projects"))}</div></div>`);
            } else {
              ...
              ssrRenderList(__props.projects.data, (project) => {
                ...
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${ssrInterpolate(unref(t)("projects.view_details"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow`)}"${_scopeId2}></span>`);
                    } else {
                      return [
                        createTextVNode(toDisplayString(unref(t)("projects.view_details")) + " ", 1),
                        createVNode("span", {
                          class: `icon-${locale.value === "ar" ? "left" : "right"}-arrow`
                        }, null, 2)
                      ];
            ...
            return [
              __props.projects.data.length === 0 ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "portal-empty" }, [
                  createVNode("i", { class: "fas fa-folder-open" }),
                  createTextVNode(" " + toDisplayString(unref(t)("projects.no_projects")), 1)
                ])
              ])) : (openBlock(), createBlock("div", {
                key: 1,
                class: "row g-4"
                  ...
                  return openBlock(), createBlock("div", {
                    ...
                    createVNode("article", { class: "portal-project-card" }, [
                      ...
                      createVNode("div", { class: "portal-project-card__meta" }, [
                        createVNode("span", null, toDisplayString(unref(t)("fields.payment_status")), 1),
                        createVNode("strong", null, toDisplayString(unref(paymentStatusLabel)(project.payment_status)), 1)
                      ]),
                      createVNode("div", { class: "portal-project-card__meta" }, [
                        createVNode("span", null, toDisplayString(unref(t)("fields.remaining")), 1),
...
const _sfc_main$j = {
  ...
  setup(__props) {
    ...
    const metaDescription = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.description) || t("pages.project_show_description");
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$l, mergeProps({
        ...
        breadcrumbs: [
          { label: unref(t)("menu.my_dashboard"), href: _ctx.route("portal.dashboard") },
          { label: unref(t)("projects.title"), href: _ctx.route("portal.projects.index") },
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a2, _b, _c, _d;
          if (_push2) {
            _push2(`<div class="portal-grid portal-grid--show"${_scopeId}><div${_scopeId}><div class="portal-panel"${_scopeId}><div class="portal-panel__header"${_scopeId}><h2 class="portal-panel__title"${_scopeId}>${ssrInterpolate(unref(t)("projects.details"))}</h2></div><div class="portal-panel__body"${_scopeId}><div class="portal-details"${_scopeId}><div class="portal-details__row"${_scopeId}><div class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.status"))}</div><div class="portal-details__value"${_scopeId}><span class="portal-badge" style="${ssrRenderStyle(statusBadgeStyle.value)}"${_scopeId}>${ssrInterpolate(((_a2 = __props.project.status) == null ? void 0 : _a2.name) || "—")}</span></div></div><div class="portal-details__row"${_scopeId}><div class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.payment_status"))}</div><div class="portal-details__value"${_scopeId}>${ssrInterpolate(unref(paymentStatusLabel)(__props.project.payment_status))}</div></div>`);
            if ((_b = __props.project.company) == null ? void 0 : _b.name) {
              _push2(`<div class="portal-details__row"${_scopeId}><div class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.company"))}</div><div class="portal-details__value"${_scopeId}>${ssrInterpolate(__props.project.company.name)}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.project.start_date) {
              _push2(`<div class="portal-details__row"${_scopeId}><div class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.start_date"))}</div><div class="portal-details__value"${_scopeId}>${ssrInterpolate(__props.project.start_date)}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.project.due_date) {
              _push2(`<div class="portal-details__row"${_scopeId}><div class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.due_date"))}</div><div class="portal-details__value"${_scopeId}>${ssrInterpolate(__props.project.due_date)}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.project.description) {
              _push2(`<div class="portal-details__row"${_scopeId}><div class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.description"))}</div><div class="portal-details__value"${_scopeId}>${ssrInterpolate(__props.project.description)}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div>`);
            if (attachments.value.length) {
              _push2(`<div class="portal-panel" style="${ssrRenderStyle({ "margin-top": "24px" })}"${_scopeId}><div class="portal-panel__header"${_scopeId}><h2 class="portal-panel__title"${_scopeId}>${ssrInterpolate(unref(t)("projects.attachments"))}</h2></div><div class="portal-panel__body"${_scopeId}><ul class="list-unstyled mb-0"${_scopeId}><!--[-->`);
            ...
            if (__props.project.is_completed) {
              _push2(`<div class="portal-panel" style="${ssrRenderStyle({ "margin-top": "24px" })}"${_scopeId}><div class="portal-panel__header"${_scopeId}><h2 class="portal-panel__title"${_scopeId}>${ssrInterpolate(unref(t)("projects.review_title"))}</h2></div><div class="portal-panel__body"${_scopeId}>`);
              if (__props.project.review) {
                _push2(`<div class="portal-details"${_scopeId}><p class="mb-2"${_scopeId}>${ssrInterpolate(unref(t)("projects.review_submitted_hint"))}</p><div class="bg-light p-3 rounded"${_scopeId}>“${ssrInterpolate(reviewQuote.value)}”</div>`);
                if (__props.project.review.status) {
                  _push2(`<span class="${ssrRenderClass([__props.project.review.status === "Published" ? "portal-badge--paid" : "portal-badge--invoice", "portal-badge mt-3"])}"${_scopeId}>${ssrInterpolate(__props.project.review.status === "Published" ? unref(t)("projects.review_status_published") : unref(t)("projects.review_status_pending"))}</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
              } else if (__props.project.can_review) {
                _push2(`<form${_scopeId}><p class="mb-3"${_scopeId}>${ssrInterpolate(unref(t)("projects.review_prompt"))}</p><textarea class="form-control" rows="4"${ssrRenderAttr("placeholder", unref(t)("projects.review_placeholder"))} required minlength="10" maxlength="2000"${_scopeId}>${ssrInterpolate(unref(reviewForm).quote)}</textarea>`);
                if (unref(reviewForm).errors.quote) {
                  _push2(`<p class="text-danger mt-2 mb-0"${_scopeId}>${ssrInterpolate(unref(reviewForm).errors.quote)}</p>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<button type="submit" class="thm-btn mt-3"${ssrIncludeBooleanAttr(unref(reviewForm).processing) ? " disabled" : ""} style="${ssrRenderStyle({ "padding": "10px 20px", "font-size": "14px" })}"${_scopeId}>${ssrInterpolate(unref(t)("projects.submit_review"))}</button></form>`);
              } else {
                _push2(`<div class="portal-empty"${_scopeId}>${ssrInterpolate(unref(t)("projects.review_unavailable"))}</div>`);
              }
              _push2(`</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="portal-grid__stack"${_scopeId}><div class="portal-panel"${_scopeId}><div class="portal-panel__header"${_scopeId}><h2 class="portal-panel__title"${_scopeId}>${ssrInterpolate(unref(t)("projects.billing"))}</h2></div><div class="portal-panel__body"${_scopeId}><div class="portal-billing-grid"${_scopeId}><div class="portal-billing-item"${_scopeId}><div class="portal-billing-item__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.budget"))}</div><div class="portal-billing-item__value"${_scopeId}>${ssrInterpolate(formatMoney(collection.value.budget, collection.value.currency))}</div></div><div class="portal-billing-item"${_scopeId}><div class="portal-billing-item__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.invoiced"))}</div><div class="portal-billing-item__value"${_scopeId}>${ssrInterpolate(formatMoney(collection.value.invoiced, collection.value.currency))}</div></div><div class="portal-billing-item"${_scopeId}><div class="portal-billing-item__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.remaining"))}</div><div class="portal-billing-item__value portal-billing-item__value--accent"${_scopeId}>${ssrInterpolate(formatMoney(collection.value.remaining, collection.value.currency))}</div></div></div><div${_scopeId}><div class="d-flex justify-content-between mb-2"${_scopeId}><span class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.collection_rate"))}</span><span class="portal-details__value"${_scopeId}>${ssrInterpolate(collection.value.collection_rate)}%</span></div><div class="portal-progress" style="${ssrRenderStyle({ "height": "10px" })}"${_scopeId}><div class="portal-progress__bar" style="${ssrRenderStyle({ width: `${collection.value.collection_rate}%` })}"${_scopeId}></div></div></div></div></div><div class="portal-panel"${_scopeId}><div class="portal-panel__header"${_scopeId}><h2 class="portal-panel__title"${_scopeId}>${ssrInterpolate(unref(t)("projects.invoices"))}</h2></div><div class="portal-panel__body"${_scopeId}>`);
            if (invoiceList.value.length === 0) {
              _push2(`<div class="portal-empty"${_scopeId}><span class="portal-empty__icon"${_scopeId}><i class="fas fa-file-alt"${_scopeId}></i></span> ${ssrInterpolate(unref(t)("projects.no_invoices"))}</div>`);
            } else {
              _push2(`<div class="portal-invoice-list"${_scopeId}><!--[-->`);
              ssrRenderList(invoiceList.value, (invoice) => {
                _push2(`<article class="portal-invoice-card"${_scopeId}><div class="portal-invoice-card__top"${_scopeId}><div${_scopeId}><div class="portal-invoice-card__number"${_scopeId}>${ssrInterpolate(invoice.invoice_number)}</div><span class="${ssrRenderClass([invoiceBadgeClass(invoice.status), "portal-badge mt-2"])}"${_scopeId}>${ssrInterpolate(unref(invoiceStatusLabel)(invoice.status))}</span></div><div class="portal-invoice-card__total"${_scopeId}>${ssrInterpolate(formatMoney(invoice.total, invoice.currency))}</div></div><div class="portal-invoice-card__meta"${_scopeId}><div class="portal-invoice-card__meta-item"${_scopeId}><span${_scopeId}>${ssrInterpolate(unref(t)("fields.issued_at"))}</span><strong${_scopeId}>${ssrInterpolate(invoice.issued_at || "—")}</strong></div><div class="portal-invoice-card__meta-item"${_scopeId}><span${_scopeId}>${ssrInterpolate(unref(t)("fields.due_at"))}</span><strong${_scopeId}>${ssrInterpolate(invoice.due_at || "—")}</strong></div><div class="portal-invoice-card__meta-item"${_scopeId}><span${_scopeId}>${ssrInterpolate(unref(t)("fields.paid_at"))}</span><strong${_scopeId}>${ssrInterpolate(invoice.paid_at || "—")}</strong></div></div><a${ssrRenderAttr("href", invoice.pdf_url)} class="portal-panel__action" target="_blank" rel="noopener"${_scopeId}><i class="fas fa-download"${_scopeId}></i> ${ssrInterpolate(unref(t)("projects.download_pdf"))}</a></article>`);
              });
              _push2(`<!--]--></div>`);
            }
            ...
            return [
              createVNode("div", { class: "portal-grid portal-grid--show" }, [
                createVNode("div", null, [
                  createVNode("div", { class: "portal-panel" }, [
                    createVNode("div", { class: "portal-panel__header" }, [
                      createVNode("h2", { class: "portal-panel__title" }, toDisplayString(unref(t)("projects.details")), 1)
                    ]),
                    createVNode("div", { class: "portal-panel__body" }, [
                      createVNode("div", { class: "portal-details" }, [
                        createVNode("div", { class: "portal-details__row" }, [
                          createVNode("div", { class: "portal-details__label" }, toDisplayString(unref(t)("fields.status")), 1),
                        ...
                        createVNode("div", { class: "portal-details__row" }, [
                          createVNode("div", { class: "portal-details__label" }, toDisplayString(unref(t)("fields.payment_status")), 1),
                        ...
                        ((_d = __props.project.company) == null ? void 0 : _d.name) ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "portal-details__label" }, toDisplayString(unref(t)("fields.company")), 1),
                        ...
                        __props.project.start_date ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "portal-details__label" }, toDisplayString(unref(t)("fields.start_date")), 1),
                        ...
                        __props.project.due_date ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "portal-details__label" }, toDisplayString(unref(t)("fields.due_date")), 1),
                        ...
                        __props.project.description ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "portal-details__label" }, toDisplayString(unref(t)("fields.description")), 1),
                  ...
                  attachments.value.length ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "portal-panel__header" }, [
                      createVNode("h2", { class: "portal-panel__title" }, toDisplayString(unref(t)("projects.attachments")), 1)
                    ]),
                    createVNode("div", { class: "portal-panel__body" }, [
                  ...
                  __props.project.is_completed ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "portal-panel__header" }, [
                      createVNode("h2", { class: "portal-panel__title" }, toDisplayString(unref(t)("projects.review_title")), 1)
                    ]),
                    createVNode("div", { class: "portal-panel__body" }, [
                      __props.project.review ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("p", { class: "mb-2" }, toDisplayString(unref(t)("projects.review_submitted_hint")), 1),
                        createVNode("div", { class: "bg-light p-3 rounded" }, "“" + toDisplayString(reviewQuote.value) + "”", 1),
                        ...
                        }, toDisplayString(__props.project.review.status === "Published" ? unref(t)("projects.review_status_published") : unref(t)("projects.review_status_pending")), 3)) : createCommentVNode("", true)
                      ])) : __props.project.can_review ? (openBlock(), createBlock("form", {
                        key: 1,
                        onSubmit: withModifiers(submitReview, ["prevent"])
                      }, [
                        createVNode("p", { class: "mb-3" }, toDisplayString(unref(t)("projects.review_prompt")), 1),
                        withDirectives(createVNode("textarea", {
                          "onUpdate:modelValue": ($event) => unref(reviewForm).quote = $event,
                          class: "form-control",
                          rows: "4",
                          placeholder: unref(t)("projects.review_placeholder"),
                          required: "",
                          minlength: "10",
                          maxlength: "2000"
                        }, null, 8, ["onUpdate:modelValue", "placeholder"]), [
                        ...
                        }, toDisplayString(unref(t)("projects.submit_review")), 9, ["disabled"])
                      ], 32)) : (openBlock(), createBlock("div", {
                        key: 2,
                        class: "portal-empty"
                      }, toDisplayString(unref(t)("projects.review_unavailable")), 1))
                    ])
                  ])) : createCommentVNode("", true)
                ]),
                createVNode("div", { class: "portal-grid__stack" }, [
                  createVNode("div", { class: "portal-panel" }, [
                    createVNode("div", { class: "portal-panel__header" }, [
                      createVNode("h2", { class: "portal-panel__title" }, toDisplayString(unref(t)("projects.billing")), 1)
                    ]),
                    createVNode("div", { class: "portal-panel__body" }, [
                      createVNode("div", { class: "portal-billing-grid" }, [
                        createVNode("div", { class: "portal-billing-item" }, [
                          createVNode("div", { class: "portal-billing-item__label" }, toDisplayString(unref(t)("fields.budget")), 1),
                        ...
                        createVNode("div", { class: "portal-billing-item" }, [
                          createVNode("div", { class: "portal-billing-item__label" }, toDisplayString(unref(t)("fields.invoiced")), 1),
                        ...
                        createVNode("div", { class: "portal-billing-item" }, [
                          createVNode("div", { class: "portal-billing-item__label" }, toDisplayString(unref(t)("fields.remaining")), 1),
                      ...
                      createVNode("div", null, [
                        createVNode("div", { class: "d-flex justify-content-between mb-2" }, [
                          createVNode("span", { class: "portal-details__label" }, toDisplayString(unref(t)("fields.collection_rate")), 1),
                  ...
                  createVNode("div", { class: "portal-panel" }, [
                    createVNode("div", { class: "portal-panel__header" }, [
                      createVNode("h2", { class: "portal-panel__title" }, toDisplayString(unref(t)("projects.invoices")), 1)
                    ]),
                    createVNode("div", { class: "portal-panel__body" }, [
                      invoiceList.value.length === 0 ? (openBlock(), createBlock("div", {
                        ...
                        createTextVNode(" " + toDisplayString(unref(t)("projects.no_invoices")), 1)
                      ])) : (openBlock(), createBlock("div", {
                        key: 1,
                          ...
                          return openBlock(), createBlock("article", {
                            ...
                            createVNode("div", { class: "portal-invoice-card__meta" }, [
                              createVNode("div", { class: "portal-invoice-card__meta-item" }, [
                                createVNode("span", null, toDisplayString(unref(t)("fields.issued_at")), 1),
                                createVNode("strong", null, toDisplayString(invoice.issued_at || "—"), 1)
                              ]),
                              createVNode("div", { class: "portal-invoice-card__meta-item" }, [
                                createVNode("span", null, toDisplayString(unref(t)("fields.due_at")), 1),
                                createVNode("strong", null, toDisplayString(invoice.due_at || "—"), 1)
                              ]),
                              createVNode("div", { class: "portal-invoice-card__meta-item" }, [
                                createVNode("span", null, toDisplayString(unref(t)("fields.paid_at")), 1),
                            ...
                            createVNode("a", {
                              ...
                              createTextVNode(" " + toDisplayString(unref(t)("projects.download_pdf")), 1)
                            ], 8, ["href"])
                          ]);
                        }), 128))
                      ]))
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/page-header.css")} data-v-0fe03073${_scopeId}><title data-v-0fe03073${_scopeId}>${ssrInterpolate(metaTitle.value)}</title><meta name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-0fe03073${_scopeId}><meta name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-0fe03073${_scopeId}><meta name="robots"${ssrRenderAttr("content", metaRobots.value)} data-v-0fe03073${_scopeId}>`);
            if (metaCanonical.value) {
              _push2(`<link rel="canonical"${ssrRenderAttr("href", metaCanonical.value)} data-v-0fe03073${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:title"${ssrRenderAttr("content", metaTitle.value)} data-v-0fe03073${_scopeId}><meta property="og:description"${ssrRenderAttr("content", metaDescription.value)} data-v-0fe03073${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta property="og:image"${ssrRenderAttr("content", metaImage.value)} data-v-0fe03073${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (metaCanonical.value) {
              _push2(`<meta property="og:url"${ssrRenderAttr("content", metaCanonical.value)} data-v-0fe03073${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:type" content="website" data-v-0fe03073${_scopeId}><meta name="twitter:card" content="summary_large_image" data-v-0fe03073${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", metaTitle.value)} data-v-0fe03073${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", metaDescription.value)} data-v-0fe03073${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta name="twitter:image"${ssrRenderAttr("content", metaImage.value)} data-v-0fe03073${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="fas fa-home" data-v-0fe03073${_scopeId2}></i>${ssrInterpolate(trans("Home"))}`);
                } else {
                  return [
                    createVNode("i", { class: "fas fa-home" }),
                    createTextVNode(toDisplayString(trans("Home")), 1)
            ...
            _push2(`</li><li data-v-0fe03073${_scopeId}><span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-0fe03073${_scopeId}></span></li><li data-v-0fe03073${_scopeId}>${ssrInterpolate(trans("Case Studies"))}</li></ul></div></div></div></div><section class="blog-page use-cases-page" data-v-0fe03073${_scopeId}><div class="use-cases-page__bg" aria-hidden="true" data-v-0fe03073${_scopeId}><div class="use-cases-page__orb use-cases-page__orb--one" data-v-0fe03073${_scopeId}></div><div class="use-cases-page__orb use-cases-page__orb--two" data-v-0fe03073${_scopeId}></div><div class="use-cases-page__orb use-cases-page__orb--three" data-v-0fe03073${_scopeId}></div></div><div class="container position-relative" data-v-0fe03073${_scopeId}><div class="section-title text-center sec-title-animation animation-style1" data-v-0fe03073${_scopeId}><div class="section-title__tagline-box" data-v-0fe03073${_scopeId}><div class="section-title__tagline-shape-1" data-v-0fe03073${_scopeId}></div><span class="section-title__tagline" data-v-0fe03073${_scopeId}>${ssrInterpolate(trans("Case Studies"))}</span><div class="section-title__tagline-shape-2" data-v-0fe03073${_scopeId}></div></div><h2 class="section-title__title title-animation" data-v-0fe03073${_scopeId}>${ssrInterpolate(trans("How We've Empowered Businesses with Innovative Tech Solutions"))}</h2></div><div class="row" data-v-0fe03073${_scopeId}><!--[-->`);
            ssrRenderList(useCases.value.data, (item, index) => {
              _push2(`<div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp"${ssrRenderAttr("data-wow-delay", `${(index % 3 + 1) * 100}ms`)} data-v-0fe03073${_scopeId}>`);
              _push2(ssrRenderComponent(UseCaseCard, {
                item,
                locale: locale.value
              }, null, _parent2, _scopeId));
            ...
            if (!useCases.value.data.length) {
              _push2(`<div class="col-12" data-v-0fe03073${_scopeId}><div class="text-center py-5" data-v-0fe03073${_scopeId}><h3 class="use-cases-page__empty" data-v-0fe03073${_scopeId}>${ssrInterpolate(trans("No records found"))}</h3></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (useCases.value.last_page > 1) {
              _push2(`<div class="blog-page__pagination" data-v-0fe03073${_scopeId}><ul class="pg-pagination list-unstyled" data-v-0fe03073${_scopeId}>`);
              if (useCases.value.prev_page_url) {
                _push2(`<li class="prev" data-v-0fe03073${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span class="icon-left-arrow-1" data-v-0fe03073${_scopeId2}></span>`);
                    } else {
                      return [
                        createVNode("span", { class: "icon-left-arrow-1" })
                      ];
              ...
              ssrRenderList(useCases.value.links, (link, index) => {
                ...
                if (link.url && index > 0 && index < useCases.value.links.length - 1) {
                  _push2(`<li class="${ssrRenderClass(["count", link.active ? "active" : ""])}" data-v-0fe03073${_scopeId}>`);
                  _push2(ssrRenderComponent(unref(Link), {
                    href: link.url
                  }, {
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              ...
              if (useCases.value.next_page_url) {
                _push2(`<li class="next" data-v-0fe03073${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-0fe03073${_scopeId2}></span>`);
                    } else {
                      return [
                        createVNode("span", {
                          class: `icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`
            ...
            return [
              createVNode("div", { class: "page-header" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h1", null, toDisplayString(trans("Case Studies")), 1),
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        createVNode("li", null, [
                          createVNode(unref(Link), {
                        ...
                        createVNode("li", null, toDisplayString(trans("Case Studies")), 1)
                      ])
                    ])
                  ])
                ])
              ]),
              createVNode("section", { class: "blog-page use-cases-page" }, [
                createVNode("div", {
                  class: "use-cases-page__bg",
                  "aria-hidden": "true"
                }, [
...
const UseCaseIndex = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-0fe03073"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/page-header.css")} data-v-95493371${_scopeId}><title data-v-95493371${_scopeId}>${ssrInterpolate(metaTitle.value)}</title><meta name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-95493371${_scopeId}><meta name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-95493371${_scopeId}><meta name="robots"${ssrRenderAttr("content", metaRobots.value)} data-v-95493371${_scopeId}>`);
            if (metaCanonical.value) {
              _push2(`<link rel="canonical"${ssrRenderAttr("href", metaCanonical.value)} data-v-95493371${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:title"${ssrRenderAttr("content", metaTitle.value)} data-v-95493371${_scopeId}><meta property="og:description"${ssrRenderAttr("content", metaDescription.value)} data-v-95493371${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta property="og:image"${ssrRenderAttr("content", metaImage.value)} data-v-95493371${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (metaCanonical.value) {
              _push2(`<meta property="og:url"${ssrRenderAttr("content", metaCanonical.value)} data-v-95493371${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:type" content="article" data-v-95493371${_scopeId}><meta name="twitter:card" content="summary_large_image" data-v-95493371${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", metaTitle.value)} data-v-95493371${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", metaDescription.value)} data-v-95493371${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta name="twitter:image"${ssrRenderAttr("content", metaImage.value)} data-v-95493371${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_sfc_main$D, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="page-header" data-v-95493371${_scopeId}><div class="page-header__bg" style="${ssrRenderStyle({ backgroundImage: `url(${asset_path.value}images/backgrounds/our-team-bg.jpg)` })}" data-v-95493371${_scopeId}></div><div class="container" data-v-95493371${_scopeId}><div class="page-header__inner" data-v-95493371${_scopeId}><h2 data-v-95493371${_scopeId}>${ssrInterpolate(useCase.value.title)}</h2><div class="thm-breadcrumb__box" data-v-95493371${_scopeId}><ul class="thm-breadcrumb list-unstyled" data-v-95493371${_scopeId}><li data-v-95493371${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("home")
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="fas fa-home" data-v-95493371${_scopeId2}></i>${ssrInterpolate(trans("Home"))}`);
                } else {
                  return [
                    createVNode("i", { class: "fas fa-home" }),
                    createTextVNode(toDisplayString(trans("Home")), 1)
            ...
            _push2(`</li><li data-v-95493371${_scopeId}><span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-95493371${_scopeId}></span></li><li data-v-95493371${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("use-cases.index")
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            ...
            _push2(`</li><li data-v-95493371${_scopeId}><span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-95493371${_scopeId}></span></li><li data-v-95493371${_scopeId}>${ssrInterpolate(useCase.value.title)}</li></ul></div></div></div></section><section class="blog-details use-cases-page" data-v-95493371${_scopeId}><div class="use-cases-page__bg" aria-hidden="true" data-v-95493371${_scopeId}><div class="use-cases-page__orb use-cases-page__orb--one" data-v-95493371${_scopeId}></div><div class="use-cases-page__orb use-cases-page__orb--two" data-v-95493371${_scopeId}></div><div class="use-cases-page__orb use-cases-page__orb--three" data-v-95493371${_scopeId}></div></div><div class="container position-relative" data-v-95493371${_scopeId}><div class="row" data-v-95493371${_scopeId}><div class="col-xl-12" data-v-95493371${_scopeId}><article class="use-case-detail" data-v-95493371${_scopeId}><div class="use-case-detail__glow" aria-hidden="true" data-v-95493371${_scopeId}></div><header class="use-case-detail__header" data-v-95493371${_scopeId}><div class="use-case-detail__identity" data-v-95493371${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("use-cases.index"),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", useCase.value.image_link)}${ssrRenderAttr("alt", useCase.value.title)} data-v-95493371${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
            ...
            _push2(`<div class="use-case-detail__intro" data-v-95493371${_scopeId}><h1 class="use-case-detail__title" data-v-95493371${_scopeId}>${ssrInterpolate(useCase.value.title)}</h1>`);
            if (useCase.value.client_name) {
              _push2(`<p class="use-case-detail__subtitle" data-v-95493371${_scopeId}>${ssrInterpolate(useCase.value.client_name)}</p>`);
            } else if (useCase.value.category_tag) {
              _push2(`<p class="use-case-detail__subtitle" data-v-95493371${_scopeId}>${ssrInterpolate(useCase.value.category_tag)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="use-case-detail__actions" data-v-95493371${_scopeId}><div class="use-case-detail__share" data-v-95493371${_scopeId}><span class="use-case-detail__share-label" data-v-95493371${_scopeId}>${ssrInterpolate(trans("Share now"))}</span><div class="use-case-detail__share-links" data-v-95493371${_scopeId}><a${ssrRenderAttr("href", getShareUrl("facebook"))} target="_blank" rel="noopener" class="use-case-detail__share-btn" aria-label="Facebook" data-v-95493371${_scopeId}><span class="icon-facebook" data-v-95493371${_scopeId}></span></a><a${ssrRenderAttr("href", getShareUrl("twitter"))} target="_blank" rel="noopener" class="use-case-detail__share-btn" aria-label="Twitter" data-v-95493371${_scopeId}><span class="fab fa-twitter" data-v-95493371${_scopeId}></span></a><a${ssrRenderAttr("href", getShareUrl("linkedin"))} target="_blank" rel="noopener" class="use-case-detail__share-btn" aria-label="LinkedIn" data-v-95493371${_scopeId}><span class="icon-linkedin" data-v-95493371${_scopeId}></span></a></div></div>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("contact-us"),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(trans("Get in Touch"))} <span class="icon-right-up" data-v-95493371${_scopeId2}></span>`);
                } else {
                  return [
                    createTextVNode(toDisplayString(trans("Get in Touch")) + " ", 1),
                    createVNode("span", { class: "icon-right-up" })
            ...
            if (useCase.value.client_name || useCase.value.completed_year || useCase.value.category_tag) {
              _push2(`<div class="use-case-detail__meta" data-v-95493371${_scopeId}>`);
              if (useCase.value.client_name) {
                _push2(`<div class="use-case-detail__pill" data-v-95493371${_scopeId}><i class="fas fa-user" data-v-95493371${_scopeId}></i><span data-v-95493371${_scopeId}>${ssrInterpolate(trans("Client"))}: ${ssrInterpolate(useCase.value.client_name)}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (useCase.value.completed_year) {
                _push2(`<div class="use-case-detail__pill" data-v-95493371${_scopeId}><i class="far fa-calendar-alt" data-v-95493371${_scopeId}></i><span data-v-95493371${_scopeId}>${ssrInterpolate(useCase.value.completed_year)}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (useCase.value.category_tag) {
                _push2(`<div class="use-case-detail__pill" data-v-95493371${_scopeId}><i class="fas fa-tag" data-v-95493371${_scopeId}></i><span data-v-95493371${_scopeId}>${ssrInterpolate(useCase.value.category_tag)}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            _push2(`<div class="use-case-detail__hero" data-v-95493371${_scopeId}><img${ssrRenderAttr("src", useCase.value.image_link)}${ssrRenderAttr("alt", useCase.value.title)} data-v-95493371${_scopeId}></div>`);
            if (useCase.value.summary) {
              _push2(`<div class="use-case-detail__section" data-v-95493371${_scopeId}><div class="use-case-detail__section-head" data-v-95493371${_scopeId}><span class="use-case-detail__section-icon" data-v-95493371${_scopeId}><i class="fas fa-lightbulb" data-v-95493371${_scopeId}></i></span><span class="use-case-detail__section-label" data-v-95493371${_scopeId}>${ssrInterpolate(trans("Project Overview"))}</span></div><p class="use-case-detail__text" data-v-95493371${_scopeId}>${ssrInterpolate(useCase.value.summary)}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (useCase.value.challenge) {
              _push2(`<div class="use-case-detail__section" data-v-95493371${_scopeId}><div class="use-case-detail__section-head" data-v-95493371${_scopeId}><span class="use-case-detail__section-icon" data-v-95493371${_scopeId}><i class="fas fa-exclamation-triangle" data-v-95493371${_scopeId}></i></span><span class="use-case-detail__section-label" data-v-95493371${_scopeId}>${ssrInterpolate(trans("The Challenge"))}</span></div><p class="use-case-detail__text" data-v-95493371${_scopeId}>${ssrInterpolate(useCase.value.challenge)}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (useCase.value.solution) {
              _push2(`<div class="use-case-detail__section" data-v-95493371${_scopeId}><div class="use-case-detail__section-head" data-v-95493371${_scopeId}><span class="use-case-detail__section-icon" data-v-95493371${_scopeId}><i class="fas fa-cogs" data-v-95493371${_scopeId}></i></span><span class="use-case-detail__section-label" data-v-95493371${_scopeId}>${ssrInterpolate(trans("Our Solution"))}</span></div><p class="use-case-detail__text" data-v-95493371${_scopeId}>${ssrInterpolate(useCase.value.solution)}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (useCase.value.results) {
              _push2(`<div class="use-case-detail__section" data-v-95493371${_scopeId}><div class="use-case-detail__section-head" data-v-95493371${_scopeId}><span class="use-case-detail__section-icon" data-v-95493371${_scopeId}><i class="fas fa-chart-line" data-v-95493371${_scopeId}></i></span><span class="use-case-detail__section-label" data-v-95493371${_scopeId}>${ssrInterpolate(trans("The Results"))}</span></div><p class="use-case-detail__text" data-v-95493371${_scopeId}>${ssrInterpolate(useCase.value.results)}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (useCase.value.content) {
              _push2(`<div class="use-case-detail__section" data-v-95493371${_scopeId}><div class="use-case-detail__section-head" data-v-95493371${_scopeId}><span class="use-case-detail__section-icon" data-v-95493371${_scopeId}><i class="fas fa-align-left" data-v-95493371${_scopeId}></i></span><span class="use-case-detail__section-label" data-v-95493371${_scopeId}>${ssrInterpolate(trans("Details"))}</span></div><div class="use-case-detail__content" data-v-95493371${_scopeId}>${useCase.value.content ?? ""}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (useCase.value.technologies && useCase.value.technologies.length) {
              _push2(`<div class="use-case-detail__section" data-v-95493371${_scopeId}><div class="use-case-detail__section-head" data-v-95493371${_scopeId}><span class="use-case-detail__section-icon" data-v-95493371${_scopeId}><i class="fas fa-code" data-v-95493371${_scopeId}></i></span><span class="use-case-detail__section-label" data-v-95493371${_scopeId}>${ssrInterpolate(trans("Technologies Used"))}</span></div><div class="use-case-detail__tags" data-v-95493371${_scopeId}><!--[-->`);
              ssrRenderList(useCase.value.technologies, (tech) => {
                _push2(`<span class="use-case-detail__tag" data-v-95493371${_scopeId}>${ssrInterpolate(tech)}</span>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              _push2(`<!---->`);
            ...
            if (useCase.value.project_url) {
              _push2(`<footer class="use-case-detail__footer" data-v-95493371${_scopeId}><a${ssrRenderAttr("href", useCase.value.project_url)} target="_blank" rel="noopener" class="use-case-detail__pill use-case-detail__pill--cta" data-v-95493371${_scopeId}>${ssrInterpolate(trans("Visit Live Project"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow`)}" data-v-95493371${_scopeId}></span></a></footer>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</article>`);
            if (relatedUseCases.value.length) {
              _push2(`<div class="use-cases-related" data-v-95493371${_scopeId}><div class="use-cases-related__head" data-v-95493371${_scopeId}><div class="section-title__tagline-box justify-content-center" data-v-95493371${_scopeId}><div class="section-title__tagline-shape-1" data-v-95493371${_scopeId}></div><span class="section-title__tagline" data-v-95493371${_scopeId}>${ssrInterpolate(trans("More Case Studies"))}</span><div class="section-title__tagline-shape-2" data-v-95493371${_scopeId}></div></div><h3 class="use-cases-related__title" data-v-95493371${_scopeId}>${ssrInterpolate(trans("Explore More Success Stories"))}</h3></div><div class="row" data-v-95493371${_scopeId}><!--[-->`);
              ssrRenderList(relatedUseCases.value, (item) => {
                _push2(`<div class="col-xl-4 col-lg-6 col-md-6" data-v-95493371${_scopeId}>`);
                _push2(ssrRenderComponent(UseCaseCard, {
                  item,
                  locale: locale.value,
                  variant: "compact"
...
const UseCaseShow = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-95493371"]]);
...
const _sfc_main$g = /* @__PURE__ */ Object.assign(__default__$3, {
  ...
  setup(__props) {
    ...
    const getServiceDescription = (service) => {
      return translateField(service == null ? void 0 : service.description);
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/page-header.css")} data-v-08f6db3e${_scopeId}><title data-v-08f6db3e${_scopeId}>${ssrInterpolate(metaTitle.value)}</title><meta name="description"${ssrRenderAttr("content", metaDescription.value)} data-v-08f6db3e${_scopeId}><meta name="keywords"${ssrRenderAttr("content", metaKeywords.value)} data-v-08f6db3e${_scopeId}><meta name="robots"${ssrRenderAttr("content", metaRobots.value)} data-v-08f6db3e${_scopeId}>`);
            if (metaCanonical.value) {
              _push2(`<link rel="canonical"${ssrRenderAttr("href", metaCanonical.value)} data-v-08f6db3e${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:title"${ssrRenderAttr("content", metaTitle.value)} data-v-08f6db3e${_scopeId}><meta property="og:description"${ssrRenderAttr("content", metaDescription.value)} data-v-08f6db3e${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta property="og:image"${ssrRenderAttr("content", metaImage.value)} data-v-08f6db3e${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (metaCanonical.value) {
              _push2(`<meta property="og:url"${ssrRenderAttr("content", metaCanonical.value)} data-v-08f6db3e${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<meta property="og:type" content="website" data-v-08f6db3e${_scopeId}><meta name="twitter:card" content="summary_large_image" data-v-08f6db3e${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", metaTitle.value)} data-v-08f6db3e${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", metaDescription.value)} data-v-08f6db3e${_scopeId}>`);
            if (metaImage.value) {
              _push2(`<meta name="twitter:image"${ssrRenderAttr("content", metaImage.value)} data-v-08f6db3e${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_sfc_main$D, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="page-header" data-v-08f6db3e${_scopeId}><div class="page-header__bg" style="${ssrRenderStyle({ backgroundImage: `url(${asset_path.value}images/backgrounds/services-bg.jpg)` })}" data-v-08f6db3e${_scopeId}></div><div class="container" data-v-08f6db3e${_scopeId}><div class="page-header__inner" data-v-08f6db3e${_scopeId}><h1 data-v-08f6db3e${_scopeId}>${ssrInterpolate(trans("Our Services"))}</h1><div class="thm-breadcrumb__box" data-v-08f6db3e${_scopeId}><ul class="thm-breadcrumb list-unstyled" data-v-08f6db3e${_scopeId}><li data-v-08f6db3e${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("home")
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="fas fa-home" data-v-08f6db3e${_scopeId2}></i>${ssrInterpolate(trans("Home"))}`);
                } else {
                  return [
                    createVNode("i", { class: "fas fa-home" }),
                    createTextVNode(toDisplayString(trans("Home")), 1)
            ...
            _push2(`</li><li data-v-08f6db3e${_scopeId}><span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-08f6db3e${_scopeId}></span></li><li data-v-08f6db3e${_scopeId}>${ssrInterpolate(trans("Our Services"))}</li></ul></div></div></div></div><section class="services-two" data-v-08f6db3e${_scopeId}><div class="container" data-v-08f6db3e${_scopeId}><div class="services-two__top" data-v-08f6db3e${_scopeId}><div class="section-title text-left sec-title-animation animation-style2" data-v-08f6db3e${_scopeId}><div class="section-title__tagline-box" data-v-08f6db3e${_scopeId}><div class="section-title__tagline-shape-1" data-v-08f6db3e${_scopeId}></div><span class="section-title__tagline" data-v-08f6db3e${_scopeId}>${ssrInterpolate(trans("Our Services"))}</span></div><h2 class="section-title__title title-animation" data-v-08f6db3e${_scopeId}>${ssrInterpolate(trans("Scale Your Business Smarter with Next-Gen IT Solutions"))} <span data-v-08f6db3e${_scopeId}></span></h2></div></div><div class="services-two__bottom" data-v-08f6db3e${_scopeId}><div class="row" data-v-08f6db3e${_scopeId}><div class="col-xl-8" data-v-08f6db3e${_scopeId}><div class="services-two__services-list" data-v-08f6db3e${_scopeId}><div class="row" data-v-08f6db3e${_scopeId}><!--[-->`);
            ssrRenderList(services.value.data, (serviceItem) => {
              _push2(`<div class="col-xl-6 col-lg-6 col-md-6 mb-4" data-v-08f6db3e${_scopeId}>`);
              _push2(ssrRenderComponent(ServiceCardThree, {
            ...
            if (!services.value.data.length) {
              _push2(`<div class="text-center py-5" data-v-08f6db3e${_scopeId}><h3 class="text-muted" data-v-08f6db3e${_scopeId}>${ssrInterpolate(trans("No services found"))}</h3></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            if (services.value.last_page > 1) {
              _push2(`<div class="blog-page__pagination services-pagination" data-v-08f6db3e${_scopeId}><ul class="pg-pagination list-unstyled" data-v-08f6db3e${_scopeId}>`);
              if (services.value.prev_page_url) {
                _push2(`<li class="prev" data-v-08f6db3e${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span class="icon-left-arrow-1" data-v-08f6db3e${_scopeId2}></span>`);
                    } else {
                      return [
                        createVNode("span", { class: "icon-left-arrow-1" })
                      ];
              ...
              ssrRenderList(services.value.links, (link, linkIndex) => {
                ...
                if (link.url && linkIndex > 0 && linkIndex < services.value.links.length - 1) {
                  _push2(`<li class="${ssrRenderClass(["count", link.active ? "active" : ""])}" data-v-08f6db3e${_scopeId}>`);
                  _push2(ssrRenderComponent(unref(Link), {
                    href: link.url
                  }, {
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              ...
              if (services.value.next_page_url) {
                _push2(`<li class="next" data-v-08f6db3e${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}" data-v-08f6db3e${_scopeId2}></span>`);
                    } else {
                      return [
                        createVNode("span", {
                          class: `icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`
            ...
            _push2(`</div><div class="col-xl-4" data-v-08f6db3e${_scopeId}><div class="services-index__sidebar" data-v-08f6db3e${_scopeId}><div class="services-details__services-list-box" data-v-08f6db3e${_scopeId}><h3 class="services-details__services-list-title" data-v-08f6db3e${_scopeId}>${ssrInterpolate(trans("Service Categories"))}</h3><ul class="services-details__services-list list-unstyled" data-v-08f6db3e${_scopeId}><li data-v-08f6db3e${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("services.index"),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` (${ssrInterpolate(totalServicesCount.value)}) ${ssrInterpolate(trans("All Services"))} <span class="${ssrRenderClass(locale.value === "ar" ? "icon-left-arrow-2" : "icon-right-arrow-2")}" data-v-08f6db3e${_scopeId2}></span>`);
                } else {
                  return [
            ...
            _push2(`</li><!--[-->`);
            ssrRenderList(categories.value, (category) => {
              _push2(`<li data-v-08f6db3e${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` (${ssrInterpolate(category.services_count || 0)}) ${ssrInterpolate(getCategoryName(category))} <span class="${ssrRenderClass(locale.value === "ar" ? "icon-left-arrow-2" : "icon-right-arrow-2")}" data-v-08f6db3e${_scopeId2}></span>`);
                  } else {
                    return [
            ...
            return [
              createVNode("div", { class: "page-header" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h1", null, toDisplayString(trans("Our Services")), 1),
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        createVNode("li", null, [
                          createVNode(unref(Link), {
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList(services.value.data, (serviceItem) => {
                              return openBlock(), createBlock("div", {
                                ...
                                createVNode(ServiceCardThree, {
                                  ...
                                  "reading-time": serviceItem.reading_time,
                                  "reading-time-label": trans("min read")
                                }, null, 8, ["title", "short-desc", "description", "highlights", "link", "image", "button-label", "is-rtl", "reading-time", "reading-time-label"])
                              ]);
                            }), 128))
                          ]),
...
const ServiceIndex = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-08f6db3e"]]);
...
const PortalSelect = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-2ede9016"]]);
const _sfc_main$d = {
  __name: "Create",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    const metaTitle = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.title) || t("tickets.create_title");
    });
    const metaDescription = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.description) || t("pages.tickets_description");
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$l, mergeProps({
        title: unref(t)("tickets.create_title"),
        subtitle: unref(t)("tickets.create_subtitle"),
        active: "tickets",
        breadcrumbs: [
          { label: unref(t)("menu.my_dashboard"), href: _ctx.route("portal.dashboard") },
          { label: unref(t)("tickets.title"), href: _ctx.route("portal.tickets.index") },
          { label: unref(t)("tickets.create_title") }
        ],
        "meta-title": metaTitle.value,
        "meta-description": metaDescription.value
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="portal-form-row"${_scopeId}><div class="portal-form-group"${_scopeId}><label for="ticket_category_id"${_scopeId}>${ssrInterpolate(unref(t)("fields.category"))} *</label>`);
            _push2(ssrRenderComponent(PortalSelect, {
              ...
              placeholder: unref(t)("tickets.select_category"),
            ...
            _push2(`</div><div class="portal-form-group"${_scopeId}><label for="priority"${_scopeId}>${ssrInterpolate(unref(t)("fields.priority"))} *</label>`);
            _push2(ssrRenderComponent(PortalSelect, {
              id: "priority",
              modelValue: unref(form).priority,
              "onUpdate:modelValue": ($event) => unref(form).priority = $event,
              options: priorityOptions.value,
              placeholder: unref(t)("tickets.select_priority"),
            ...
            _push2(`</div></div><div class="portal-form-group"${_scopeId}><label for="description"${_scopeId}>${ssrInterpolate(unref(t)("fields.description"))} *</label><textarea id="description" rows="6" class="${ssrRenderClass([{ "portal-input--error": unref(form).errors.description }, "portal-input"])}" required${_scopeId}>${ssrInterpolate(unref(form).description)}</textarea>`);
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("tickets.back_to_tickets"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("tickets.back_to_tickets")), 1)
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`<button type="submit" class="thm-btn"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""}${_scopeId}>${ssrInterpolate(unref(t)("tickets.submit_ticket"))}</button></div></form></div></div>`);
          } else {
            return [
                ...
                createVNode("div", { class: "portal-panel__body" }, [
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "portal-form-group" }, [
                      createVNode("label", { for: "subject" }, toDisplayString(unref(t)("fields.subject")) + " *", 1),
                      withDirectives(createVNode("input", {
                        id: "subject",
                    ...
                    createVNode("div", { class: "portal-form-row" }, [
                      createVNode("div", { class: "portal-form-group" }, [
                        createVNode("label", { for: "ticket_category_id" }, toDisplayString(unref(t)("fields.category")) + " *", 1),
                      ...
                      createVNode("div", { class: "portal-form-group" }, [
                        createVNode("label", { for: "priority" }, toDisplayString(unref(t)("fields.priority")) + " *", 1),
                        createVNode(PortalSelect, {
                          id: "priority",
                          modelValue: unref(form).priority,
                          "onUpdate:modelValue": ($event) => unref(form).priority = $event,
                    ...
                    createVNode("div", { class: "portal-form-group" }, [
                      createVNode("label", { for: "description" }, toDisplayString(unref(t)("fields.description")) + " *", 1),
                      withDirectives(createVNode("textarea", {
                        id: "description",
                    ...
                    createVNode("div", { class: "portal-form-group" }, [
                      createVNode("label", { for: "attachment" }, toDisplayString(unref(t)("projects.attachments")), 1),
                      createVNode("input", {
                        id: "attachment",
                        type: "file",
                      ...
                      createVNode("p", { class: "portal-form-hint" }, toDisplayString(unref(t)("tickets.attachment_hint")), 1),
                    ...
                    createVNode("div", { class: "portal-ticket-form__actions" }, [
                      ...
                      }, toDisplayString(unref(t)("tickets.submit_ticket")), 9, ["disabled"])
                    ])
                  ], 32)
                ])
              ])
...
const _sfc_main$c = {
  ...
  setup(__props) {
    ...
    const metaTitle = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.title) || t("pages.tickets_title");
    });
    const metaDescription = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.description) || t("pages.tickets_description");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$l, mergeProps({
        title: unref(t)("tickets.title"),
        subtitle: unref(t)("tickets.subtitle"),
        active: "tickets",
        breadcrumbs: [
          { label: unref(t)("menu.my_dashboard"), href: _ctx.route("portal.dashboard") },
          { label: unref(t)("tickets.title") }
        ],
        "meta-title": metaTitle.value,
        "meta-description": metaDescription.value
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(PortalSelect, {
              ...
              placeholder: unref(t)("tickets.all_statuses")
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="portal-ticket-filters__group"${_scopeId}><label${_scopeId}>${ssrInterpolate(unref(t)("tickets.filter_priority"))}</label>`);
            _push2(ssrRenderComponent(PortalSelect, {
              modelValue: filterForm.priority,
              "onUpdate:modelValue": ($event) => filterForm.priority = $event,
              options: priorityOptions.value,
              placeholder: unref(t)("tickets.all_priorities")
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="portal-ticket-filters__group"${_scopeId}><label${_scopeId}>${ssrInterpolate(unref(t)("tickets.sort_newest"))}</label>`);
            _push2(ssrRenderComponent(PortalSelect, {
              modelValue: filterForm.sort,
              "onUpdate:modelValue": ($event) => filterForm.sort = $event,
              options: sortOptions.value
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="portal-ticket-filters__actions"${_scopeId}><button type="submit" class="thm-btn"${_scopeId}>${ssrInterpolate(unref(t)("tickets.apply_filters"))}</button><button type="button" class="portal-panel__action"${_scopeId}>${ssrInterpolate(unref(t)("tickets.clear_filters"))}</button></div></form>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="fas fa-plus me-1"${_scopeId2}></i>${ssrInterpolate(unref(t)("tickets.new_ticket"))}`);
                } else {
                  return [
                    createVNode("i", { class: "fas fa-plus me-1" }),
                    createTextVNode(toDisplayString(unref(t)("tickets.new_ticket")), 1)
                  ];
                }
              }),
              _: 1
            ...
            if (__props.tickets.data.length === 0) {
              ...
              ssrRenderList(__props.tickets.data, (ticket) => {
                ...
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${ssrInterpolate(unref(t)("tickets.view_ticket"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow`)}"${_scopeId2}></span>`);
                    } else {
                      return [
                        createTextVNode(toDisplayString(unref(t)("tickets.view_ticket")) + " ", 1),
                        createVNode("span", {
                          class: `icon-${locale.value === "ar" ? "left" : "right"}-arrow`
                        }, null, 2)
                      ];
            ...
            return [
                  ...
                  createVNode("div", { class: "portal-ticket-toolbar" }, [
                    createVNode("form", {
                      ...
                      createVNode("div", { class: "portal-ticket-filters__group" }, [
                        createVNode("label", null, toDisplayString(unref(t)("tickets.filter_status")), 1),
                        createVNode(PortalSelect, {
                          modelValue: filterForm.status,
                          "onUpdate:modelValue": ($event) => filterForm.status = $event,
                          options: statusOptions.value,
                      ...
                      createVNode("div", { class: "portal-ticket-filters__group" }, [
                        createVNode("label", null, toDisplayString(unref(t)("tickets.filter_priority")), 1),
                        createVNode(PortalSelect, {
                          modelValue: filterForm.priority,
                          "onUpdate:modelValue": ($event) => filterForm.priority = $event,
                          options: priorityOptions.value,
                      ...
                      createVNode("div", { class: "portal-ticket-filters__group" }, [
                        createVNode("label", null, toDisplayString(unref(t)("tickets.sort_newest")), 1),
                        createVNode(PortalSelect, {
                          modelValue: filterForm.sort,
                          "onUpdate:modelValue": ($event) => filterForm.sort = $event,
                          options: sortOptions.value
                      ...
                      createVNode("div", { class: "portal-ticket-filters__actions" }, [
                        createVNode("button", {
                          type: "submit",
                          class: "thm-btn"
                        }, toDisplayString(unref(t)("tickets.apply_filters")), 1),
                        createVNode("button", {
                          type: "button",
                          class: "portal-panel__action",
                          onClick: clearFilters
                        }, toDisplayString(unref(t)("tickets.clear_filters")), 1)
                      ])
                    ], 32),
                    createVNode(unref(Link), {
                      href: _ctx.route("portal.tickets.create"),
              ...
              __props.tickets.data.length === 0 ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "portal-empty" }, [
                  ...
                  createTextVNode(" " + toDisplayString(unref(t)("tickets.no_tickets")), 1)
                ])
              ])) : (openBlock(), createBlock("div", {
                key: 1,
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(__props.tickets.data, (ticket) => {
                  return openBlock(), createBlock("article", {
                    ...
                    createVNode("div", { class: "portal-ticket-card__meta" }, [
                      createVNode("div", null, [
                        createVNode("span", null, toDisplayString(unref(t)("fields.category")), 1),
                        createVNode("strong", null, toDisplayString(ticket.category || "—"), 1)
                      ]),
                      createVNode("div", null, [
                        createVNode("span", null, toDisplayString(unref(t)("fields.priority")), 1),
                        createVNode("strong", null, toDisplayString(unref(ticketPriorityLabel)(ticket.priority)), 1)
                      ]),
                      createVNode("div", null, [
                        createVNode("span", null, toDisplayString(unref(t)("fields.status")), 1),
...
const _sfc_main$b = {
  ...
  setup(__props) {
    ...
    const metaDescription = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.description) || t("pages.ticket_show_description");
    });
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="${ssrRenderClass(`fas fa-arrow-${locale.value === "ar" ? "right" : "left"}`)}"${_scopeId2}></i> ${ssrInterpolate(unref(t)("tickets.back_to_tickets"))}`);
                } else {
                  return [
                    createVNode("i", {
            ...
            _push2(`<div class="portal-grid portal-grid--show"${_scopeId}><div${_scopeId}><div class="portal-panel"${_scopeId}><div class="portal-panel__header"${_scopeId}><h2 class="portal-panel__title"${_scopeId}>${ssrInterpolate(unref(t)("projects.details"))}</h2></div><div class="portal-panel__body"${_scopeId}><div class="portal-details"${_scopeId}><div class="portal-details__row"${_scopeId}><div class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.ticket_number"))}</div><div class="portal-details__value"${_scopeId}>${ssrInterpolate(__props.ticket.ticket_number)}</div></div><div class="portal-details__row"${_scopeId}><div class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.status"))}</div><div class="portal-details__value"${_scopeId}><span class="${ssrRenderClass([statusBadgeClass(__props.ticket.status), "portal-badge"])}"${_scopeId}>${ssrInterpolate(unref(ticketStatusLabel)(__props.ticket.status))}</span></div></div><div class="portal-details__row"${_scopeId}><div class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.priority"))}</div><div class="portal-details__value"${_scopeId}>${ssrInterpolate(unref(ticketPriorityLabel)(__props.ticket.priority))}</div></div><div class="portal-details__row"${_scopeId}><div class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.category"))}</div><div class="portal-details__value"${_scopeId}>${ssrInterpolate(__props.ticket.category || "—")}</div></div><div class="portal-details__row"${_scopeId}><div class="portal-details__label"${_scopeId}>${ssrInterpolate(unref(t)("fields.created_at"))}</div><div class="portal-details__value"${_scopeId}>${ssrInterpolate(formatDate(__props.ticket.created_at))}</div></div></div></div></div>`);
            if (__props.ticket.can_reply) {
              _push2(`<div class="portal-panel" style="${ssrRenderStyle({ "margin-top": "24px" })}"${_scopeId}><div class="portal-panel__body"${_scopeId}><button type="button" class="portal-panel__action text-danger"${_scopeId}><i class="fas fa-times-circle me-1"${_scopeId}></i>${ssrInterpolate(unref(t)("tickets.close_ticket"))}</button></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="portal-grid__stack"${_scopeId}><div class="portal-panel"${_scopeId}><div class="portal-panel__header"${_scopeId}><h2 class="portal-panel__title"${_scopeId}>${ssrInterpolate(unref(t)("tickets.conversation"))}</h2></div><div class="portal-panel__body"${_scopeId}><div class="portal-ticket-thread"${_scopeId}><div class="portal-ticket-message portal-ticket-message--customer"${_scopeId}><div class="portal-ticket-message__header"${_scopeId}><strong${_scopeId}>${ssrInterpolate(unref(t)("tickets.original_message"))}</strong><span${_scopeId}>${ssrInterpolate(formatDate(__props.ticket.created_at))}</span></div><div class="portal-ticket-message__body"${_scopeId}>${ssrInterpolate(__props.ticket.description)}</div>`);
            ...
            if (__props.ticket.can_reply) {
              ...
              _push2(`</div><button type="submit" class="thm-btn"${ssrIncludeBooleanAttr(unref(replyForm).processing) ? " disabled" : ""}${_scopeId}>${ssrInterpolate(unref(t)("tickets.send_reply"))}</button></form></div>`);
            } else {
              _push2(`<div class="portal-empty portal-empty--compact"${_scopeId}>${ssrInterpolate(unref(t)("tickets.ticket_closed"))}</div>`);
            }
            _push2(`</div></div></div></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "portal-grid portal-grid--show" }, [
                createVNode("div", null, [
                  createVNode("div", { class: "portal-panel" }, [
                    ...
                    createVNode("div", { class: "portal-panel__body" }, [
                      createVNode("div", { class: "portal-details" }, [
                        createVNode("div", { class: "portal-details__row" }, [
                          createVNode("div", { class: "portal-details__label" }, toDisplayString(unref(t)("fields.ticket_number")), 1),
                        ...
                        createVNode("div", { class: "portal-details__row" }, [
                          createVNode("div", { class: "portal-details__label" }, toDisplayString(unref(t)("fields.priority")), 1),
                          createVNode("div", { class: "portal-details__value" }, toDisplayString(unref(ticketPriorityLabel)(__props.ticket.priority)), 1)
                        ]),
                        createVNode("div", { class: "portal-details__row" }, [
                          createVNode("div", { class: "portal-details__label" }, toDisplayString(unref(t)("fields.category")), 1),
                          createVNode("div", { class: "portal-details__value" }, toDisplayString(__props.ticket.category || "—"), 1)
                        ]),
                        createVNode("div", { class: "portal-details__row" }, [
                          createVNode("div", { class: "portal-details__label" }, toDisplayString(unref(t)("fields.created_at")), 1),
                  ...
                  __props.ticket.can_reply ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "portal-panel__body" }, [
                      createVNode("button", {
                        ...
                        createTextVNode(toDisplayString(unref(t)("tickets.close_ticket")), 1)
                      ])
                    ])
                  ])) : createCommentVNode("", true)
                ]),
                createVNode("div", { class: "portal-grid__stack" }, [
                  createVNode("div", { class: "portal-panel" }, [
                    createVNode("div", { class: "portal-panel__header" }, [
                      createVNode("h2", { class: "portal-panel__title" }, toDisplayString(unref(t)("tickets.conversation")), 1)
                    ]),
                    createVNode("div", { class: "portal-panel__body" }, [
                      createVNode("div", { class: "portal-ticket-thread" }, [
                        createVNode("div", { class: "portal-ticket-message portal-ticket-message--customer" }, [
                          createVNode("div", { class: "portal-ticket-message__header" }, [
                            createVNode("strong", null, toDisplayString(unref(t)("tickets.original_message")), 1),
                      ...
                      __props.ticket.can_reply ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("form", {
                          ...
                          createVNode("div", { class: "portal-form-group" }, [
                            createVNode("label", { for: "reply" }, toDisplayString(unref(t)("tickets.send_reply")), 1),
                            withDirectives(createVNode("textarea", {
                              id: "reply",
                              "onUpdate:modelValue": ($event) => unref(replyForm).body = $event,
                              rows: "4",
                              class: ["portal-input", { "portal-input--error": unref(replyForm).errors.body }],
                              placeholder: unref(t)("tickets.reply_placeholder"),
                              required: ""
                          ...
                          }, toDisplayString(unref(t)("tickets.send_reply")), 9, ["disabled"])
                        ], 32)
                      ])) : (openBlock(), createBlock("div", {
                        key: 1,
                        class: "portal-empty portal-empty--compact"
                      }, toDisplayString(unref(t)("tickets.ticket_closed")), 1))
                    ])
                  ])
                ])
              ])
...
const ForgotPassword = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-5b68d6b8"]]);
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$3]]);
...
const Register = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-daff4a9e"]]);
...
const ResetPassword = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-f5323f04"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_Head, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<link rel="stylesheet"${ssrRenderAttr("href", $setup.asset_path + "site/css/module-css/page-header.css")}${_scopeId}><link rel="stylesheet"${ssrRenderAttr("href", $setup.asset_path + "site/css/module-css/shop.css")}${_scopeId}><title${_scopeId}>${ssrInterpolate($setup.metaTitle)}</title><meta name="description"${ssrRenderAttr("content", $setup.metaDescription)}${_scopeId}><meta name="robots" content="noindex, nofollow"${_scopeId}>`);
      } else {
        return [
          createVNode("link", {
            rel: "stylesheet",
  ...
  _push(ssrRenderComponent(_component_app_layout, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<section class="page-header"${_scopeId}><div class="page-header__bg" style="${ssrRenderStyle({ backgroundImage: `url(${$setup.asset_path}images/backgrounds/login-bg.jpg)` })}"${_scopeId}></div><div class="container"${_scopeId}><div class="page-header__inner"${_scopeId}><h2${_scopeId}>${ssrInterpolate($setup.trans("Two-Factor Authentication"))}</h2><div class="thm-breadcrumb__box"${_scopeId}><ul class="thm-breadcrumb list-unstyled"${_scopeId}><li${_scopeId}><a href="/"${_scopeId}><i class="fas fa-home"${_scopeId}></i>${ssrInterpolate($setup.trans("Home"))}</a></li><li${_scopeId}><span class="${ssrRenderClass(`icon-${$setup.locale === "ar" ? "left" : "right"}-arrow-1`)}"${_scopeId}></span></li><li${_scopeId}>${ssrInterpolate($setup.trans("Two-Factor Authentication"))}</li></ul></div></div></div></section><section class="login-one"${_scopeId}><div class="container"${_scopeId}><div class="login-one__form"${_scopeId}><div class="inner-title text-center"${_scopeId}><h2${_scopeId}>${ssrInterpolate($setup.trans("Two-Factor Authentication"))}</h2><p class="mt-3 mb-0"${_scopeId}>${ssrInterpolate($setup.trans("Please confirm access to your account by entering the authentication code provided by your authenticator application."))}</p></div><form class="mt-4"${_scopeId}><div class="row"${_scopeId}>`);
        if (!$setup.useRecoveryCode) {
          _push2(`<div class="col-xl-12"${_scopeId}><div class="form-group"${_scopeId}><div class="input-box"${_scopeId}><input${ssrRenderAttr("value", $setup.form.code)} type="text" inputmode="numeric" autocomplete="one-time-code"${ssrRenderAttr("placeholder", $setup.trans("Authentication Code"))}${ssrIncludeBooleanAttr($setup.form.processing) ? " disabled" : ""} required autofocus${_scopeId}></div>`);
          if ($setup.form.errors.code) {
            _push2(`<div class="text-danger mt-1 small"${_scopeId}>${ssrInterpolate($setup.form.errors.code)}</div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></div>`);
        } else {
          _push2(`<div class="col-xl-12"${_scopeId}><div class="form-group"${_scopeId}><div class="input-box"${_scopeId}><input${ssrRenderAttr("value", $setup.form.recovery_code)} type="text" autocomplete="one-time-code"${ssrRenderAttr("placeholder", $setup.trans("Recovery Code"))}${ssrIncludeBooleanAttr($setup.form.processing) ? " disabled" : ""} required autofocus${_scopeId}></div>`);
          if ($setup.form.errors.recovery_code) {
            _push2(`<div class="text-danger mt-1 small"${_scopeId}>${ssrInterpolate($setup.form.errors.recovery_code)}</div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></div>`);
        }
        _push2(`<div class="col-xl-12 text-center mb-3"${_scopeId}><button type="button" class="btn btn-link"${ssrIncludeBooleanAttr($setup.form.processing) ? " disabled" : ""}${_scopeId}>${ssrInterpolate($setup.useRecoveryCode ? $setup.trans("Use an authentication code") : $setup.trans("Use a recovery code"))}</button></div><div class="col-xl-12"${_scopeId}><div class="form-group"${_scopeId}><button type="submit"${ssrIncludeBooleanAttr($setup.form.processing) ? " disabled" : ""} class="${ssrRenderClass([{ "opacity-50": $setup.form.processing }, "thm-btn"])}"${_scopeId}>`);
        if ($setup.form.processing) {
          _push2(`<span${_scopeId}><i class="fa-solid fa-spinner fa-spin me-2"${_scopeId}></i>${ssrInterpolate($setup.trans("Signing In..."))}</span>`);
        } else {
          _push2(`<span${_scopeId}>${ssrInterpolate($setup.trans("Login"))} <span class="${ssrRenderClass(`icon-${$setup.locale === "ar" ? "left" : "right"}-arrow`)}"${_scopeId}></span></span>`);
        }
        _push2(`</button></div></div></div></form></div></div></section>`);
      } else {
        return [
          createVNode("section", { class: "page-header" }, [
            createVNode("div", {
            ...
            createVNode("div", { class: "container" }, [
              createVNode("div", { class: "page-header__inner" }, [
                createVNode("h2", null, toDisplayString($setup.trans("Two-Factor Authentication")), 1),
                createVNode("div", { class: "thm-breadcrumb__box" }, [
                  createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                    createVNode("li", null, [
                      createVNode("a", { href: "/" }, [
                    ...
                    createVNode("li", null, toDisplayString($setup.trans("Two-Factor Authentication")), 1)
                  ])
                ])
              ])
            ])
          ...
          createVNode("section", { class: "login-one" }, [
            createVNode("div", { class: "container" }, [
              createVNode("div", { class: "login-one__form" }, [
                createVNode("div", { class: "inner-title text-center" }, [
                  createVNode("h2", null, toDisplayString($setup.trans("Two-Factor Authentication")), 1),
                  createVNode("p", { class: "mt-3 mb-0" }, toDisplayString($setup.trans("Please confirm access to your account by entering the authentication code provided by your authenticator application.")), 1)
                ]),
                createVNode("form", {
                  class: "mt-4",
                  ...
                  createVNode("div", { class: "row" }, [
                    ...
                    createVNode("div", { class: "col-xl-12 text-center mb-3" }, [
                      createVNode("button", {
                        type: "button",
                        class: "btn btn-link",
                        disabled: $setup.form.processing,
...
const TwoFactorChallenge = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/page-header.css")}${_scopeId}><link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/portal.css")}${_scopeId}><title${_scopeId}>${ssrInterpolate(metaTitle.value)}</title><meta name="description"${ssrRenderAttr("content", metaDescription.value)}${_scopeId}><meta name="robots" content="noindex, nofollow"${_scopeId}>`);
          } else {
            return [
              createVNode("link", {
                rel: "stylesheet",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("profile.back_to_profile"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("profile.back_to_profile")), 1)
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`<button type="submit" class="thm-btn"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""}${_scopeId}>${ssrInterpolate(unref(t)("profile.confirm_password_button"))}</button></div></form></div></div></div></section>`);
          } else {
            return [
              createVNode("section", { class: "page-header portal-page-header" }, [
                createVNode("div", {
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h2", null, toDisplayString(unref(t)("profile.confirm_password_title")), 1),
                    createVNode("p", { class: "portal-page-header__subtitle" }, toDisplayString(unref(t)("profile.confirm_password_description")), 1)
                  ])
                ])
              ]),
              createVNode("section", { class: "portal-one" }, [
                  ...
                  createVNode("div", { class: "portal-panel portal-panel--narrow" }, [
                    createVNode("div", { class: "portal-panel__body" }, [
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "portal-form-group" }, [
                          createVNode("label", { for: "password" }, toDisplayString(unref(t)("profile.current_password")) + " *", 1),
                          withDirectives(createVNode("input", {
                            id: "password",
                        ...
                        createVNode("div", { class: "portal-profile-form__actions" }, [
                          ...
                          createVNode("button", {
                            ...
                            class: "thm-btn",
                            disabled: unref(form).processing
                          }, toDisplayString(unref(t)("profile.confirm_password_button")), 9, ["disabled"])
                        ])
                      ], 32)
                    ])
                  ])
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    const metaTitle = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.title) || t("pages.dashboard_title");
    });
    const metaDescription = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.description) || t("pages.dashboard_description");
    });
    const welcomeSubtitle = computed(() => {
      var _a;
      return `${t("dashboard.welcome", { name: (_a = auth.value) == null ? void 0 : _a.name })} — ${t("dashboard.subtitle")}`;
    });
    const formatMoney = (amount, currency) => `${Number(amount).toFixed(2)} ${currency || ""}`.trim();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$l, mergeProps({
        title: unref(t)("menu.my_dashboard"),
        subtitle: welcomeSubtitle.value,
        active: "dashboard",
        breadcrumbs: [{ label: unref(t)("menu.my_dashboard") }],
        "meta-title": metaTitle.value,
        "meta-description": metaDescription.value
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="portal-stats"${_scopeId}><div class="portal-stat"${_scopeId}><span class="portal-stat__icon"${_scopeId}><i class="fas fa-briefcase"${_scopeId}></i></span><span class="portal-stat__label"${_scopeId}>${ssrInterpolate(unref(t)("dashboard.total_projects"))}</span><span class="portal-stat__value"${_scopeId}>${ssrInterpolate(__props.stats.total_projects)}</span></div><div class="portal-stat"${_scopeId}><span class="portal-stat__icon"${_scopeId}><i class="fas fa-spinner"${_scopeId}></i></span><span class="portal-stat__label"${_scopeId}>${ssrInterpolate(unref(t)("dashboard.active_projects"))}</span><span class="portal-stat__value"${_scopeId}>${ssrInterpolate(__props.stats.active_projects)}</span></div><div class="portal-stat"${_scopeId}><span class="portal-stat__icon"${_scopeId}><i class="fas fa-bell"${_scopeId}></i></span><span class="portal-stat__label"${_scopeId}>${ssrInterpolate(unref(t)("menu.notifications"))}</span><span class="portal-stat__value"${_scopeId}>${ssrInterpolate(__props.stats.unread_notifications)}</span></div></div><div class="row g-4"${_scopeId}><div class="col-lg-7"${_scopeId}><div class="portal-panel"${_scopeId}><div class="portal-panel__header"${_scopeId}><h2 class="portal-panel__title"${_scopeId}>${ssrInterpolate(unref(t)("dashboard.recent_projects"))}</h2>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("portal.projects.index"),
              class: "portal-panel__action"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("dashboard.view_all_projects"))} <i class="${ssrRenderClass(`fas fa-arrow-${locale.value === "ar" ? "left" : "right"}`)}"${_scopeId2}></i>`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("dashboard.view_all_projects")) + " ", 1),
                    createVNode("i", {
            ...
            if (__props.projects.length === 0) {
              _push2(`<div class="portal-empty"${_scopeId}><i class="fas fa-folder-open"${_scopeId}></i> ${ssrInterpolate(unref(t)("dashboard.no_projects"))}</div>`);
            } else {
              _push2(`<div class="portal-table-wrap"${_scopeId}><table class="portal-table"${_scopeId}><thead${_scopeId}><tr${_scopeId}><th${_scopeId}>${ssrInterpolate(unref(t)("fields.status"))}</th><th${_scopeId}>${ssrInterpolate(unref(t)("projects.title"))}</th><th${_scopeId}>${ssrInterpolate(unref(t)("fields.remaining"))}</th><th${_scopeId}></th></tr></thead><tbody${_scopeId}><!--[-->`);
              ssrRenderList(__props.projects, (project) => {
                ...
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${ssrInterpolate(unref(t)("projects.view_details"))}`);
                    } else {
                      return [
                        createTextVNode(toDisplayString(unref(t)("projects.view_details")), 1)
                      ];
            ...
            _push2(`</div></div></div><div class="col-lg-5"${_scopeId}><div class="portal-panel"${_scopeId}><div class="portal-panel__header"${_scopeId}><h2 class="portal-panel__title"${_scopeId}>${ssrInterpolate(unref(t)("dashboard.recent_notifications"))}</h2>`);
            if (__props.notifications.length) {
              _push2(`<button type="button" class="portal-link-muted"${_scopeId}>${ssrInterpolate(unref(t)("notifications.mark_all_read"))}</button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="portal-panel__body"${_scopeId}>`);
            if (__props.notifications.length === 0) {
              _push2(`<div class="portal-empty"${_scopeId}><i class="fas fa-bell-slash"${_scopeId}></i> ${ssrInterpolate(unref(t)("dashboard.no_notifications"))}</div>`);
            } else {
            ...
            return [
              createVNode("div", { class: "portal-stats" }, [
                createVNode("div", { class: "portal-stat" }, [
                  ...
                  createVNode("span", { class: "portal-stat__label" }, toDisplayString(unref(t)("dashboard.total_projects")), 1),
                ...
                createVNode("div", { class: "portal-stat" }, [
                  ...
                  createVNode("span", { class: "portal-stat__label" }, toDisplayString(unref(t)("dashboard.active_projects")), 1),
                ...
                createVNode("div", { class: "portal-stat" }, [
                  ...
                  createVNode("span", { class: "portal-stat__label" }, toDisplayString(unref(t)("menu.notifications")), 1),
              ...
              createVNode("div", { class: "row g-4" }, [
                createVNode("div", { class: "col-lg-7" }, [
                  createVNode("div", { class: "portal-panel" }, [
                    createVNode("div", { class: "portal-panel__header" }, [
                      createVNode("h2", { class: "portal-panel__title" }, toDisplayString(unref(t)("dashboard.recent_projects")), 1),
                      createVNode(unref(Link), {
                        href: _ctx.route("portal.projects.index"),
                        class: "portal-panel__action"
                      }, {
                    ...
                    createVNode("div", { class: "portal-panel__body" }, [
                      __props.projects.length === 0 ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("i", { class: "fas fa-folder-open" }),
                        createTextVNode(" " + toDisplayString(unref(t)("dashboard.no_projects")), 1)
                      ])) : (openBlock(), createBlock("div", {
                        key: 1,
                        ...
                        createVNode("table", { class: "portal-table" }, [
                          createVNode("thead", null, [
                            createVNode("tr", null, [
                              createVNode("th", null, toDisplayString(unref(t)("fields.status")), 1),
                              createVNode("th", null, toDisplayString(unref(t)("projects.title")), 1),
                              createVNode("th", null, toDisplayString(unref(t)("fields.remaining")), 1),
                              createVNode("th")
                            ])
                          ]),
                ...
                createVNode("div", { class: "col-lg-5" }, [
                  createVNode("div", { class: "portal-panel" }, [
                    createVNode("div", { class: "portal-panel__header" }, [
                      createVNode("h2", { class: "portal-panel__title" }, toDisplayString(unref(t)("dashboard.recent_notifications")), 1),
                      __props.notifications.length ? (openBlock(), createBlock("button", {
                        key: 0,
                        type: "button",
                        class: "portal-link-muted",
                        onClick: markAllRead
                      }, toDisplayString(unref(t)("notifications.mark_all_read")), 1)) : createCommentVNode("", true)
                    ]),
                    createVNode("div", { class: "portal-panel__body" }, [
                      __props.notifications.length === 0 ? (openBlock(), createBlock("div", {
                        ...
                        createTextVNode(" " + toDisplayString(unref(t)("dashboard.no_notifications")), 1)
                      ])) : (openBlock(), createBlock("div", {
                        key: 1,
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    const metaTitle = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.title) || t("pages.profile_title");
    });
    const metaDescription = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.description) || t("pages.profile_description");
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$l, mergeProps({
        title: unref(t)("profile.title"),
        subtitle: unref(t)("profile.subtitle"),
        active: "profile",
        breadcrumbs: [
          { label: unref(t)("menu.my_dashboard"), href: _ctx.route("portal.dashboard") },
          { label: unref(t)("profile.title") }
        ],
        "meta-title": metaTitle.value,
        "meta-description": metaDescription.value
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="row g-4"${_scopeId}><div class="col-lg-6"${_scopeId}><div class="portal-panel"${_scopeId}><div class="portal-panel__header"${_scopeId}><h2 class="portal-panel__title"${_scopeId}>${ssrInterpolate(unref(t)("profile.information"))}</h2></div><div class="portal-panel__body"${_scopeId}><form class="portal-profile-form"${_scopeId}><div class="portal-profile-avatar"${_scopeId}><div class="portal-profile-avatar__preview"${_scopeId}><img${ssrRenderAttr("src", avatarPreview.value || __props.user.avatar)}${ssrRenderAttr("alt", unref(t)("profile.avatar"))}${_scopeId}></div><div class="portal-profile-avatar__actions"${_scopeId}><label class="portal-profile-avatar__upload thm-btn thm-btn--sm"${_scopeId}><i class="fas fa-camera"${_scopeId}></i> ${ssrInterpolate(unref(t)("profile.change_photo"))} <input type="file" accept="image/jpeg,image/png,image/jpg,image/webp" class="d-none"${_scopeId}></label>`);
            if (avatarPreview.value) {
              _push2(`<button type="button" class="portal-panel__action"${_scopeId}>${ssrInterpolate(unref(t)("profile.remove_photo"))}</button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            ...
            _push2(`</div><div class="portal-form-group"${_scopeId}><label for="profile-name"${_scopeId}>${ssrInterpolate(unref(t)("profile.name"))} *</label><input id="profile-name"${ssrRenderAttr("value", unref(profileForm).name)} type="text" class="${ssrRenderClass([{ "portal-input--error": unref(profileForm).errors.name }, "portal-input"])}" required${_scopeId}>`);
            ...
            _push2(`</div><div class="portal-form-group"${_scopeId}><label for="profile-mobile"${_scopeId}>${ssrInterpolate(unref(t)("profile.mobile"))}</label><input id="profile-mobile"${ssrRenderAttr("value", unref(profileForm).mobile)} type="text" class="${ssrRenderClass([{ "portal-input--error": unref(profileForm).errors.mobile }, "portal-input"])}"${_scopeId}>`);
            ...
            _push2(`</div><div class="portal-form-group"${_scopeId}><label for="confirm-password"${_scopeId}>${ssrInterpolate(unref(t)("profile.confirm_password"))} *</label><input id="confirm-password"${ssrRenderAttr("value", unref(passwordForm).password_confirmation)} type="password" class="portal-input" required autocomplete="new-password"${_scopeId}></div><div class="portal-profile-form__actions"${_scopeId}><button type="submit" class="thm-btn"${ssrIncludeBooleanAttr(unref(passwordForm).processing) ? " disabled" : ""}${_scopeId}>${ssrInterpolate(unref(t)("profile.update_password"))}</button></div></form></div></div><div class="portal-panel"${_scopeId}><div class="portal-panel__header"${_scopeId}><h2 class="portal-panel__title"${_scopeId}>${ssrInterpolate(unref(t)("profile.two_factor"))}</h2></div><div class="portal-panel__body"${_scopeId}><p class="portal-profile-2fa__text"${_scopeId}>${ssrInterpolate(unref(t)("profile.two_factor_description"))}</p>`);
            if (__props.twoFactorEnabled) {
              _push2(`<div class="portal-profile-2fa__status"${_scopeId}><span class="portal-badge portal-badge--paid"${_scopeId}>${ssrInterpolate(unref(t)("profile.two_factor_enabled"))}</span></div>`);
            } else if (__props.twoFactorPending) {
              _push2(`<div class="portal-profile-2fa__status"${_scopeId}><span class="portal-badge portal-badge--invoice"${_scopeId}>${ssrInterpolate(unref(t)("profile.two_factor_pending"))}</span></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.twoFactorEnabled || __props.twoFactorPending) {
              _push2(`<div class="portal-profile-2fa__tools"${_scopeId}><button type="button" class="portal-panel__action"${ssrIncludeBooleanAttr(twoFactorLoading.value) ? " disabled" : ""}${_scopeId}><i class="fas fa-qrcode"${_scopeId}></i> ${ssrInterpolate(unref(t)("profile.show_qr"))}</button>`);
              if (__props.twoFactorEnabled) {
                _push2(`<button type="button" class="portal-panel__action"${ssrIncludeBooleanAttr(twoFactorLoading.value) ? " disabled" : ""}${_scopeId}><i class="fas fa-key"${_scopeId}></i> ${ssrInterpolate(unref(t)("profile.show_recovery_codes"))}</button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            if (recoveryCodes.value.length) {
              _push2(`<div class="portal-profile-2fa__codes"${_scopeId}><p class="portal-form-hint"${_scopeId}>${ssrInterpolate(unref(t)("profile.recovery_codes_hint"))}</p><ul${_scopeId}><!--[-->`);
            ...
            if (__props.twoFactorEnabled || __props.twoFactorPending) {
              _push2(`<button type="button" class="portal-profile-2fa__disable"${ssrIncludeBooleanAttr(twoFactorLoading.value) ? " disabled" : ""}${_scopeId}>${ssrInterpolate(unref(t)("profile.disable_two_factor"))}</button>`);
            } else {
              _push2(`<button type="button" class="thm-btn"${ssrIncludeBooleanAttr(twoFactorLoading.value) ? " disabled" : ""}${_scopeId}>${ssrInterpolate(unref(t)("profile.enable_two_factor"))}</button>`);
            }
            ...
            return [
              ...
              createVNode("div", { class: "row g-4" }, [
                createVNode("div", { class: "col-lg-6" }, [
                  createVNode("div", { class: "portal-panel" }, [
                    createVNode("div", { class: "portal-panel__header" }, [
                      createVNode("h2", { class: "portal-panel__title" }, toDisplayString(unref(t)("profile.information")), 1)
                    ]),
                    createVNode("div", { class: "portal-panel__body" }, [
                      createVNode("form", {
                        class: "portal-profile-form",
                        ...
                        createVNode("div", { class: "portal-profile-avatar" }, [
                          ...
                          createVNode("div", { class: "portal-profile-avatar__actions" }, [
                            createVNode("label", { class: "portal-profile-avatar__upload thm-btn thm-btn--sm" }, [
                              ...
                              createTextVNode(" " + toDisplayString(unref(t)("profile.change_photo")) + " ", 1),
                              createVNode("input", {
                                type: "file",
                            ...
                            avatarPreview.value ? (openBlock(), createBlock("button", {
                              ...
                              class: "portal-panel__action",
                              onClick: clearAvatar
                            }, toDisplayString(unref(t)("profile.remove_photo")), 1)) : createCommentVNode("", true)
                          ]),
                        ...
                        createVNode("div", { class: "portal-form-group" }, [
                          createVNode("label", { for: "profile-name" }, toDisplayString(unref(t)("profile.name")) + " *", 1),
                          withDirectives(createVNode("input", {
                            id: "profile-name",
                        ...
                        createVNode("div", { class: "portal-form-group" }, [
                          createVNode("label", { for: "profile-email" }, toDisplayString(unref(t)("profile.email")) + " *", 1),
                          withDirectives(createVNode("input", {
                            id: "profile-email",
                        ...
                        createVNode("div", { class: "portal-form-group" }, [
                          createVNode("label", { for: "profile-mobile" }, toDisplayString(unref(t)("profile.mobile")), 1),
                          withDirectives(createVNode("input", {
                            id: "profile-mobile",
                        ...
                        createVNode("div", { class: "portal-profile-form__actions" }, [
                          ...
                          }, toDisplayString(unref(t)("profile.save_changes")), 9, ["disabled"])
                        ])
                      ], 32)
                    ])
                  ])
                ...
                createVNode("div", { class: "col-lg-6" }, [
                  createVNode("div", { class: "portal-panel mb-4" }, [
                    createVNode("div", { class: "portal-panel__header" }, [
                      createVNode("h2", { class: "portal-panel__title" }, toDisplayString(unref(t)("profile.change_password")), 1)
                    ]),
                    createVNode("div", { class: "portal-panel__body" }, [
                      createVNode("form", {
                        class: "portal-profile-form",
                        ...
                        createVNode("div", { class: "portal-form-group" }, [
                          createVNode("label", { for: "current-password" }, toDisplayString(unref(t)("profile.current_password")) + " *", 1),
                          withDirectives(createVNode("input", {
                            id: "current-password",
                        ...
                        createVNode("div", { class: "portal-form-group" }, [
                          createVNode("label", { for: "new-password" }, toDisplayString(unref(t)("profile.new_password")) + " *", 1),
                          withDirectives(createVNode("input", {
                            id: "new-password",
                        ...
                        createVNode("div", { class: "portal-form-group" }, [
                          createVNode("label", { for: "confirm-password" }, toDisplayString(unref(t)("profile.confirm_password")) + " *", 1),
                          withDirectives(createVNode("input", {
                            id: "confirm-password",
                        ...
                        createVNode("div", { class: "portal-profile-form__actions" }, [
                          ...
                          }, toDisplayString(unref(t)("profile.update_password")), 9, ["disabled"])
                        ])
                      ], 32)
                    ])
                  ]),
                  createVNode("div", { class: "portal-panel" }, [
                    createVNode("div", { class: "portal-panel__header" }, [
                      createVNode("h2", { class: "portal-panel__title" }, toDisplayString(unref(t)("profile.two_factor")), 1)
                    ]),
                    createVNode("div", { class: "portal-panel__body" }, [
                      createVNode("p", { class: "portal-profile-2fa__text" }, toDisplayString(unref(t)("profile.two_factor_description")), 1),
                      __props.twoFactorEnabled ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "portal-profile-2fa__status"
                      }, [
                        createVNode("span", { class: "portal-badge portal-badge--paid" }, toDisplayString(unref(t)("profile.two_factor_enabled")), 1)
                      ])) : __props.twoFactorPending ? (openBlock(), createBlock("div", {
                        key: 1,
                        class: "portal-profile-2fa__status"
                      }, [
                        createVNode("span", { class: "portal-badge portal-badge--invoice" }, toDisplayString(unref(t)("profile.two_factor_pending")), 1)
                      ])) : createCommentVNode("", true),
                      __props.twoFactorEnabled || __props.twoFactorPending ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("button", {
                          ...
                          createTextVNode(" " + toDisplayString(unref(t)("profile.show_qr")), 1)
                        ], 8, ["disabled"]),
                        __props.twoFactorEnabled ? (openBlock(), createBlock("button", {
                          ...
                          createTextVNode(" " + toDisplayString(unref(t)("profile.show_recovery_codes")), 1)
                      ...
                      recoveryCodes.value.length ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("p", { class: "portal-form-hint" }, toDisplayString(unref(t)("profile.recovery_codes_hint")), 1),
                        createVNode("ul", null, [
                      ...
                      __props.twoFactorPending ? (openBlock(), createBlock("form", {
                        ...
                        createVNode("div", { class: "portal-form-group" }, [
                          createVNode("label", { for: "two-factor-code" }, toDisplayString(unref(t)("profile.confirm_code")) + " *", 1),
                          withDirectives(createVNode("input", {
                            id: "two-factor-code",
                            ...
                            maxlength: "6",
                            class: "portal-input",
                            placeholder: unref(t)("profile.confirm_code_placeholder"),
                            required: ""
                          }, null, 8, ["onUpdate:modelValue", "placeholder"]), [
                        ...
                        createVNode("button", {
                          ...
                          disabled: twoFactorLoading.value
                        }, toDisplayString(unref(t)("profile.confirm_two_factor")), 9, ["disabled"])
                      ...
                      createVNode("div", { class: "portal-profile-2fa__actions" }, [
                        ...
                        }, toDisplayString(unref(t)("profile.disable_two_factor")), 9, ["disabled"])) : (openBlock(), createBlock("button", {
                          key: 1,
                          type: "button",
                          class: "thm-btn",
                          disabled: twoFactorLoading.value,
                          onClick: enableTwoFactor
                        }, toDisplayString(unref(t)("profile.enable_two_factor")), 9, ["disabled"]))
                      ])
                    ])
                  ])
                ])
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const metaTitle = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.title) || t("pages.subscriptions_title");
    });
    const metaDescription = computed(() => {
      var _a;
      return ((_a = props.meta) == null ? void 0 : _a.description) || t("pages.subscriptions_description");
    });
    const formatMoney = (amount, currency) => `${Number(amount ?? 0).toFixed(2)} ${currency || ""}`.trim();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$l, mergeProps({
        title: unref(t)("subscriptions.title"),
        subtitle: unref(t)("subscriptions.subtitle"),
        active: "subscriptions",
        breadcrumbs: [
          { label: unref(t)("menu.my_dashboard"), href: _ctx.route("portal.dashboard") },
          { label: unref(t)("subscriptions.title") }
        ],
        "meta-title": metaTitle.value,
        "meta-description": metaDescription.value
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (__props.subscriptions.data.length === 0) {
              _push2(`<div class="portal-panel"${_scopeId}><div class="portal-empty"${_scopeId}><i class="fas fa-sync-alt"${_scopeId}></i> ${ssrInterpolate(unref(t)("subscriptions.no_subscriptions"))}</div></div>`);
            } else {
              _push2(`<div class="row g-4"${_scopeId}><!--[-->`);
              ssrRenderList(__props.subscriptions.data, (subscription) => {
                ...
                _push2(`<div class="portal-project-card__meta"${_scopeId}><span${_scopeId}>${ssrInterpolate(unref(t)("subscriptions.amount"))}</span><strong${_scopeId}>${ssrInterpolate(formatMoney(subscription.amount, subscription.currency))}</strong></div><div class="portal-project-card__meta"${_scopeId}><span${_scopeId}>${ssrInterpolate(unref(t)("subscriptions.billing_cycle"))}</span><strong${_scopeId}>${ssrInterpolate(subscription.billing_cycle_label)}</strong></div>`);
                if (subscription.renewal_at) {
                  _push2(`<div class="portal-project-card__meta"${_scopeId}><span${_scopeId}>${ssrInterpolate(unref(t)("subscriptions.renewal_at"))}</span><strong${_scopeId}>${ssrInterpolate(subscription.renewal_at)}</strong></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (subscription.service_name) {
                  _push2(`<div class="portal-project-card__meta"${_scopeId}><span${_scopeId}>${ssrInterpolate(unref(t)("subscriptions.service"))}</span><strong${_scopeId}>${ssrInterpolate(subscription.service_name)}</strong></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (subscription.auto_renew) {
                  _push2(`<div class="portal-project-card__meta"${_scopeId}><span${_scopeId}>${ssrInterpolate(unref(t)("subscriptions.auto_renew"))}</span><strong${_scopeId}>${ssrInterpolate(unref(t)("subscriptions.auto_renew_enabled"))}</strong></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</article></div>`);
            ...
            return [
              __props.subscriptions.data.length === 0 ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "portal-empty" }, [
                  createVNode("i", { class: "fas fa-sync-alt" }),
                  createTextVNode(" " + toDisplayString(unref(t)("subscriptions.no_subscriptions")), 1)
                ])
              ])) : (openBlock(), createBlock("div", {
                key: 1,
                class: "row g-4"
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(__props.subscriptions.data, (subscription) => {
                  ...
                  return openBlock(), createBlock("div", {
                    ...
                    createVNode("article", { class: "portal-project-card" }, [
                      ...
                      createVNode("div", { class: "portal-project-card__meta" }, [
                        createVNode("span", null, toDisplayString(unref(t)("subscriptions.amount")), 1),
                        createVNode("strong", null, toDisplayString(formatMoney(subscription.amount, subscription.currency)), 1)
                      ]),
                      createVNode("div", { class: "portal-project-card__meta" }, [
                        createVNode("span", null, toDisplayString(unref(t)("subscriptions.billing_cycle")), 1),
                      ...
                      subscription.renewal_at ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("span", null, toDisplayString(unref(t)("subscriptions.renewal_at")), 1),
                      ...
                      subscription.service_name ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("span", null, toDisplayString(unref(t)("subscriptions.service")), 1),
                      ...
                      subscription.auto_renew ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("span", null, toDisplayString(unref(t)("subscriptions.auto_renew")), 1),
                        createVNode("strong", null, toDisplayString(unref(t)("subscriptions.auto_renew_enabled")), 1)
                      ])) : createCommentVNode("", true)
                    ])
                  ]);
                }), 128))
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/page-header.css")}${_scopeId}><link rel="stylesheet"${ssrRenderAttr("href", asset_path.value + "site/css/module-css/error.css")}${_scopeId}><title${_scopeId}>${ssrInterpolate(metaTitle.value)}</title><meta name="description"${ssrRenderAttr("content", metaDescription.value)}${_scopeId}><meta name="keywords"${ssrRenderAttr("content", metaKeywords.value)}${_scopeId}><meta name="robots"${ssrRenderAttr("content", metaRobots.value)}${_scopeId}>`);
            if (metaCanonical.value) {
              _push2(`<link rel="canonical"${ssrRenderAttr("href", metaCanonical.value)}${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            ...
            return [
              ...
              createVNode("link", {
                rel: "stylesheet",
                href: asset_path.value + "site/css/module-css/error.css"
              }, null, 8, ["href"]),
              createVNode("title", null, toDisplayString(metaTitle.value), 1),
              createVNode("meta", {
                name: "description",
      ...
      _push(ssrRenderComponent(_sfc_main$D, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="page-header"${_scopeId}><div class="page-header__bg" style="${ssrRenderStyle({ backgroundImage: `url(${asset_path.value}images/contact-header-bg.jpg)` })}"${_scopeId}></div><div class="container"${_scopeId}><div class="page-header__inner"${_scopeId}><h1${_scopeId}>${ssrInterpolate(trans("404 Error"))}</h1><div class="thm-breadcrumb__box"${_scopeId}><ul class="thm-breadcrumb list-unstyled"${_scopeId}><li${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: getHomeUrl()
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            ...
            _push2(`</li><li${_scopeId}><span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow-1`)}"${_scopeId}></span></li><li${_scopeId}>${ssrInterpolate(trans("404 Error"))}</li></ul></div></div></div></section><section class="error-page"${_scopeId}><div class="container"${_scopeId}><div class="error-page__inner text-center"${_scopeId}><div class="error-page__img float-bob-y"${_scopeId}><img${ssrRenderAttr("src", asset_path.value + "site/images/resources/error-page-img1.png")}${ssrRenderAttr("alt", trans("404 Error"))} width="620" height="420" decoding="async"${_scopeId}></div><div class="error-page__content"${_scopeId}><h2${_scopeId}>${ssrInterpolate(trans("Oops! Page Not Found!"))}</h2><p${_scopeId}>${ssrInterpolate(trans("The page you are looking for does not exist. It might have been moved or deleted."))}</p><div class="btn-box"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              class: "thm-btn",
              href: getHomeUrl()
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(trans("Back To Home"))} <span class="${ssrRenderClass(`icon-${locale.value === "ar" ? "left" : "right"}-arrow`)}"${_scopeId2}></span>`);
                } else {
                  return [
            ...
            return [
              createVNode("section", { class: "page-header" }, [
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "page-header__inner" }, [
                    createVNode("h1", null, toDisplayString(trans("404 Error")), 1),
                    createVNode("div", { class: "thm-breadcrumb__box" }, [
                      createVNode("ul", { class: "thm-breadcrumb list-unstyled" }, [
                        createVNode("li", null, [
                          createVNode(unref(Link), {
                ...
                createVNode("div", { class: "container" }, [
                  createVNode("div", { class: "error-page__inner text-center" }, [
                    createVNode("div", { class: "error-page__img float-bob-y" }, [
                      createVNode("img", {
                        src: asset_path.value + "site/images/resources/error-page-img1.png",
                        alt: trans("404 Error"),
                        width: "620",
                        height: "420",
                        decoding: "async"
      ...
      if (modules.length > 1) {
        return resolvePageComponent(
          ...
          /* @__PURE__ */ Object.assign({
            ...
            "../../Modules/User/resources/assets/js/Pages/Portal/ConfirmPassword.vue": __vite_glob_0_26,
            "../../Modules/User/resources/assets/js/Pages/Portal/Dashboard.vue": __vite_glob_0_27,
            "../../Modules/User/resources/assets/js/Pages/Portal/Profile.vue": __vite_glob_0_28,
            "../../Modules/User/resources/assets/js/Pages/Portal/Subscriptions/Index.vue": __vite_glob_0_29
          })
        );
      }
      return resolvePageComponent(
